...
\end{tikzpicture}}{An increasing blue curve through the points (1.41,0.5), (2,1), and (2.45,1.5).  A dashed horizontal and vertical line connects the middle point to the y and x axes (respectively).  Red horizontal and vertical lines connect the other points to the y and x axes respectively.}}{$\delta\le0.45$}
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{An increasing blue curve through the points (1.29,0.7), (2,1), and (2.95,1.3).  A dashed horizontal and vertical line connects the middle point to the y and x axes (respectively).  Red horizontal and vertical lines connect the other points to the y and x axes respectively.}}{$\delta\le0.71$}
