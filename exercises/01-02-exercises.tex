...
\begin{tikzpicture}[alt={An increasing blue curve through the points (1.41,0.5), (2,1), and (2.45,1.5).  A dashed horizontal and vertical line connects the middle point to the y and x axes (respectively).  Red horizontal and vertical lines connect the other points to the y and x axes respectively.},>=stealth]
...
\begin{tikzpicture}[alt={An increasing blue curve through the points (1.29,0.7), (2,1), and (2.95,1.3).  A dashed horizontal and vertical line connects the middle point to the y and x axes (respectively).  Red horizontal and vertical lines connect the other points to the y and x axes respectively.},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
minor x tick num=1,axis y line=middle,axis x line=middle,name=myplot,
