...
% infinite limits :(
%\exercise{\noindent\begin{minipage}{\linewidth}\centering
%\begin{tikzpicture}[alt={A curve starting at the origin, shooting up to positive infinity when x=1, and then coming back down in a mirror image to finish at (2,0).}]
%\begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
%axis y line=middle,axis x line=middle,name=myplot,
%ymin=-.1,ymax=2.1,xmin=-.1,xmax=2.1]
...
%\exercise{\noindent\begin{minipage}{\linewidth}\centering
%\begin{tikzpicture}[alt={A line segment from a solid dot at (0,1) to a hollow dot at (1,2); a solid dot at (1,1); a parabola starting with its vertex at a hollow dot at (1,0) and then curving upward to end at (2,2).}]
%\begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
%axis y line=middle,axis x line=middle,name=myplot,
%ymin=-.1,ymax=2.1,xmin=-.1,xmax=2.1]
