...
\end{tikzpicture}}{A line segment connecting (0,1) to a hollow dot at (1,2) and then curving to (2,0).  There is also a dot at (1,1).}
\end{minipage}
\begin{multicols}{2}
\begin{enumerate}
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A line segment connecting (0,0) to a hollow dot at (1,1).  Another line segment connects a solid dot at (1,2) to (2,0).}
\end{minipage}
\begin{multicols}{2}
\begin{enumerate}
\item		$\ds \lim_{x\to 1^-} f(x)$
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A curve from the origin to (1,2) and then a line segment to (2,0).}
\end{minipage}
\begin{multicols}{2}
\begin{enumerate}
\item		$\ds \lim_{x\to 1^-} f(x)$
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A curve from a solid dot at (-4,-4) to a hollow dot at (0,4), then a solid dot at (0,0), and then a curve from a hollow dot at (0,-4) to a solid dot at (4,4).}
\end{minipage}
\begin{multicols}{2}
\begin{enumerate}
\item		$\ds \lim_{x\to 0^-} f(x)$
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A line segment from a solid dot at (-4,0) to a hollow dot at (-2,2) to a solid dot at the origin to a hollow dot at (2,2) to a solid dot at (4,0).  There is also a solid dot at (-2,0).}
\end{minipage}
\begin{multicols}{2}
\begin{enumerate}
\item		$\ds \lim_{x\to -2^-} f(x)$
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{For each integer -4 to 3 inclusive, a horizontal line segment from a solid dot at (n,n) to a hollow dot at (n+1,n).}
\end{minipage}
