...
\input{exercises/01-05-exset-01}

\questioncolumnbreak

\input{exercises/01-05-exset-02}
...
\begin{exerciseset}{Exercises}{ test your understanding of the Intermediate Value Theorem.}
...
\input{exercises/01-05-exset-06}
...
\item	$\ds \lim_{x\to -4/5^-} \frac{x^2-8.2 x-7.2}{x^2+5.8 x+4}$
\end{enumerate}}{\begin{tabular}{cc}
$x$ & $f(x)$ \\ \hline 
