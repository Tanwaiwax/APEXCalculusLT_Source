...
\input{exercises/01_04_exset_02}

\input{exercises/01_04_exset_05}

\questioncolumnbreak

\input{exercises/01_04_exset_03}

\input{exercises/01_04_exset_04}

\printreview

\exercise{Evaluate the limit: $\ds \lim_{x\to -1} \frac{x^2+5 x+4}{x^2-3 x-4}$.}{$-3/5$}

\exercise{Evaluate the limit: $\ds \lim_{x\to -4} \frac{x^2-16}{x^2-4 x-32}$.}{$2/3$}
