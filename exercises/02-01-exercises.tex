...
\end{tikzpicture}}{A U shaped graph through (-1,0), (0,-1), and (1,0).}}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{enumerate}
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A curve starting up near (-1,5) and then moving downward toward (3,0).}}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{enumerate}
\item	Approximations will vary; they should match (c) closely.
\item		$\fp(x) = -1/(x+1)^2$
...
\exercise{\mbox{}\\[-2\baselineskip]\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A curve starting near (-3,-5), passing through (-2,0), going up to (-1,1), turning downward to the origin and down to (1,-1), turning back upward to (2,0) and finishing near (3,5).}}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{enumerate}
...
\exercise{\mbox{}\\[-2\baselineskip]\pdftooltip{\begin{tikzpicture}[scale=.8]
\begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,xtick={-2,-1,1,2},
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A curve starting near (-2,-6), going through (-1.5,0), up to (-1,4), turning at that point downward to (0,1), turning at that point up to (1,4), turning back down to (1.5,0), and finishing near (2,-6).}}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{enumerate}
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A curve starting near (-5,3) and finishing at a hollow dot at (-3,1), then a solid dot at (-3,2), and then another curve starting from (-3,3) and finishing near (-1,-1).}}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{enumerate}
\item		1
\item		3
\item		Does not exist
