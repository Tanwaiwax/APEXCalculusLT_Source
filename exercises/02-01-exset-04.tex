...
\end{tikzpicture}
\end{minipage}
}{\mbox{}\\[-\baselineskip]\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
...
\exercise{\noindent\begin{minipage}{\linewidth}
\begin{tikzpicture}[alt={A U shaped graph going through (-4,-1), (-2,-3), and (0,-1).}]
\begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
...
\end{tikzpicture}
\end{minipage}
}{\mbox{}\\[-\baselineskip]\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},baseline=10pt,scale=.8]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
xtick={-2,-1,1,2,-3,3},ytick={-2,2,-4,4,-6,6},
ymin=-6.5,ymax=6.5,xmin=-3.5,xmax=3.5]
...
%\exercise{\begin{minipage}[]{\linewidth}
%\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},baseline=10pt,scale=.8]
%\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
%axis y line=middle,axis x line=middle,name=myplot,
...
\exercise{\begin{minipage}[]{\linewidth}
\begin{tikzpicture}[alt={A curve starting near (-5,-4), spiking upward toward (-1,10).  A separate curve starts near (-1,-10) before turning to finish near (5,3).},baseline=10pt,scale=.8]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
