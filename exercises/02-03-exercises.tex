...
\begin{tikzpicture}[alt={The curve a starts near (-0.5,5), drops quickly to cross the x axis near x=-0.2, crosses the y axis near y=-1, then turns upward near (0.5,-1.5), crosses the x axis near x=0.8, and increases at a relatively constant rate to finish near (4,4).  The curve b starts near (-0.2,-6), crosses the y axis near y=-2 and the x axis near x=0.5, peaks near (2,1.2), and decreases slowly from there.  The curve c starts near (0.4,4), drops quickly to cross the x axis near x=2, and remains close to the x axis (but negative) after that.}]
...
\begin{tikzpicture}[alt={The curve a is U shaped, with the bottom of the U touching the origin.  The curve b starts low in the third quadrant, increases and then flattens out as it passes through the origin before turning to increase again.  The curve c is U shaped as well, but with a flatter bottom than curve a, and the bottom of the curve is a bit below the x axis but on the y axis.  The curve d starts low in the third quadrant, increases quickly to the second quadrant where it turns to pass through the origin down to the fourth quadrant, where it turns again to increase quickly into the first quadrant.}]
 \begin{axis}[xtick=\empty, ytick=\empty, axis y line=middle,axis x line=middle,
