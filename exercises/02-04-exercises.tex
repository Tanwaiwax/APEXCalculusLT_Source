...
\input{exercises/02-04-exset-08}

\input{exercises/02-04-exset-01}

\input{exercises/02-04-exset-02}

\input{exercises/02-04-exset-03}

\input{exercises/02-04-exset-04}

\input{exercises/02-04-exset-05}

\input{exercises/02-04-exset-06}

\input{exercises/02-04-exset-09}
...
\begin{enumext*}[columns=2,labelsep=.7em,label=\alph*,wrap-label={(#1)}]
\item $(fg)'(-1)$
\item $(f/g)'(-1)$
\item $(fg)'(3)$
\item $(g/f)'(3)$
\end{enumext*}}{\leavevmode\vspace{-1.5\baselineskip}\begin{enumext*}[columns=5,labelsep=.5em,label=\alph*,wrap-label={(#1)}]\item $-\frac72$ \item $\frac1{18}$ \item $-\frac92$ \item $\frac{15}2$\end{enumext*}}
