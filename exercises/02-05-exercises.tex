...
\input{exercises/02-05-exset-01}
...
\end{tabular}}{The function f is the line segments connecting (-2,1.5) to (1,0) to (2,4) to (4,-2).  The function g is the line segments connecting (-1.5,4) to (1,-1) to (4,3.5).}}{(a) $6$  \qquad (b) $1$ \qquad (c) $-3$ \qquad (d) $1.5$}
