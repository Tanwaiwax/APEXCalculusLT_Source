...
\begin{tikzpicture}
 \begin{axis}[xtick=\empty, ytick=\empty, axis y line=middle,axis x line=middle,
  ...
  \addplot [{\colorone}, dashed, smooth, domain=-1.66:1.68,thick] {.5*x*x*x*x*x-2*x}; 
  \node[label={30:{\scriptsize $d$}}] at (axis cs:1.6,2.1) {};

  \addplot [{\colortwo}, smooth, domain=-1.217:1.217,thick] {2.5*x*x*x*x-2};
  \node[label={30:{\scriptsize $c$}}] at (axis cs:1.1,2.1) {};

  \addplot [{\colorone}, smooth, domain=-.669:.704, thick] {10*x*x*x};
  \node[label={30:{\scriptsize $b$}}] at (axis cs:.55,2.1) {};

  \addplot [{\colortwo}, dashed, smooth, domain=-.341:.341, thick] {30*x*x};
