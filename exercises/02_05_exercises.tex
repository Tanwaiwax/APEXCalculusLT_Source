...
\exercise{T/F: The Generalized Power Rule states that $\ds \frac{d}{dx}\Big( g(x)^n\Big) = n\big(g(x)\big)^{n-1}$.}{F}

\exercise{T/F: $\ds \frac{d}{dx}\big(\ln (x^2)\big) = \frac{1}{x^2}$.}{F}

\exercise{T/F: $\ds \frac{d}{dx}\big(e^{x^2}\big) =e^{x^2}$.}{F}
% was the ET:
%\exercise{T/F: $\ds \frac{d}{dx}\big(3^x\big) \approx 1.1\cdot3^x$.}{T}

\exercise{T/F: $\ds \frac{dx}{dy} = \frac{dx}{dt}\cdot \frac{dt}{dy}$}{T}

\exercise{T/F: Taking the derivative of $f(x) = x^2\sin(5x)$ requires the use of both the Product and Chain Rules.}{T}

\printproblems

\input{exercises/02_05_exset_01}
...
\end{tabular}}{(a) $6$  \qquad (b) $1$ \qquad (c) $-3$ \qquad (d) $1.5$}
...
\input{exercises/02_05_exset_02}
...
\end{enumerate}}{In both cases the derivative is the same: $1/x$. }
...
\end{enumerate}}{In both cases the derivative is the same: $k/x$. }
