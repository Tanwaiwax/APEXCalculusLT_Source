...
\exercise{$f(x)=\dfrac{\sin(4x+1)}{(5x-9)^3}$}{$\fp(x)=\dfrac{(5x-9)^3 4\cos(4x+1)-\sin(4x+1)15(5x-9)^2}{(5x-9)^6}$}

\exercise{$f(x)=\dfrac{(4x+1)^2}{\tan(5x)}=\dfrac{\tan(5x)8(4x+1)-(4x+1)^2 5\sec^2(5x)}{\tan^2(5x)}$}
