...
\exercise{Since $\frac d{dx}(\sin^{-1}x+\cos^{-1}x)=0$, what does this tell us about $\sin^{-1}x+\cos^{-1}x$?}{This sum is constant (in fact, it is $\pi/2$).}
...
\exercise{$\ds\int_{1/\sqrt 2}^{1/2} \frac{2}{\sqrt{1-x^2}}\,dx$}{$-\pi/6$}
