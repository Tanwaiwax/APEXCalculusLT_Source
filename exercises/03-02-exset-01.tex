\begin{exerciseset}{In Exercises}{, a function $f(x)$ and interval $[a,b]$ are given. Check if Rolle's Theorem can be applied to $f$ on $[a,b]$; if so, find $c$ in $(a,b)$ such that $\fp(c)=0$.}
