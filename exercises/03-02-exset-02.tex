\exercisesetinstructions{, a function $f(x)$ and interval $[a,b]$ are given. Check if the Mean Value Theorem can be applied to $f$ on $[a,b]$; if so, find a value $c$ in $[a,b]$ guaranteed by the Mean Value Theorem.}
