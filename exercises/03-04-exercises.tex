...
\begin{tikzpicture}[alt={A curve starting near (-3,-4), passing through (-2,0), peaking at (0,4) before falling in a mirror image through (2,0) to finish near (3,-4).}]
...
\begin{tikzpicture}[alt={A curve starting near (-3,-3), passing through (-2,0), peaking at (-1,2) before falling to pass through the origin and finish in a mirror image through (1,-2), (2,0), and (3,3).}]
\begin{axis}[width=.4\textwidth,tick label style={font=\scriptsize },
	axis y line=middle,axis x line=middle,
    ymin=-3,ymax=3,
	xmin=-3,xmax=3,name=myplot]
...
%\begin{tikzpicture}[alt={W shape starting near (-3,4) through (-2.3,0), bottoming near (-1.7,-5), through (-0.9,0), peaking at (0,4), finishing in a mirror image through (0.9,0), (1.7,-5), (2.3,0), and (3,4).}]
%\begin{axis}[width=.4\textwidth,tick label style={font=\scriptsize },
%	axis y line=middle,axis x line=middle,
%    ymin=-5,ymax=5,
%	xmin=-3,xmax=3,name=myplot]
