...
\begin{tikzpicture}[alt={W shaped graph starting near (-3,4), moving downward to turn upward near (-2,-4), peaking at (0,4), and then finishing in a mirror image through (2,-4) and (3,4).}]
...
\input{exercises/03-05-exset-01}

\input{exercises/03-05-exset-02}

\exercisesetinstructions{, sketch the graph of a function that satisfies all of the given conditions.}
...
\input{exercises/03-05-exset-03}
