...
\exercise{$\ds f(x) =\frac{1}{x^2-2x+2}$
}{domain=$(-\infty,\infty)$
...
\exercise{$\ds f(x) =\frac{x^2-4}{x^2-1}$
...
\exercise{$\ds f(x) =\frac{x}{x^2-2x-8}$
...
\exercise{$\ds f(x) =x-2 \sin x$ on $0\le x\le3\pi$
}{domain=$(-\infty,\infty)$;
...
\exercise{$\ds f(x) =\cos^2 x-2 \sin x$ on $0\le x\le2\pi$
}{domain=$(-\infty,\infty)$;
