...
\exercise{$\ds f(x) = e^{-x^2}$}{\lxenumerate{label=(\alph*)}
...
\exercise{$\ds f(x) = x\sqrt{x+3}$}{\lxenumerate{label=(\alph*)}
\item Possible points of inflection: none
...
\exercise{$f(x)=x^3-3x^2-9x+4$}{\lxenumerate{label=(\alph*)}
\item Possible points of inflection: $x=1$
...
\exercise{$f(x)=x^4-2x^2+3$}{\lxenumerate{label=(\alph*)}
...
\exercise{$f(x)=1+3x^2-2x^3$}{\lxenumerate{label=(\alph*)}
\item Possible points of inflection: $x=1/2$
...
\exercise{$f(x)=\sqrt x -\sqrt[4]{x}$}{\lxenumerate{label=(\alph*)}
