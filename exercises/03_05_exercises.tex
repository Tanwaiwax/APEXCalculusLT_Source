\printconcepts
\exercise{Why is sketching curves by hand beneficial even though technology is readily available?
}{Answers will vary.
}

\exercise{T/F: When sketching graphs of functions, it is useful to find the critical points.
}{T
}

\exercise{T/F: When sketching graphs of functions, it is useful to find the possible points of inflection.
}{T
}

\exercise{T/F: When sketching graphs of functions, it is useful to find the horizontal and vertical asymptotes.
}{T
}
...
\input{exercises/03_05_exset_02}
\ifthenelse{\boolean{printquestions}}{\columnbreak}{}
\input{exercises/03_05_exset_03}
