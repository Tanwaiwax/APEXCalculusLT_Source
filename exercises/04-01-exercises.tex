...
\input{exercises/04-01-exset-03}
...
\input{exercises/04-01-exset-04}
...
\begin{tikzpicture}[alt={A smooth curve through the points (-2,0.2), (-1,0.5), (0,1), (1,1.5), (2,0), (4,-1), (6,0), and (7,2).},baseline=(current bounding box.north)]
