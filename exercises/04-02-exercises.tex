...
\item	19 feet?
\end{enumext}
How long will the tank take to fill when starting at empty?}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{enumext}[start=1]
\item  $50.92$ ft/min
\item	 $0.509$ ft/min
\item  $0.141$ ft/min
\end{enumext}}
...
\item	40 feet?
\end{enumext}
How far must the man walk to raise the weight all the way to the pulley?}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{enumext}[start=1]
\item  $0.63$ ft/sec
\item	 $1.6$ ft/sec
\end{enumext}}
About 52 ft.}
