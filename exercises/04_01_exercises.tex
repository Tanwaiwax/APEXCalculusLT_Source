...
\exercise{T/F: In order to get a solution to $f(x)=0$ accurate to $d$ places after the decimal, at least $d+1$ iterations of Newtons' Method must be used.}{F}

\printproblems

\input{exercises/04_01_exset_01}

\input{exercises/04_01_exset_02}
...
\input{exercises/04_01_exset_04}
