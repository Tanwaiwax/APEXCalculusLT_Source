...
\item	19 feet?
\end{enumerate}
How long will the tank take to fill when starting at empty?}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
\item  $50.92$ ft/min
\item	 $0.509$ ft/min
\item  $0.141$ ft/min
\end{enumerate}
...
\item	40 feet?
\end{enumerate}
How far must the man walk to raise the weight all the way to the pulley?}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
\item  $0.63$ ft/sec
\item	 $1.6$ ft/sec
\end{enumerate}
About 52 ft.}

% todo fix 4.1#14 so that c doesn't happen after d
