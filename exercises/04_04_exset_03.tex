...
\exercise{Answer\label{exer:04_04_ex_36} the questions of \autoref{exer:04_04_ex_35}, but with a measured angle of $71.5^\circ$, accurate to $1^\circ$, measured from a point $100'$ from the wall.
%\begin{minipage}{\linewidth}
%\centering
%\begin{tikzpicture}
%\draw [ultra thick] (1,-1) -- node [pos=.5,right] {\scriptsize $l=$?}(1,1);
