\exercisesetinstructions{, a velocity function of an object moving along a straight line is given. Find (a) the displacement of the object over the given time interval and (b) the total distance traveled by the object over the given time interval.}
