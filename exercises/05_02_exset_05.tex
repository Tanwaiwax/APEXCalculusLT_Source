...
\exercise{$\ds \int_0^3 \big(s(t) + r(t)\big)\ dt$
}{24
}

\exercise{$\ds \int_5^0 \big(s(t) - r(t)\big)\ dt$
}{$-7$
}

\exercise{$\ds \int_3^3 \big(\pi s(t) - 7r(t)\big)\ dt$
}{$-7$
}

\exercise{Find values for $a$ and $b$ such that 
