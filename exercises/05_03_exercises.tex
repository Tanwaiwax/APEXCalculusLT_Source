...
\begin{exerciseset}{In Exercises}{, express the limit as a definite integral.}
...
\begin{exerciseset}{In Exercises}{, express the definite integral as a limit of a sum.}
...
\exercise{Use Theorems \ref{thm:summation} and \ref{thm:riemannSum} to justify the remaining property in \autoref{thm:defintprop}: \[\int_a^b k\cdot f(x)\,dx =k\int_a^b f(x)\,dx\]}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{align*}
