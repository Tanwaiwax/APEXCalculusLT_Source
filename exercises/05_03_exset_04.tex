\exerciseset{Theorem \ref{thm:summation} states
...
\exercise{$\ds \sum_{i=11}^{20} i$
}{$155$
}

\exercise{$\ds \sum_{i=16}^{25} i^3$
}{$91,225$
}

\exercise{$\ds \sum_{i=7}^{12} 4$
}{$24$
}

\exercise{$\ds \sum_{i=5}^{10} 4i^3$
}{$11,700$
}
}