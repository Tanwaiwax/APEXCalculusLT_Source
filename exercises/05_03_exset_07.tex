\exerciseset{In Exercises}{, find an antiderivative of the given function.}{

\exercise{$f(x) = 5\sec^2 x$}{$F(x) = 5\tan x+ 4$}

\exercise{$\ds f(x) = \frac7x$}{$F(x) = 7\ln|x| + 14$}

\exercise{$\ds g(t) = 4t^5-5t^3+8$}{$G(t) = 4/6t^6-5/4t^4+8t+9$}

%\exercise{$\ds g(t) = 5\cdot 8^t$}{$G(t) = 5\cdot 8^t/\ln 8 + 900$}
