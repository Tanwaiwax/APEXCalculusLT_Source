...
\exercise{For any $x>0$, define $\ds g(x)=\int_1^x\frac1t\ dt$.
\begin{enumerate}
...
% gets pushed to the next page for lousy spacing
...
% \node [above] at (myplot.above origin) {\scriptsize $y$};
%\end{tikzpicture}\\
%For a positive integer $n$, define $\ds b_n=\frac1\pi\int_{-\pi}^\pi f(x)\sin(nx)\ dx$.
%\begin{enumerate}
%\item Find $b_n$.
