\begin{exerciseset}{In Exercises}{, a region is given. Find the area of the region using Simpson's Rule:
\begin{enumerate}
...
\exercise{\begin{minipage}{\linewidth}\begin{tikzpicture}[yscale=.6]
