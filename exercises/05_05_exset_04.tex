...
\exercise{$\ds \int_{1}^{4} \frac{1}{\sqrt x} \ dx$}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
\item		$n=150$ (using $\max\big(\fpp(x)\big)=1$)
\item		$n=18$	(using $\max\big(f\,^{(4)}(x)\big)=7$)
\end{enumerate}}

\exercise{$\ds \int_{0}^{\pi} \cos \big(x^2\big) \ dx$}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
\item		$n=1004$ (using $\max\big(\fpp(x)\big)=39$)
\item		$n=62$	(using $\max\big(f\,^{(4)}(x)\big)=800$)
\end{enumerate}}

\exercise{$\ds \int_{0}^{5} x^4 \ dx$}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
