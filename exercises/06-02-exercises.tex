...
\input{exercises/06-02-exset-01}

\input{exercises/06-02-exset-02}

\input{exercises/06-02-exset-03}
...
\begin{tikzpicture}[alt={Three line segments with hollow dots at each end connecting (-3π,-π) to (-π,π); (-π,-π) to (π,π); and (π,-π) to (3π,π).}]
...
\begin{minipage}{\linewidth}\centering
\begin{tikzpicture}[alt={A jagged line segment connecting (-5π/2,-π/2), (-3π/2,π/2), (-π/2,-π/2), (π/2,π/2), (3π/2,-π/2), and (5π/2,π/2).}]
 \begin{axis}[width=\textwidth,tick label style={font=\scriptsize},
  axis y line=middle, axis x line=middle, name=myplot, axis on top,
