...
Hint: Integrate with respect to y, and consult the table of Integration Rules in the Appendix if necessary.}{Using rule \#\ref{intRuleRtSmSq}: $A=\int_0^{\sinh\theta}\sqrt{1+y^2}-y\coth\theta\dd y
