% todo Create exercises for L'Hôpital's rule with the indeterminate form infinity-infinity
% todo Create exercises for L'Hôpital's rule with limits other than 0, 1, or infinity
...
\exercise{$\ds \lim_{x\to 0^+} \left(\frac{2+5^x}3\right)^{1/x}$}{$\sqrt[3]5$}

\exercise{$\ds \lim_{x\to\infty} \left(\frac{1+7^{1/x}}2\right)^x$}{$\sqrt7$}
