...
\exercise{$\ds \int \frac{1}{2 x+7}\ dx$}{$\frac{1}{2} \ln\abs{2 x+7}+C$}
...
\exercise{$\ds\int\cos^3(x)\sin(x)\ dx$}{$-\frac{\cos^4(x)}4+C$}

\exercise{$\ds \int \cos (3-6 x)\ dx$}{$-\frac16\sin(3-6x)+C$}

\exercise{$\ds \int \sec ^2(4-x)\ dx$}{$-\tan (4-x)+C$}

\exercise{$\ds \int \sec (2 x)\ dx$}{$\frac{1}{2} \ln\abs{\sec (2x)+\tan(2x)}+C$}
...
\exercise{$\ds\int\frac{e^x}{e^x+1}\ dx$}{$\ln(e^x+1)+C$}
...
\exercise{$\ds \int \frac{\big(\ln x\big)^2}{x}\ dx$}{$\frac{\bigl(\ln x\bigr)^3}{3}+C$}

\exercise{$\ds \int \frac{\ln \left(x^3\right)}{x}\ dx$}{$\frac32 \ln^2(x)+C$}

\exercise{$\ds \int \frac{1}{x \ln \left(x^2\right)}\ dx$}{$\frac12 \ln\abs{\ln \left(x^2\right)}+C$}

% was set 5
\exercise{$\ds\int\frac{x^2+3x+1}x\ dx$}{$\frac{x^2}2+3x+\ln\abs x+C$}
...
\exercise{$\ds\int\sin(5x+1)\ dx$}{$-\frac15\cos(5x+1)+C$}
