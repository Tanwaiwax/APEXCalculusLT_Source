...
\exercise{\mbox{}\\[-2\baselineskip]\begin{enumerate}
 ...
 \begin{align*}
  \int_0^{\pi/2}\sin^{2k+1}x\ dx&=\frac{2\cdot4\cdot6\cdots(2k)}{1\cdot3\cdot5\cdot7\cdots(2k+1)}\qquad\text{and}\\
  \int_0^{\pi/2}\sin^{2k}x\ dx&=\frac{1\cdot3\cdot5\cdots(2k-1)}{2\cdot4\cdot6\cdots(2k)}\frac\pi2.
 \end{align*}
\end{enumerate}}{}
