\begin{exerciseset}{In Exercises}{, evaluate the given improper integral.}
...
\exercise{$\ds \int_{-\infty}^\infty\frac{x}{x^2+4}\ dx$}{diverges}
...
\exercise{$\ds \int_{0}^3\frac1x\ dx$}{diverges}

\exercise{$\ds \int_{-1}^1 \frac 1x \ dx$}{diverges}

\exercise{$\ds \int_{2}^5 \frac{dx}{\sqrt{x-2}}$}{$2\sqrt3$}

\exercise{$\ds \int_{1}^9 \frac{dx}{\sqrt[3]{9-x}}$}{$6$}

\exercise{$\ds \int_{1}^3\frac{1}{x-2}\ dx$}{diverges}

\exercise{$\ds \int_{0}^\pi \sec^2 x\ dx$}{diverges}

\exercise{$\ds \int_{0}^{\frac\pi2}\sec x\ dx$}{diverges}

\exercise{$\ds \int_{-2}^1 \frac{1}{\sqrt{\abs x}} \ dx$}{$2+2\sqrt{2}$}
