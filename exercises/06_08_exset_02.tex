...
\exercise{$\ds \int \frac {5x^2}{\sqrt{x^2-10}}\ dx$}{$\frac52x\sqrt{x^2-10}+25\ln\abs{\frac{x}{\sqrt{10}}+\frac{\sqrt{x^2-10}}{\sqrt{10}}}+C$}

\exercise{$\ds \int \frac {1}{(x^2+4x+13)^2}\ dx$}{$\frac1{18}\frac{x+2}{x^2+4x+13}+\frac1{54}\tan^{-1}\left(\frac{x+2}3\right)+C$}
...
\exercise{$\ds \int \frac{x^2}{\sqrt{x^2+3}}\ dx$}{$\frac12x\sqrt{x^2+3}-\frac32\ln\abs{\frac{\sqrt{x^2+3}}{\sqrt3}+\frac x{\sqrt3}}+C$}
