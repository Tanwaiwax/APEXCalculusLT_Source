...
\exercise{$\ds \int \frac{-x^3+14 x^2-46 x-7}{x^2-7 x+1} dx $}{$-\frac{x^2}{2}+2 \ln \abs{x^2-7 x+1}+7 x+C$}
...
\exercise{$\ds \int (x-2)\ln x\ dx$}{$-\frac{x^2}{4}+\frac{1}{2} x^2 \ln\abs x+2 x-2 x \ln\abs x+C$}
...
\exercise{$\ds \int \left(\ln (x+1)\right)^2\ dx$}{$2 x+x \left(\ln\abs{x+1}\right)+\left(\ln\abs{x+1}\right)^2-$ $2 x \ln\abs{x+1}-2 \ln\abs{x+1}+2+C$}
