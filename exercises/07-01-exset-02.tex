\exercisesetinstructions{, find the area of the region bounded by the given curves.}
...
%
\exercise{$y=2x$, \quad $y=5x$, \quad $x= 3$.}{$27/2$}

\exercise{$y=-x+1$, \quad $y=3x+6$, \quad $x=2$ \quad $x= -1$.}{$21$}

\exercise{$y=x^2-2x+5$, \quad $y=5x-5$.}{$9/2$}

\exercise{$y=2x^2+2x-5$, \quad $y=x^2+3x+7$.}{$343/6$}
