...
\end{tikzpicture}}{ALT-TEXT-TO-BE-DETERMINED}}{Placing the tip of the cone at the origin such that the $x$-axis runs through the center of the circular base, we have $A(x)=\pi x^2/4$. Thus the volume is $250\pi/3$ units$^3$.}
...
\end{tikzpicture}}{ALT-TEXT-TO-BE-DETERMINED}}{The cross-sections of this cone are the same as the cone in \autoref{ex_07_02_ex_18}. Thus they have the same volume of $250\pi/3$ units$^3$.}

\exercise{A right triangular cone with height of 10 and whose base is a right, isosceles triangle with side length 4.

\pdftooltip{\begin{tikzpicture}[scale=.75]
...
\draw (-.2,.4) -- (0,.3) -- (.2,.4);
\end{tikzpicture}}{ALT-TEXT-TO-BE-DETERMINED}}{Orient the cone such that the tip is at the origin and the $x$-axis is perpendicular to the base. The cross-sections of this cone are right, isosceles triangles with side length $2x/5$; thus the cross-sectional areas are $A(x) = 2x^2/25$, giving a volume of $80/3$ units$^3$.}
...
\pdftooltip{\begin{tikzpicture}[x={(1,0)},z={(0,1)},y={(.5,.87)},scale=.4]
