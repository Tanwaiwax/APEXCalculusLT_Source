...
\begin{tikzpicture}[alt={A 2 ft square whose top is 1 ft below the water line.},xscale=.7,yscale=.7]			
...
\exercise{\begin{minipage}{\linewidth}
\begin{tikzpicture}[alt={A rectangle that is 1 ft wide and 2 ft tall whose top is 1 ft below the water line.},xscale=.7,yscale=.7]			
...
\exercise{\begin{minipage}{\linewidth}
\begin{tikzpicture}[alt={A triangle with base 4 ft and height 6 ft.  The tip opposite 4 ft is the top and is 5 ft below the water line.},xscale=.5,yscale=.4]			
...
\exercise{\begin{minipage}{\linewidth}
\begin{tikzpicture}[alt={A triangle with base 4 ft and height 6 ft pointing downward.  The base is 5 ft below the water line.},xscale=.5,yscale=.4]			
\draw [thick] (0,0) -- (-2,6) -- node [below,pos=.5] {\scriptsize 4 ft} (2,6) -- cycle;
\foreach \x in {-2,-1,0,1,2}{%
...
\exercise{\begin{minipage}{\linewidth}
\begin{tikzpicture}[alt={A disk with radius 2 ft whose center is 5 ft below the water line.},xscale=.5,yscale=.5]			
...
\exercise{\begin{minipage}{\linewidth}
\begin{tikzpicture}[alt={A disk whose radius is 4 ft and whose center is 5 ft below the water line.},xscale=.5,yscale=.5]			
...
\exercise{\begin{minipage}{\linewidth}
\begin{tikzpicture}[alt={A rectangle that is 4 ft wide and 2 ft tall whose center is 5 ft below the water line.},xscale=.5,yscale=.5]			
...
\exercise{\begin{minipage}{\linewidth}
\begin{tikzpicture}[alt={A rectangle that is 2 ft wide and 4 ft tall whose center is 5 ft below the water line.},xscale=.5,yscale=.5]			
...
\exercise{\begin{minipage}{\linewidth}
\begin{tikzpicture}[alt={A 2 ft square oriented diagonally whose top tip is 1 ft below the water line.},xscale=.7,yscale=.7]			
...
\exercise{\begin{minipage}{\linewidth}
\begin{tikzpicture}[alt={An isosceles right triangle with side lengths 2 ft and base parallel to the water line, which is 1 ft above the top tip.},xscale=.7,yscale=.7]			
