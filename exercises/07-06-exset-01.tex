...
\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},xscale=.7,yscale=.7]			
...
\exercise{\begin{minipage}{\linewidth}
\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},xscale=.5,yscale=.4]			
...
\exercise{\begin{minipage}{\linewidth}
\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},xscale=.5,yscale=.5]			
