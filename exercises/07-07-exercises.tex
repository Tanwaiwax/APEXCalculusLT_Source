...
\addplot[draw={\colorone},mark=*,only marks] coordinates {(-7,7)(-5,4)(-3,3)(-2,1)};
\node[above] at (axis cs:-4,5) {$f(x)$};
\end{axis}
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
...
\addplot[mark=*,only marks] coordinates {(-7,7)(-5,4)(-3,3)(-2,1)};
\addplot[domain=-9:9,black, thick,smooth,dashed] {x};
\draw[draw={\colortwo},thick] (axis cs:7,-7)--(axis cs:4,-5)--(axis cs:3,-3)--(axis cs:1,-1);
\addplot[draw={\colorone},mark=*,only marks] coordinates {(7,-7)(4,-5)(3,-3)(1,-2)};
\node[above] at (axis cs:-4,5) {$f(x)$};
\end{axis}
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
...
\input{exercises/07-07-exset-02}
