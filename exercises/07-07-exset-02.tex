\begin{exerciseset}{In Exercises}{, find a restriction of the domain of the given function on which the function will have an inverse.}
...
\begin{exerciseset}{In Exercises}{, find the inverse of the given function.}
...
\begin{exerciseset}{In Exercises}{, find the exact value.}
