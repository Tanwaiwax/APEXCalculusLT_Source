...
\input{exercises/07-exp-log-set-01}

\input{exercises/07-exp-log-set-02}

\input{exercises/07-exp-log-set-03}
...
\input{exercises/02-06-exset-05}

\exercise{The amount $y$ of C\textsuperscript{14} in an object decays according the the function $y(t)=y_0e^{-rt}$, where $y_0$ denotes the initial amount. If it takes 5730 years for half the initial amount to decay, find the rate constant $r$, and then determines how long it takes until only 10\% remains.}{$r = (\ln 2)/5730$; $5730\ln10/\ln2\approx19034.65$ years}
% .1 = e^{-rt}
% rt = ln 10
% t = (ln 10)/r = 5730(ln10)/(ln2)