\exerciseset{In Exercises}{, a solid is described. Orient the solid along the $x$-axis such that a cross-sectional area function $A(x)$ can be obtained, then apply Theorem \ref{thm:volume_by_cross_section} to find the volume of the solid.
}{
