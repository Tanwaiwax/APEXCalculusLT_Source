\exerciseset{In Exercises}{, a solid is described. Orient the solid along the $x$-axis such that a cross-sectional area function $A(x)$ can be obtained, then apply \autoref{thm:volume_by_cross_section} to find the volume of the solid.}{
...
\end{tikzpicture}
}{The cross-sections of this cone are the same as the cone in \autoref{ex_07_02_ex_18}. Thus they have the same volume of $250\pi/3$ units$^3$.
}
