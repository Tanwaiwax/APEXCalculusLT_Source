...
\exercise{\begin{minipage}{\linewidth}\centering\myincludegraphics{figures/fig07_02_ex_06}\end{minipage}
\ifthenelse{\boolean{printquestions}}{\columnbreak}{}}{$70\pi/3$ units$^3$}
