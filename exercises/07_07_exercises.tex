...
\begin{exerciseset}{In Exercises}{, given the graph of $f$, sketch the graph of $f^{-1}$.}
...
\input{exercises/07_07_exset_02}

\begin{exerciseset}{In Exercises}{, simplify the expression.}
