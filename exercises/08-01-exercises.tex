...
\end{enumerate}}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{enumerate}\item $f(n)=Ar^n$\end{enumerate}}}
...
\exercise{Define a sequence $\{a_n\}$ by $a_1=1$ and $a_n=\sqrt{2+a_{n-1}}$ for all $n > 1$. So $a_1=1$, $a_2=\sqrt3$, $a_3=\sqrt{2+\sqrt3}$, $a_3=\sqrt{2+\sqrt{2+\sqrt3}}$,\dots.
 ...
 \end{enumerate}}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{enumerate}\setcounter{enumii}{3}\item 2\end{enumerate}}}
% x = sqrt(2+x)
% x^2 = 2+x
% x^2 - x - 2 = 0
% (x-2)(x+1) = 0
