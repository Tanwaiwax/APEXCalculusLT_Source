\begin{exerciseset}{In Exercises}{, a convergent alternating series is given along with its sum and a value of $\epsilon$. Use \autoref{thm:alt_series_approx} to find $n$ such that the $n^\text{th}$ partial sum of the series is within $\epsilon$ of the sum of the series.}
