\begin{exerciseset}{In Exercises}{, find the $x^n$ term of the indicated Taylor polynomial.}
...
\exercise{Find a formula for the $x^n$ term of the Maclaurin polynomial for $f(x)=\sin x$.}{When $n$ even, 0; when $n$ is odd, $\frac{(-1)^{(n-1)/2}}{n!}x^n$.}
