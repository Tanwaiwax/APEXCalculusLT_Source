...
\exercise{$\ds \sum_{n=1}^\infty \frac{n^2}{2^n}$
}{Converges; Integral Test
}
\exercise{$\ds \sum_{n=1}^\infty \frac{1}{(2n+5)^3}$
...
\exercise{$\ds \sum_{n=1}^\infty \frac{n-2}{10n+5}$
...
\exercise{$\ds \sum_{n=1}^\infty \frac{\cos (1/n)}{\sqrt{n}}$
