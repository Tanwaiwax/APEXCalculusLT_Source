...
\exercise{$\ds \sum_{n=1}^\infty \frac{(-1)^{n+1}}{n^2}$
}{\begin{enumerate}
	\item converges
...
\exercise{$\ds \sum_{n=1}^\infty \frac{(-1)^{n+1}}{\sqrt{n!}}$
}{\begin{enumerate}
	\item converges
...
\exercise{$\ds \sum_{n=0}^\infty (-1)^{n}\frac{n+5}{3n-5}$
}{\begin{enumerate}
...
\exercise{$\ds \sum_{n=1}^\infty (-1)^{n}\frac{2^n}{n^2}$
}{\begin{enumerate}
	\item diverges (limit of terms is not 0)
	\item	diverges
	\item n/a; diverges
...
\exercise{$\ds \sum_{n=1}^\infty \frac{(-1)^{n}}{\ln n+1}$
}{\begin{enumerate}
	\item converges
...
\exercise{$\ds \sum_{n=2}^\infty (-1)^n\frac{n}{\ln n }$
}{\begin{enumerate}
	\item diverges (limit of terms is not 0)
	\item	diverges 
	\item n/a; diverges
...
\exercise{$\ds \sum_{n=1}^\infty \frac{(-1)^{n+1}}{1+3+5+\cdots+(2n-1) }$
}{\begin{enumerate}
	\item converges
...
\exercise{$\ds \sum_{n=1}^\infty \cos \big(\pi n\big)$
}{\begin{enumerate}
...
\exercise{$\ds \sum_{n=1}^\infty \frac{(-1000)^n}{n!}$
}{\begin{enumerate}
	\item converges
	\item	converges (Ratio Test in next section)
	\item absolute
