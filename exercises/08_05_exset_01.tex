...
\exercise{$\ds \sum_{n=1}^\infty \frac{(-1)^{n+1}}{1+3+5+\dots+(2n-1) }$}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
	\item converges
...
\exercise{$\ds \sum_{n=2}^\infty \frac{\sin\big((n+1/2)\pi\big)}{n\ln n}$}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
	\item converges
...
\exercise{$\ds \sum_{n=2}^\infty \frac{(-1)^n}{n(\ln n)^2}$}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
	\item converges
