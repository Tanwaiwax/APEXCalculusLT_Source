\exerciseset{In Exercises}{, use the Taylor series  given in Key Idea \ref{idea:common_taylor} to verify the given identity.
}{

\exercise{$\cos(-x) = \cos x$
...
\exercise{$\frac{d}{dx}\big(\sin x\big) = \cos x$
}{Given $\ds \sin x = \sum_{n=0}^\infty (-1)^n\frac{x^{2n+1}}{(2n+1)!}$,
...
\exercise{$\frac{d}{dx}\big(\cos x\big) = -\sin x$
}{Given $\ds \cos x = \sum_{n=0}^\infty (-1)^n\frac{x^{2n}}{(2n)!}$,
