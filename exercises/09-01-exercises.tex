...
\input{exercises/09-01-exset-01}

\iftoggle{abridgeConics}{}{\input{exercises/09-01-exset-02}}

\input{exercises/09-01-exset-03}

\input{exercises/09-01-exset-05}

\iftoggle{abridgeConics}{}{\input{exercises/09-01-exset-04}}

\input{exercises/09-01-exset-06}
...
\input{exercises/09-01-exset-07}

\input{exercises/09-01-exset-08}

\iftoggle{abridgeConics}{}{\input{exercises/09-01-exset-09}}

\input{exercises/09-01-exset-10}
...
\hfill \begin{tikzpicture}[alt={Points A, B, and C are in a row, with 1000m between A and B, and 2000m between B and C.}]
