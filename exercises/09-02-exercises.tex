...
\input{exercises/09-02-exset-01}

\input{exercises/09-02-exset-02}

\input{exercises/09-02-exset-03}
...
\input{exercises/09-02-exset-06}
...
\begin{enumext}[start=1]\raggedright
\item once clockwise
\item once counter-clockwise
\end{enumext}
\end{minipage}%
\begin{minipage}{.5\linewidth}
\begin{enumext}[start=1]\addtocounter{enumii}{2}\raggedright
...
\input{exercises/09-02-exset-08}
