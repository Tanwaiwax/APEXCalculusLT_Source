...
\begin{tikzpicture}[alt={A parabola starting at (6,-8), moving up and left to the origin, (0,1), (2,0), and finishing at (12,-8).}]
...
\begin{tikzpicture}[alt={A vertical line from (1,-5) to (1,5).}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis equal,
...
\begin{tikzpicture}[alt={A horizontal line connecting (0,2) and (4,2).  The curve moves both directions on the line.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis equal,
minor x tick num=4,minor y tick num=4,ymin=-.5,ymax=2.5,xmin=-.5,xmax=4.5]
...
\begin{tikzpicture}[alt={A curve starting near (-1,4), passing through (3,2), turning downward and then back to the left to bottom out at (3,1) before turning back up to pass through (3,2) again and finishing near (6,4).}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis equal,
