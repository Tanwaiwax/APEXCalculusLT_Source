...
\begin{tikzpicture}[alt={A curve starting near (-10,3), moving down and left to a cusp at the origin.  Afterward, moving up and left so that it's vertical near (-1,2), passing through (0,4), and leaving the graph moving up and to the right.}]
...
\begin{tikzpicture}[alt={A curve starting near (1.5,0.5), moving up and left.  As it moves left, it starts wiggling up and down faster and faster.}]
\begin{axis}[width=1.167\marginparwidth,tick label style={font=\scriptsize},axis y line=middle,axis x line=middle,name=myplot,
...
\begin{tikzpicture}[alt={An ellipse centered at the origin where x reaches ±3 and y reaches ±5, traced counterclockwise.}]
\begin{axis}[width=1.167\marginparwidth,tick label style={font=\scriptsize},axis y line=middle,axis x line=middle,name=myplot,
...
\begin{tikzpicture}[alt={An ellipse centered at (2,3) where -1≤x≤5 and -2≤y≤8, traced counterclockwise.}]
\begin{axis}[width=1.167\marginparwidth,tick label style={font=\scriptsize},axis y line=middle,axis x line=middle,name=myplot,
...
\begin{tikzpicture}[alt={A parabola starting at (1,1), passing through (1/√2,0), bottoming out at (0,-1), and finishing in a mirror image through (-1/√2,0) and (-1,1).}]
\begin{axis}[width=1.167\marginparwidth,tick label style={font=\scriptsize},axis y line=middle,axis x line=middle,name=myplot,
...
\begin{tikzpicture}[alt={A figure eight starting at (1,0), moving upward to peak (0.7,1) before crossing the origin diagonally.  It finishes in a mirror image through the other three quadrants.}]
\begin{axis}[width=1.167\marginparwidth,tick label style={font=\scriptsize},axis y line=middle,axis x line=middle,name=myplot,
%minor x tick num=4,minor y tick num=4,
ymin=-1.1,ymax=1.1,xmin=-1.1,xmax=1.1]
...
\begin{tikzpicture}[alt={The right half of a hyperbola centered at the origin with vertices at (±2,0), traced upward.}]
\begin{axis}[width=1.167\marginparwidth,tick label style={font=\scriptsize},axis y line=middle,axis x line=middle,name=myplot,
minor x tick num=4,minor y tick num=4,
...
\begin{tikzpicture}[alt={The right half of a hyperbola centered at the origin with vertices (±1,0), traced upward from (3.8,-3.6) to (3.8,3.6).}]
...
\begin{tikzpicture}[alt={A roundish cloud shape with seven inner loops.}]
\begin{axis}[width=1.167\marginparwidth,tick label style={font=\scriptsize},axis y line=middle,axis x line=middle,name=myplot,
%minor x tick num=4,minor y tick num=4,
...
\begin{tikzpicture}[alt={A roundish shape with nine outer loops.}]
\begin{axis}[width=1.167\marginparwidth,tick label style={font=\scriptsize},axis y line=middle,axis x line=middle,name=myplot,
%minor x tick num=4,minor y tick num=4,
ymin=-1.5,ymax=1.5,xmin=-1.5,xmax=1.5]
