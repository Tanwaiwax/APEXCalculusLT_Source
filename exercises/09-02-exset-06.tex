\begin{exerciseset}{In Exercises}{, find parametric equations for the given rectangular equation using the parameter $\ds t=\frac{\dd y}{\dd x}$. Verify that at $t=1$, the point on the graph has a tangent line with slope of 1.}
