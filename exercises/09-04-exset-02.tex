\begin{exerciseset}{In Exercises}{, convert the  polar equation to a rectangular equation.}

% todo Tim this is the same as Example 10.4.6#4.
...
\exercise{$r=\tan\theta$}{$x^4+x^2y^2-y^2=0$}

\exercise{$r=\cot\theta$}{$y^4+x^2y^2-x^2=0$}
