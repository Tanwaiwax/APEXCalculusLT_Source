...
\exercise{$r=1$;\quad $\theta = \pi/4$}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
	\item $\frac{dy}{dx} = -\cot\theta$
	\item	tangent line: $y=-(x-\sqrt{2}/2)+\sqrt{2}/2$; normal line: $y=x$
\end{enumerate}}

\exercise{$r=\cos\theta$;\quad $\theta = \pi/4$}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
	\item $\frac{dy}{dx} = 1/2(\tan \theta-\cot\theta)$
	\item	tangent line: $y=1/2$; normal line: $x=1/2$
\end{enumerate}}

\exercise{$r=1+\sin\theta$;\quad $\theta = \pi/6$}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
...
\exercise{$\ds r=1-3\cos\theta$;\quad $\theta = 3\pi/4$}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
...
\exercise{$r=\theta$;\quad $\theta = \pi/2$}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
...
\exercise{$r=\cos(3\theta)$;\quad $\theta = \pi/6$}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
...
\exercise{$r=\sin(4\theta)$;\quad $\theta = \pi/3$}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
...
\exercise{$\ds r=\frac1{\sin\theta-\cos\theta}$;\quad $\theta = \pi$}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
	\item $\frac{dy}{dx} = 1$
