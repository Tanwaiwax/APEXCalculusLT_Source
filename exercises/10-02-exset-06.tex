\begin{exerciseset}{\parbox{\linewidth}{A weight of $p$ lb is suspended from a chain of length $\ell$ while a constant force of $\vec F_w$ pushes the weight to the right, making an angle of $\theta$ with the vertical, as shown in the figure below.\\
\null\hfill
\begin{tikzpicture}
