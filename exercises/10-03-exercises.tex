...
\input{exercises/10-03-exset-01}
...
\input{exercises/10-03-exset-02}

\input{exercises/10-03-exset-03}

\input{exercises/10-03-exset-04}

\input{exercises/10-03-exset-05}
...
% todo the solution to 11.3#40-46
...
\begin{center}
\begin{tikzpicture}[alt={Vectors u and v with an angle 𝜃 between them, and vector u-v pointing from the head of v to the head of u.},scale=2]
