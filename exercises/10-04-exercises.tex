...
\end{enumerate}
\end{multicols}}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{%
 \begin{enumerate}
  \item $\vec a\cdot(\vec b\times\vec c)
...
\begin{exerciseset}{In Exercises}{, calculate the determinant.}
...
\input{exercises/10-04-exset-01}
...
\input{exercises/10-04-exset-02}

\input{exercises/10-04-exset-03}

\input{exercises/10-04-exset-04}

\input{exercises/10-04-exset-05}

\input{exercises/10-04-exset-06}

\input{exercises/10-04-exset-07}
...
\begin{align*}
	...
	&(\bracket{u_2v_3-u_3v_2,-(u_1v_3-u_3v_1),u_1v_2-u_2v_1}) \\
