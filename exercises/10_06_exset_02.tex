...
\exercise{Passes through $(2,3,4)$ and has normal vector\\ $\vec n=\bracket{3,-1,7}$.
}{Standard form: $3(x-2)-(y-3)+7(z-4)=0$\\
general form: $3x-y+7z=31$
}

\exercise{Passes through $(1,3,5)$ and has normal vector\\ $\vec n=\bracket{0,2,4}$.
}{Standard form: $2(y-3)+4(z-5)=0$\\
general form: $2y+4z=26$
}

\exercise{Passes through the points $(1,2,3)$, $(3,-1,4)$ and $(1,0,1)$.
}{Answers may vary;\\
Standard form: $8(x-1)+4(y-2)-4(z-3)=0$\\
general form: $8x+4y-4z=4$
}

\exercise{Passes through the points $(5,3,8)$, $(6,4,9)$ and $(3,3,3)$.
}{Answers may vary;\\
...
$\ell_1(t) =\bracket{2,1,2}+ t\bracket{1,2,3}$ and \\
$\ell_2(t) =\bracket{2,1,2}+ t\bracket{2,5,4}$.
}{Answers may vary;\\
...
\exercise{Contains the intersecting lines\\
$\ell_1(t) =\bracket{5,0,3}+ t\bracket{-1,1,1}$ and \\
$\ell_2(t) =\bracket{1,4,7}+ t\bracket{3,0,-3}$.
}{Answers may vary;\\
...
$\ell_1(t) =\bracket{1,1,1}+ t\bracket{1,2,3}$ and \\
$\ell_2(t) =\bracket{1,1,2}+ t\bracket{1,2,3}$.
}{Answers may vary;\\
...
\exercise{Contains the parallel lines\\
$\ell_1(t) =\bracket{1,1,1}+ t\bracket{4,1,3}$ and \\
$\ell_2(t) =\bracket{2,2,2}+ t\bracket{4,1,3}$.
}{Answers may vary;\\
...
$\ell(t) =\bracket{4,5,6}+ t\bracket{1,1,1}$.
}{Answers may vary;\\
