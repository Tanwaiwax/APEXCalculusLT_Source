\exercisesetinstructions[Exercises]{ ask you to solve a variety of problems based on the principles of projectile motion.}
...
\end{enumext}}{The stone, while whirling, can be modeled by $\vrt =\bracket{3\cos(8\pi t),3\sin (8\pi t)}$. 
\begin{enumext}[start=1]
...
\end{enumext}}{The position function of the ball is\\
