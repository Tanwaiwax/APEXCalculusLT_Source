...
\input{exercises/11-05-exset-01}

\input{exercises/11-05-exset-02}

\input{exercises/11-05-exset-03}

\input{exercises/11-05-exset-04}

\input{exercises/11-05-exset-05}
...
\exercise{Find the curvature of $\vec r(t)=\bracket{f(t)\cos t,f(t)\sin t}$.}{Using \autoref{thm:curvature_formulas} part 2, we have $\kappa(t)=\frac{\abs{f(t)^2+2\fp(t)^2-\fpp(t)f(t)}}{(f(t)^2+\fp(t)^2)^{3/2}}$}
% x'=f'c-fs, y'=f's+fc, x'x'=f'f'cc-2f'fcs+ffss, y'y'=f'f'ss+2f'fsc+ffcc
% x'x'+y'y' = f'f'+ff
% x''=f''c-2f's-fc, y''=f''s+2f'c-fs
% x'y''-x''y' = 2f'f'-f''f+ff
