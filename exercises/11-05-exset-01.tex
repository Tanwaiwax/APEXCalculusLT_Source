\exercisesetinstructions{, a position function \vrt\ is given, where $t=0$ corresponds to the initial position. Find the arc length parameter $s$, and rewrite \vrt\ in terms of $s$; that is, find $\vec r(s)$.}
