...
\exercise{How is \textit{velocity} different from \textit{speed}?
}{
...
\exercise{What is the difference between \textit{displacement} and \textit{distance traveled}?
}{
...
\exercise{What is the difference between \textit{average velocity} and \textit{average speed}?
}{
...
\exercise{\textit{Distance traveled} is the same as \underline{\hskip .5in} \underline{\hskip .5in}, just viewed in a different context.
}{
arc length
}

\exercise{Describe a scenario where an object's average speed is a large number, but the magnitude of the average velocity is not a large number.
}{
...
\exercise{Explain why it is not possible to have an average velocity with a large magnitude but a small average speed.
}{
