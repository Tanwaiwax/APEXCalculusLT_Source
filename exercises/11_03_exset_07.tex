...
\end{enumerate}}{\mbox{}\\[-2\baselineskip]The position function of the ball is $\vrt =\bracket{(146.67\cos\theta)t,-16t^2+(146.67\sin\theta)t+3}$, where $\theta$ is the angle of elevation.
\begin{enumerate}
...
\end{enumerate}}{The position function of the ball is $\vrt =\bracket{(v_0\cos\theta)t,-16t^2+(v_0\sin\theta)t+6}$, where $\theta$ is the angle of elevation and $v_0$ is the initial ball speed.
\begin{enumerate}
