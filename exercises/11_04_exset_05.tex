\begin{exerciseset}{In Exercises}{, find $a_{\text{T}}$ and $a_{\text{N}}$ given $\vrt$. Sketch \vrt\ on the indicated interval, and comment on the relative sizes of $a_{\text{T}}$ and $a_{\text{N}}$ at the indicated $t$ values.}
