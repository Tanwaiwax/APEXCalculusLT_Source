\exerciseset{In Exercises}{, find $a_{\text{T}}$ and $a_{\text{N}}$ given $\vrt$. Sketch \vrt\ on the indicated interval, and comment on the relative sizes of $a_{\text{T}}$ and $a_{\text{N}}$ at the indicated $t$ values.
}{

\exercise{$\vrt =\bracket{t,t^2}$ on $[-1,1]$; consider $t=0$ and $t=1$.
...
\exercise{$\vrt =\bracket{t,1/t}$ on $(0,4]$; consider $t=1$ and $t=2$.
...
\exercise{$\vrt =\bracket{2\cos t,2\sin t}$ on $[0,2\pi]$; consider $t=0$ and $t=\pi/2$.
...
\exercise{$\vrt =\bracket{\cos (t^2),\sin (t^2)}$ on $(0,2\pi]$; consider $t=\sqrt{\pi/2}$ and $t=\sqrt{\pi}$.
...
\exercise{$\vrt =\bracket{a\cos t,a\sin t, bt}$ on $[0,2\pi]$, where $a,b>0$; consider $t=0$ and $t=\pi/2$.
...
\exercise{$\vrt =\bracket{5\cos t,4\sin t, 3\sin t}$ on $[0,2\pi]$; consider $t=0$ and $t=\pi/2$.
