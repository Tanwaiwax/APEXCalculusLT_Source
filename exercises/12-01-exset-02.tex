...
\begin{tikzpicture}[alt={Three lines of slope 3/2 through the points (0,-1), the origin, and (0,1).}]
...
\begin{tikzpicture}[alt={The lines y=±x are labeled c=0.  c=-1 is a hyperbola with vertices at (±1,0).  c=1 is a hyperbola with vertices at (0,±1).}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
...
\begin{tikzpicture}[alt={Parabolas opening to the right with vertices at (c,0) for the given values of c.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
ymin=-4.1,ymax=4.1,xmin=-4.1,xmax=4.1]
...
\begin{tikzpicture}[alt={Hyperbolas opening vertically centered at (c,c).}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
ymin=-4.1,ymax=4.1,xmin=-4.1,xmax=4.1]
...
\begin{tikzpicture}[alt={The line y=x and the circles ±(1,-1) with radius 1 labeled ±1.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
ymin=-4.1,ymax=4.1,xmin=-4.1,xmax=4.1]
...
\begin{tikzpicture}[alt={Various cubics passing through an inflection point at (0,1).}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
ymin=-4.1,ymax=4.1,xmin=-4.1,xmax=4.1]
...
\begin{tikzpicture}[alt={Ellipses centered at the origin that are twice as wide as tall.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
ymin=-4.1,ymax=4.1,xmin=-4.1,xmax=4.1]
