...
\input{exercises/12-05-exset-01}

\input{exercises/12-05-exset-02}

\input{exercises/12-05-exset-03}

\input{exercises/12-05-exset-04}

\exercisesetinstructions{, a function $w=F(x,y,z)$ and a point $P$ are give. Find the direction of maximum increase and the maximal value of the directional derivative for $F$ at $P$}
