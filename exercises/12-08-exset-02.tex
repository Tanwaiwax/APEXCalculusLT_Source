\exercisesetinstructions{,  functions $z=f(x,y)$, $x=g(t)$ and $y=h(t)$ are given. Find the values of $t$ where $\frac{\dd z}{\dd t}=0$. Note: these are the same surfaces/curves as found in Exercises~\ref{12_08_ex_07}--\ref{12_08_ex_08}.}
