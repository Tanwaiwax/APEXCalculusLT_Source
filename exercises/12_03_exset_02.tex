...
\exercise{$\ds f(x,y) = \sqrt{4xy^2+1}$
...
\exercise{$\ds f(x,y) =(2x+5y)\sqrt{y}$
...
\exercise{$\ds f(x,y) =5x-17y$
}{$f_x=5$, $f_y=-17$\\
$f_{xx}=0$, $f_{yy}=0$\\
$f_{xy}=0$, $f_{yx}=0$\\
}
\exercise{$\ds f(x,y) =3x^2+1$
}{$f_x=6x$, $f_y=0$\\
$f_{xx}=6$, $f_{yy}=0$\\
$f_{xy}=0$, $f_{yx}=0$\\
}
\exercise{$\ds f(x,y) =\ln(x^2+y)$
