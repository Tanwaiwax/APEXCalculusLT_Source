...
\end{enumerate}
}{$\nabla f =\bracket{\cos x\cos y, -\sin x\sin y}$; $\nabla f(\frac{\pi}{4},\frac{\pi}{3}) =\bracket{\frac{1}{2\sqrt{2}},-\frac12\sqrt{\frac32}}$. Be sure to change all directions to unit vectors. 
\begin{enumerate}
...
\end{enumerate}
}{$\nabla f =\bracket{\frac{-2x}{(x^2+y^2+1)^2}, \frac{-2y}{(x^2+y^2+1)^2}}$; $\nabla f(1,1) =\bracket{-2/9,-2/9}$. Be sure to change all directions to unit vectors.
\begin{enumerate}
