...
\exercise{$f(x,y) = 2x^2y-4xy^2$,  $\vec v =\bracket{1,3}$, $P=(2,3)$.\label{12_06_ex_05}}{\begin{enumerate}
...
\exercise{$f(x,y) = 3\cos x\sin y$,  $\vec v =\bracket{1,2}$, $P=(\pi/3, \pi/6)$.}{\begin{enumerate}
...
\exercise{$f(x,y) = 3x-5y$,  $\vec v =\bracket{1,1}$, $P=(4,2)$.}{\begin{enumerate}
...
\exercise{$f(x,y) = x^2-2x-y^2+4y$,  $\vec v =\bracket{1,1}$, $P=(1,2)$.\label{12_06_ex_08}}{\begin{enumerate}
