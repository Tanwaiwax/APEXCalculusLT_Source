\exerciseset{In Exercises}{, a function $z=f(x,y)$, a vector $\vec v$ and a point $P$ are given. Give the parametric equations of the following directional tangent lines to the graph of $f$ at $P$:
...
\exercise{$f(x,y) = 2x^2y-4xy^2$,  $\vec v =\bracket{1,3}$, $P=(2,3)$.\label{12_06_ex_05}}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
...
\exercise{$f(x,y) = 3\cos x\sin y$,  $\vec v =\bracket{1,2}$, $P=(\pi/3, \pi/6)$.}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
...
\exercise{$f(x,y) = 3x-5y$,  $\vec v =\bracket{1,1}$, $P=(4,2)$.}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
...
\exercise{$f(x,y) = x^2-2x-y^2+4y$,  $\vec v =\bracket{1,1}$, $P=(1,2)$.\label{12_06_ex_08}}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
