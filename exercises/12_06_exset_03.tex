\exerciseset{In Exercises}{, a function $z=f(x,y)$ and a point $P$ are given. Find the two points that are 2 units from the surface of the graph of $f$ at $P$. Note: these are the same functions as in Exercises~\ref{12_06_ex_05}--\ref{12_06_ex_08}.}{
