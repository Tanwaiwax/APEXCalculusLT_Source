\exerciseset{In Exercises}{, find the absolute maximum and minimum of the function subject to the given constraint.
}{

\exercise{$\ds f(x,y) = x^2+y^2+y+1$, constrained to the triangle with vertices $(0,1)$, $(-1,-1)$ and $(1,-1)$.
...
\exercise{$\ds f(x,y) = 5x-7y$, constrained to the region bounded by $y=x^2$ and $y=1$.
...
\exercise{$\ds f(x,y) = x^2+2x+y^2+2y$, constrained to the region bounded by the circle $x^2+y^2=4$.
...
\exercise{$\ds f(x,y) = 3y-2x^2$, constrained to the region bounded by the parabola $y=x^2+x-1$ and the line $y=x$.
}{The region has two ``corners'' at $(-1,-1)$ and $(1,1)$.\\
