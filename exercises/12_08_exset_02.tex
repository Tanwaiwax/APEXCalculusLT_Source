...
\exercise{$\ds z=x^2-y^2$,\qquad $x=t$,\qquad $y=t^2-1$
}{$t=0, \pm\sqrt{3/2}$
}

\exercise{$\ds z=5x+2y$,\qquad $x=2\cos t+1$,\qquad $y=\sin t-3$
}{$t=\tan^{-1}(1/5) +n\pi$, where $n$ is an integer
	
}

\exercise{$\ds z=\frac{x}{y^2+1}$,\qquad $x=\cos t$,\qquad $y=\sin t$
...
\exercise{$\ds z=x^2+2y^2$,\qquad $x=\sin t$,\qquad $y=3\sin t$
}{We find that $$\frac{dz}{dt} = 38\cos t\sin t.$$
Thus $\frac{dz}{dt} = 0$ when $t=\pi n$ or $\pi n+\pi/2$, where $n$ is any integer.}

\exercise{$\ds z=\cos x\sin y$,\qquad $x=\pi t$,\qquad $y=2\pi t+\pi/2$
