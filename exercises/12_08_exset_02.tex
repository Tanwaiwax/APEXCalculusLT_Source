\begin{exerciseset}{In Exercises}{,  functions $z=f(x,y)$, $x=g(t)$ and $y=h(t)$ are given. Find the values of $t$ where $\frac{dz}{dt}=0$. Note: these are the same surfaces/curves as found in Exercises~\ref{12_08_ex_07}--\ref{12_08_ex_08}.}
...
\exercise{$\ds z=\cos x\sin y$,\qquad $x=\pi t$,\qquad $y=2\pi t+\pi/2$}{We find that $\frac{dz}{dt} =$
