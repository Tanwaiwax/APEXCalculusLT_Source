...
\exercise{$\ds z=x^2y$,\qquad $x=s-t$,\qquad $y=2s+4t$;\qquad $s=1$, $t=0$
}{\begin{enumerate}
...
\exercise{$\ds z=\cos\big(\pi x+\frac{\pi}2y\big)$,\quad $x=st^2$,\quad $y=s^2t$;\quad $s=1$, $t=1$
}{\begin{enumerate}
...
\exercise{$\ds z=x^2+y^2$,\quad $x=s\cos t$,\quad $y=s\sin t$;\quad $s=2$, $t=\pi/4$
}{\begin{enumerate}
...
\exercise{$\ds z=e^{-(x^2+y^2)}$,\quad $x=t$,\quad $y=st^2$;\quad $s=1$, $t=1$
}{\begin{enumerate}
