...
3Droo=150.00000343149}{width=.7\linewidth}{figures/fig13_05_ex_05_3D}}{$\ds S = \int_0^{2\pi}\int_0^{2\pi} \sqrt{1+ \cos^2x\cos^2y+\sin^2x\sin^2y}\dd x\dd y$}
...
3Droo=150.00000281692286}{width=.7\linewidth}{figures/fig13_05_ex_06_3D}}{$\ds S = \int_{-3}^{3}\int_{-\sqrt{9-x^2}}^{\sqrt{9-x^2}} \sqrt{1+ \frac{4x^2+4y^2}{(1+x^2+y^2)^4}}\dd x\dd y$\\
...
3Droo=150.00000127208068}{width=.7\linewidth}{figures/fig13_05_ex_07_3D}}{$\ds S = \int_{-1}^{1}\int_{-1}^{1} \sqrt{1+ 4x^2+4y^2}\dd x\dd y$}
...
3Droo=149.99999722540937}{width=.7\linewidth}{figures/fig13_05_ex_08_3D}}{$\ds S = \int_{-5}^{5}\int_{0}^{1} \sqrt{1+ \frac{4x^2e^{2x^2}}{\bigl(1+e^{x^2}\bigr)^4}}\dd y\dd x$}
