\exercisesetinstructions{,  two surfaces $f_1(x,y)$ and $f_2(x,y)$ and a region $R$ in the $x$, $y$ plane are given. Set up and evaluate the double integral that finds the volume between these surfaces over $R$.}
