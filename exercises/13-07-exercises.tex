...
\input{exercises/13-07-exset-01}

\input{exercises/13-07-exset-02}

\input{exercises/13-07-exset-03}

\input{exercises/13-07-exset-04}

\input{exercises/13-07-exset-05}

\input{exercises/13-07-exset-06}

\input{exercises/13-07-exset-07}

\input{exercises/13-07-exset-08}

\input{exercises/13-07-exset-09}

\input{exercises/13-07-exset-10}
...
% todo the solution to 14.7#46, 48-52
...
% todo Tim can 14.7#50 fit into its space?
\exercise{Show that the distance $d$ between the points $P_1$ and $P_2$ with spherical coordinates $( \rho_1,\theta_1,\phi_1 )$ and $( \rho_2,\theta_2,\phi_2 )$, respectively, is $d=$
  \[
   \sqrt{\rho_1^2 + \rho_2^2 - 2 \rho_1\,\rho_2 [ \sin \phi_1 \,
...
\exercise{Evaluate $\ds\iint_{R} \sin \left( \frac{x+y}2 \right)\,\cos \left( \frac{x-y}2 \right)\dd A$, where $R$  is the triangle with vertices $(0,0)$, $(2,0)$ and $(1,1)$. (\emph{Hint: Use the change of variables $u=(x+y)/2$, $v=(x-y)/2$.})}{$1-\sin2/2$}
