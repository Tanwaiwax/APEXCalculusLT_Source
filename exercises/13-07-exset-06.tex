\begin{exerciseset}{In Exercises}{, a solid is described along with its density function. Find the mass of the solid using cylindrical coordinates.}
...
\[\int_0^{2\pi}\int_0^2\int_0^4 (r+1)r\dd z\dd r\dd \theta = 112\pi/3.\]}
...
\[\int_0^{2\pi}\int_2^3\int_0^{10} zr\dd z\dd r\dd \theta = 250\pi.\]}
...
\[\int_0^{2\pi}\int_0^1\int_{-\sqrt{1-r^2}}^{\sqrt{1-r^2}}r\dd z\dd r\dd \theta=4\pi/3.\]}
