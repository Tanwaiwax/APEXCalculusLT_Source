...
\exercise{$\ds \iint_R x^2y\dd A$, where $R$ is bounded by $y=\sqrt{x}$ and $y=x^2$.}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{enumerate}
...
\exercise{$\ds \iint_R x^2y\dd A$, where $R$ is bounded by $y=\sqrt[3]{x}$ and $y=x^3$.}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{enumerate}
\item \noindent \begin{minipage}{.9\linewidth}
\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,
...
\exercise{$\ds \iint_R x^2-y^2\dd A$, where $R$ is the rectangle with corners $(-1,-1)$, $(1,-1)$, $(1,1)$ and $(-1,1)$.}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{enumerate}
\item \noindent \begin{minipage}{.9\linewidth}
\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,
...
\exercise{$\ds \iint_R ye^x\dd A$, where $R$ is bounded by $x=0$, $x=y^2$ and $y=1$. }{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{enumerate}
\item \noindent \begin{minipage}{.9\linewidth}
\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,
...
\exercise{$\ds \iint_R \big(6-3x-2y\big)\dd A$, where $R$ is bounded by $x=0$, $y=0$ and $3x+2y=6$.}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{enumerate}
\item \noindent \begin{minipage}{.9\linewidth}
\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,
...
\exercise{$\ds \iint_R e^y\dd A$, where $R$ is bounded by $y=\ln x$ and\par $\ds y=\frac{1}{e-1}(x-1)$.}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{enumerate}
\item \noindent \begin{minipage}{.9\linewidth}
\begin{tikzpicture}
...
\exercise{$\ds \iint_R \big(x^3y-x\big)\dd A$, where $R$ is the half disk $x^2+y^2\le9$ in the first and second quadrants.}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{enumerate}
\item \noindent \begin{minipage}{.9\linewidth}
\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,
...
\exercise{$\ds \iint_R \big(4-3y\big)\dd A$, where $R$ is bounded by $y=0$, $y=x/e$ and $y=\ln x$.}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{enumerate}
\item \noindent \begin{minipage}{.9\linewidth}
\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,
