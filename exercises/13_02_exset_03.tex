\exerciseset{In Exercises}{, state why it is difficult/impossible to integrate the iterated integral in the given order of integration. Change the order of integration and evaluate the new iterated integral.}{

\exercise{$\ds \int_0^4\int_{y/2}^2 e^{x^2}\ dx\ dy$
...
\exercise{$\ds \int_0^{\sqrt{\pi/2}}\int_{x}^{\sqrt{\pi/2}} \cos\big(y^2\big)\ dy\ dx$
...
\exercise{$\ds \int_0^{1}\int_y^{1} \frac{2y}{x^2+y^2}\ dx\ dy$
...
\exercise{$\ds \int_{-1}^{1}\int_1^{2} \frac{x\tan^2y}{1+\ln y}\ dy\ dx$
