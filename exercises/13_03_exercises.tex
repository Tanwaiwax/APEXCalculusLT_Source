...
\exercise{When evaluating $\ds\iint_R f(x,y)\ dA$ using polar coordinates, $f(x,y)$ is replaced with \underline{\hskip .5in} and $dA$ is replaced with \underline{\hskip.5in}.}{$f\big(r\cos\theta,r\sin\theta\big)$, $r\ dr\ d\theta$}
...
\exercise{Evaluate $\ds\iint_R\frac1x\,dA$ where $R$ is the region that lies inside the circle $x^2+y^2=1$ and to the right of the parabola $2x+y^2=1$.}{$2$}

\exercise{Evaluate $\ds\iint_R(1+x^2+y^2)^{-3/2}\,dA$ where $R$ is that part of the disk $x^2+y^2\le1$ in the first quadrant.}{$(1-1/\sqrt2)\pi/2$}
