...
% todo Tim do we add the steps to calculate \int e^{-x^2} ?
...
Confirm that the volume of a right circular cone with height $h$ and base radius $a$ is $\ds V = \frac13\pi a^2h$ by evaluating $\ds \iint_R f(x,y)\ dA$ in polar coordinates.}{\begin{align*}
