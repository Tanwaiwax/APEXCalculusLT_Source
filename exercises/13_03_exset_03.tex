\begin{exerciseset}{In Exercises}{, special double integrals are presented that are especially well suited for evaluation in polar coordinates.}
...
Confirm that the volume of a right circular cone with height $h$ and base radius $a$ is $\ds V = \frac13\pi a^2h$ by evaluating $\ds \iint_R f(x,y)\ dA$ in polar coordinates.}{\mbox{}\\[-2\baselineskip]\parbox[t]{\linewidth}{\begin{align*}
	\iint_R & f(x,y)\ dA\\
