...
\exercise{$R$ is the $4\times 4$ square with corners at $(-2,-2)$ and $(2,2)$ with density $\delta(x,y) = 1$. 
}{$I_x = 64/3$; $I_y = 64/3$; $I_O = 128/3$
}
\exercise{$R$ is the $8\times 2$ rectangle with corners at $(-4,-1)$ and $(4,1)$ with density $\delta(x,y) = 1$. 
}{$I_x = 16/3$; $I_y = 256/3$; $I_O = 272/3$
}
\exercise{$R$ is the $4\times 2$ rectangle with corners at $(-2,-1)$ and $(2,1)$ with density $\delta(x,y) = 2$. 
}{$I_x = 16/3$; $I_y = 64/3$; $I_O = 80/3$
}
\exercise{$R$ is the circle with radius 2 centered at the origin with density $\delta(x,y) = 4/\pi$. 
