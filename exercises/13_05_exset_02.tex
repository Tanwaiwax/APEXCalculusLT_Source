...
\exercise{$f(x,y) = -2x+4y^2+7$ over $R$, the triangle bounded by $y=-x$, $y=x$, $0\leq y\leq 1$.}{\mbox{}\\[-2\baselineskip]\begin{align*}
...
\exercise{$f(x,y) = \frac23x^{3/2}+2y^{3/2}$ over $R$, the rectangle with opposite corners $(0,0)$ and $(1,1)$.}{\mbox{}\\[-2\baselineskip]\begin{align*}
