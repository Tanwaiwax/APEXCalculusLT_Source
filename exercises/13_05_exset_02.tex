...
\exercise{$f(x,y) = 3x-7y+2$; $R$ is the rectangle with opposite corners $(-1,0)$ and $(1,3)$.
}{$\ds SA = \int_{0}^{3}\int_{-1}^{1} \sqrt{1+ 9+49}\ dx\ dy = 6\sqrt{59} \approx 46.09$
}
\exercise{$f(x,y) = 2x+2y+2$; $R$ is the triangle with corners $(0,0)$, $(1,0)$ and $(0,1)$.
}{$\ds SA = \int_{0}^{1}\int_{0}^{1-x} \sqrt{1+ 4+4}\ dy\ dx = 18$
}
\exercise{$f(x,y) = x^2+y^2+10$; $R$ is the circle $x^2+y^2=16$.
...
\exercise{$f(x,y) = -2x+4y^2+7$ over $R$, the triangle bounded by $y=-x$, $y=x$, $0\leq y\leq 1$.
}{
...
\exercise{$f(x,y) = x^2+y$ over $R$, the triangle bounded by $y=2x$, $y=0$ and $x=2$.
}{
...
\exercise{$f(x,y) = \frac23x^{3/2}+2y^{3/2}$ over $R$, the rectangle with opposite corners $(0,0)$ and $(1,1)$.
}{
...
\exercise{$f(x,y) = 10-2\sqrt{x^2+y^2}$ over $R$, the circle $x^2+y^2=25$. (This is the cone with height 10 and base radius 5; be sure to compare you result with the known formula.)
}{This is easier in polar:
...
\exercise{Find the surface area of the sphere with radius 5 by doubling the surface area of $f(x,y) = \sqrt{25-x^2-y^2}$ over $R$, the circle $x^2+y^2=25$. (Be sure to compare you result with the known formula.)
}{This is easier in polar:
...
\exercise{Find the surface area of the ellipse formed by restricting the plane $f(x,y) = cx+dy+h$ to the region $R$, the circle $x^2+y^2=1$, where $c$, $d$ and $h$ are some constants. Your answer should be given in terms of $c$ and $d$; why does the value of $h$ not matter?
