\exerciseset{In Exercises}{,  a domain $D$ is described by its bounding surfaces, along with a graph. Set up the triple integrals that give the volume of $D$ in all 6 orders of integration, and find the volume of $D$ by evaluating the indicated triple integral.}{

\ifthenelse{\boolean{printquestions}}{\enlargethispage{2\baselineskip}}{}
...
3Dcoo=-9.639361381530762 -8.587801933288574 36.453922271728516,
3Droo=149.9999987284343,
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=0mm 10mm 0mm 0mm,clip}{figures/fig13_06_ex_08}}{	$dz\ dy\ dx$: $\ds\int_1^3\int_0^{2}\int_0^{(3-x)/2}\ dz\ dy\ dx$\\
...
3Droo=149.9999987284343,
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=0mm 0mm 0mm 0mm,clip}{figures/fig13_06_ex_09}}{$dz\ dy\ dx$: $\ds\int_0^2\int_{-2}^{0}\int_{y^2/2}^{-y}\ dz\ dy\ dx$\\
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=0mm 0mm 0mm 0mm,clip}{figures/fig13_06_ex_10}}{$dz\ dy\ dx$: $\ds\int_0^3\int_{3x}^{9}\int_{0}^{\sqrt{y^2-9x^2}}\ dz\ dy\ dx$\\
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=0mm 0mm 15mm 5mm,clip}{figures/fig13_06_ex_11}}{$dz\ dy\ dx$: $\ds\int_0^2\int_{1-x/2}^{1}\int_{0}^{2x+4y-4}\ dz\ dy\ dx$\\
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=0mm 0mm 5mm 5mm,clip}{figures/fig13_06_ex_12}}{$dz\ dy\ dx$: $\ds\int_{-2}^2\int_{0}^{4-x^2}\int_{0}^{2y}\ dz\ dy\ dx$\\
...
3Droo=149.9999987284343,
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=0mm 0mm 0mm 0mm,clip}{figures/fig13_06_ex_13}}{$dz\ dy\ dx$: $\ds\int_{0}^1\int_{0}^{1-x^2}\int_{0}^{\sqrt{1-y}}\ dz\ dy\ dx$\\
