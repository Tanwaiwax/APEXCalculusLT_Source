...
\exercise{\label{13_06_ex_07}$D$ is bounded by the coordinate planes and\\
 $z=2-2x/3-2y$.\\
...
\exercise{\label{13_06_ex_08}$D$ is bounded by the planes $y=0$, $y=2$,  $x=1$, $z=0$ and\\
 $z=(3-x)/2$.\\
...
\exercise{\label{13_06_ex_11}$D$ is bounded by the planes $x=2$, $y=1$,  $z=0$ and \\
 $z=2x+4y-4$.\\
...
\exercise{\label{13_06_ex_12}$D$ is bounded by the plane $z=2y$ and by $y=4-x^2$.\\
