\exerciseset{In Exercises}{,  points are given in either the rectangular, cylindrical or spherical coordinate systems. Find the coordinates of the points in the other systems.}{
...
\end{enumerate}}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
	\item Cylindrical: $(4,\frac\pi3,-1)$ and $(5\sqrt2,\frac{3\pi}4,6)$\\
		Spherical: $(\sqrt{17},\frac\pi3,\cos^{-1}\frac{-1}{\sqrt{17}})$ and $(\sqrt{86},\frac{3\pi}4,\cos^{-1}\frac6{\sqrt{86}})$
	\item Rectangular: $(\frac12,\frac{\sqrt3}2,-2)$ and $(-\sqrt3,-1,3)$\\
		Spherical: $(\sqrt5,\frac\pi3,\cos^{-1}(-\frac2{\sqrt5}))$ and $(\sqrt{13},\frac{5\pi}6,\tan^{-1}\frac23)$
