\exerciseset{In Exercises}{, a solid is described along with its density function. Find the mass of the solid using spherical coordinates. %(Note: these are the same solids and density functions as found in Exercises \ref{ex:13_07_ex_23} through \ref{ex:13_07_ex_26}.) 
}{
...
\[
\int_0^{\pi/2}\int_0^{2\pi}\int_0^1\rho^2\sin(\varphi)\ d\rho\ d\theta\ d\varphi
= 2\pi/3.
\]
...
\[
\int_0^\pi\int_0^{2\pi}\int_4^5(\rho)\rho^2\sin(\varphi)\ d\rho\ d\theta\ d\varphi
= 369\pi.
\]
...
\big(\rho\cos(\varphi)\big)\rho^2\sin(\varphi)\ d\rho\ d\theta\ d\varphi = \pi/8.
\]
