\begin{exerciseset}{In Exercises}{, a solid is described along with its density function. Find the mass of the solid using spherical coordinates. %(Note: these are the same solids and density functions as found in Exercises~\ref{ex:13_07_ex_23}--\ref{ex:13_07_ex_26}.) 
}
