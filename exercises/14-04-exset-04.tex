\exercisesetinstructions{, a vector field $\vec F$ and a closed curve $C$, enclosing a region $R$, are given. Verify the Divergence Theorem by evaluating both $\oint_C\vec F\cdot \vec n\dd s$ and $\iint_R \divv \vec F\dd A$, showing they are equal.}
