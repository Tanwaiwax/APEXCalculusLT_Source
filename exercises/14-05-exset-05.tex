\exercisesetinstructions{, set up the double integral that finds the surface area $S$ of the given surface \surfaceS, then use technology to approximate its value.}
