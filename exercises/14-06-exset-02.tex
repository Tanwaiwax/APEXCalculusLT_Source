\exercisesetinstructions{, a surface \surfaceS\ and a vector field $\vec F$ are given. Compute the flux of $\vec F$ across $\surfaceS$. (If \surfaceS\ is not a closed surface, choose $\vec n$ so that it has a positive $z$-component, unless otherwise indicated.)}
...
3Dlights=Headlamp}{120pt}{A dome whose base is an ellipse with -5<x<5 and -3<y<3.  It peaks at (0,0,1).}{figures/fig14_06_ex_13_3D}\hfill}
...
3Droo=149.9999987284343,
3Dlights=Headlamp}{120pt}{A sphere of radius 1 chopped off at z=1/2.}{figures/fig14_06_ex_14_3D}\hfill}
