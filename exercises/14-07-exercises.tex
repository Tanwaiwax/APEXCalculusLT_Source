...
\input{exercises/14-07-exset-02}

\input{exercises/14-07-exset-03}

\input{exercises/14-07-exset-04}

\input{exercises/14-07-exset-05}
...
\exercise{Construct a Möbius strip from a piece of paper, then draw a line down its center (like the dotted line in \autoref{fig:mobius}(b)). Cut the Möbius strip along that center line completely around the strip. How many surfaces does this result in? How would you describe them? Are they orientable?}{}

\exercise{Use a computer algebra system to plot the Möbius strip parameterized as $\vecr(u,v) =$
  \[
