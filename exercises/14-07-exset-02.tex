\begin{exerciseset}{In Exercises}{, a closed curve $C$ that is the boundary of a surface \surfaceS\ is given along with a vector field $\vec F$. Verify Stokes' Theorem on $C$; that is, show $\oint_C \vec F\cdot\dd\vec r = \iint_\surfaceS\bigl(\curl \vec F\,\bigr)\cdot\vec n\dd S$.}
...
% todo solve 15.7#10
\exercise{$C$ is the curve parametrized by $\vec r(t) =\bracket{\cos t, \sin t, 1}$ and $\surfaceS$ is the portion of $z=x^2+y^2$ enclosed by $C$; $\vec F=xy\,\veci+xz\,\vecj+yz\,\veck$}{}

% apex
\exercise{$C$ is the curve parametrized by $\vec r(t) =\bracket{\cos t, \sin t, 1}$ and $\surfaceS$ is the portion of $z=x^2+y^2$ enclosed by $C$; $\vec F =\bracket{z,-x,y}$. 
...
$\iint_\surfaceS\big(\curl \vec F\big)\cdot\vec n\dd S = \pi$.}

\exercise{$C$ is the curve parametrized by $\vec r(t) =\bracket{\cos t, \sin t, e^{-1}}$ and $\surfaceS$ is the portion of $z=e^{-x^2-y^2}$ enclosed by $C$; $\vec F =\bracket{-y,x,1}$.
...
$\iint_\surfaceS\big(\curl \vec F\big)\cdot\vec n\dd S = \iint_\surfaceS 0 \dd S = 0$.}
...
$\iint_\surfaceS\big(\curl \vec F\big)\cdot\vec n\dd S = -4/5$.}
