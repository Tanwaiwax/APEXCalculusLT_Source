\begin{exerciseset}{In Exercises}{, a planar curve $C$ is given along with a surface $f$ that is defined over $C$. Evaluate the line integral $\ds \int_Cf(s)\ ds.$}
