\begin{exerciseset}{In Exercises}{, sketch the given vector field over the rectangle with opposite corners $(-2,-2)$ and $(2,2)$, sketching one vector for every point with integer coordinates (i.e., at $(0,0)$, $(1,2)$, etc.).}
