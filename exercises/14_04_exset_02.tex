\begin{exerciseset}{In Exercises}{, a vector field $\vec F$ and a closed curve $C$, enclosing a region $R$, are given. Verify Green's Theorem by evaluating $\oint_C\vec F\cdot d\vec r$ and $\iint_R \curl \vec F\ dA$, showing they are equal.}
