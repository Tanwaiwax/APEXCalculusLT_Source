...
\exercise{$C$ is the curve parametrized by $\vec r(t) =\bracket{\cos t,\sin (2t)}$ on $0\leq t\leq 2$. }{Any choice of $\vec F$ is appropriate as long as $\curl \vec F = 1$. The choices of  $\vec F =\bracket{-y,0}$, $\bracket{0,x}$ and $\bracket{-y/2,x/2}$ each lead to reasonable integrands. The area of $R$ is $16/15$.}
