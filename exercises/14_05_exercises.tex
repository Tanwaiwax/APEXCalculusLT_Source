...
\exercise{Give an example of a non-orientable surface.}{Many possible answers exist; the one given by the book is the M\"obius band.}
...
\input{exercises/14_05_exset_01}

\input{exercises/14_05_exset_02}
