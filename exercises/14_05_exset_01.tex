\exerciseset{In Exercises}{, parametrize the surface defined by the function $z=f(x,y)$ over each of the given regions $R$ of the $x$-$y$ plane.}{
...
\end{enumerate}}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
	...
	\item	$\vec r(u,v) =\\\bracket{3v\cos u+1, 3v\sin u+2, 3(3v\cos u+1)^2(3v\sin u+2)}$, on $0\leq u\leq 2\pi$, $0\leq v\leq 1$.
...
\end{enumerate}}{\mbox{}\\[-2\baselineskip]\begin{enumerate}
	...
	\item	$\vec r(u,v) =\bracket{u,u+v(4-2u),4u+2\big(u+v(4-2u)\big)^2}$ on $0\leq u\leq 2$, $0\leq v\leq 1$.
