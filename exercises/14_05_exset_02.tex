\exerciseset{In Exercises}{, a surface $\surfaceS$ in space is described that cannot be defined in terms of a function $z=f(x,y)$. Give a parametrization of \surfaceS.}{
...
\exercise{\surfaceS\ is the elliptic cone $\ds y^2= x^2+\frac{z^2}{16}$, for $-1 \leq y \leq 5$.}{Answers may vary; one solution is $\vec r(u,v) =\bracket{v\cos u, v, 4v\sin u}$ with $0\leq u\leq 2\pi$, $-1\leq v\leq 5$.}
