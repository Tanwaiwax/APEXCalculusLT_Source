...
\exercise{\surfaceS\ is the elliptic cone $\ds y^2= x^2+\frac{z^2}{16}$, for $-1 \leq y \leq 5$.
%\ifthenelse{\boolean{printquestions}}{\columnbreak}{}
}{Answers may vary; one solution is $\vec r(u,v) =\bracket{v\cos u, v, 4v\sin u}$ with $0\leq u\leq 2\pi$, $-1\leq v\leq 5$.}
