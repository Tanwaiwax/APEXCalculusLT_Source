...
\input{exercises/14_07_exset_01}

\input{exercises/14_07_exset_02}

\input{exercises/14_07_exset_03}

\input{exercises/14_07_exset_04}

\input{exercises/14_07_exset_05}
...
\exercise{Let $\surfaceS$ be a closed surface and $\vec F$ a smooth vector field. Show that $\ds\iint_{\surfaceS} (\curl{\vec F}\,)\cdot\vecn\,dS= 0$. (\emph{Hint: Split $\surfaceS$ in half.})}{}
