...
\exerciseset{In Exercises}{, use the Divergence Theorem to evaluate the surface integral $\iint_{\Sigma} \Dotprod{\textbf{f}}{d\sigma}$ of the given vector field $\textbf{f}(x,y,z)$ over the surface $\Sigma$.}{
