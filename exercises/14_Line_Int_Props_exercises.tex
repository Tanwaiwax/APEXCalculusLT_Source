...
\exercise{Let\label{contra_green} $\vecf(x,y)=\frac{-y}{x^2 + y^2}\,\veci + \frac{x}{x^2 + y^2}\,\vecj$ for all $(x,y)\ne(0,0)$, and $C:$ $x=\cos t$, $y=\sin t$, $0\le t\le 2\pi$.
  \begin{enumerate}
...
\exercise{For $\vecf=\bracket{xy,y}$, evaluate $\ds\oint_C\vecf\cdot d\vecr$ where $C$ is $x=\cos t$, $y=\sin t$ for $0\le t\le2\pi$. Is $\vecf$ conservative?}{$0$; no}

\exercise{For $\vecf=\bracket{y^2,x^2}$, evaluate $\ds\int_C\vecf\cdot d\vecr$ for:
\begin{enumerate}
\item $C$ given by $x=t$, $y=t^2$ for $0\le t\le1$.
\item $C$ given by $x=t^2$, $y=t$ for $0\le t\le1$.
\item Is $\vecf$ conservative?
\end{enumerate}}{$7/10$; $7/10$; no}

\exercise{For $\vecf=\bracket{xy^2,x^2y}$, evaluate $\ds\int_C\vecf\cdot d\vecr$ where $C$ is $x=t\cos t$, $y=t\sin t$ for $0\le t\le5\pi/4$}{$625\pi^4/2048$}

\exercise{For $\vecf=\bracket{2xe^y,2y+x^2e^y}$, evaluate $\ds\int_C\vecf\cdot d\vecr$ where $C$ is the polygonal path from $(1,0)$ to $(2,1)$ to $(0,0)$.}{$-1$}
