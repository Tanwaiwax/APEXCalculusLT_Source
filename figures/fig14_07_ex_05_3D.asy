...
draw((4,0,0)--(0,3,0)--(0,0,2)--cycle,colorone+linewidth(2));
draw((4,0,0)--(0,0,0),colorone+linewidth(2));
draw((0,3,0)--(0,0,0),colorone+linewidth(2));
draw((0,0,2)--(0,0,0),colorone+linewidth(2));
...
surface s=surface(f,(0,0),(3,1),1,1,
usplinetype=new splinetype[] {notaknot,notaknot,monotonic});
pen p=colorone;
draw(s,emissive(coloronefill),meshpen=p);
