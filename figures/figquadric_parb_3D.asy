...
//ASY file for fig:quadric1 in Chapter 10 sec:space_coord
// and subsequent quadric library
...
//Add labels
label(minipage("\noindent \centering In plane\\ $y=0$"),(4,0,6),N);
draw((4.25,0,5.5)--(4,0,4.25),linewidth(.75),Arrow3);
label(minipage("\noindent \centering In plane\\ $x=0$"),(0,2,6),N);
draw((0,2.25,5.5)--(0,2,4.25),linewidth(.75),Arrow3);
label(minipage("\noindent \centering In plane\\ $z=d$"),(-1,3,1),N);
