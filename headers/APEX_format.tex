...
%\exerciseheader%
%\small%
%\noindent\underline{\parbox{\textwidth}{\hyperref[sol#3]{\textbf{\huge#2}}\refstepcounter{subsection}\label{exer#3}}}% 
%\sffamily%
%\bigskip%
%\begin{multicols}{2}%
%	\openin\exansread=#1 
...
\exercisegeometry%
\exerciseheader%
\exercisesubsection{\sectiontag}%
%\noindent\underline{\parbox{\textwidth}{%
%\hyperref[sol\sectiontag]{\textbf{\huge Exercises \sectiontag}}%
%\refstepcounter{subsection}}}%
\label{exer\sectiontag}%
\small%
\bigskip%
\begin{multicols}{2}%
\input{#1}%
...
\newcommand*{\lxenumerate}[1]{\iflatexml\begin{enumerate}\else\begin{enumerate}[#1]\fi}
