...
\textbf{Example~\refstepcounter{examplecounter}\label{#1}\theexamplecounter%
\lxAddClass{exampleNum}}%
~\textbf{#2}

The example:\lxAddClass{beginExample}

#3\vskip \baselineskip%
\textsc{\small\bfseries Solution\lxAddClass{solutionTag}}%
#4

QED.\lxAddClass{endExample}%
}%
...
% white: hsl(x,x,100)
% blue: hsl(240,100,50)
% line color: blue!95!black!30: blue!95!black!30!white:
%   hsl(240,100,50)!95!black!30!white: hsl(240,100,48)!30!white: hsl(240,100,84)
...
\long\def\newspecialbox#1#2#3#4#5{%
\iflatexml\makeenv{#1}{#5}\fi%
\newcounter{#1counter}%
\expandafter\long\expandafter\def\csname #1\endcsname ##1##2##3{%
\vskip\baselineskip%
\noindent\refstepcounter{#1counter}\label{##1}%
\coloredbox
{rectangle,text width = \specialboxlength, inner xsep=\specialboxinnerseplengthx, inner ysep=\specialboxinnerseplengthy, anchor=north west,yshift=\specialboxinnerseplengthy,#3}
{draw=black,thick,rectangle,text width = \specialboxlength, inner xsep=\specialboxinnerseplengthx, inner ysep=\specialboxinnerseplengthy, anchor=north west,yshift=\specialboxinnerseplengthy,#4}
{\textbf{#2~\arabic{#1counter}\hskip 20pt ##2}\vskip.5\baselineskip\iflatexml\\\fi
...
\newspecialbox{definition}{Definition}{draw = yellow!95!black!60,top color = white!95!yellow, bottom color = yellow!90!black!30, text justified, very thick}{draw, text justified, very thick}{60}
% yellow!95!black!60 : hsl(60,100,47)!60 : hsl(60,100,68)
% white!95!yellow : hsl(60,100,97)
% yellow!90!black!30 : hsl(60,100,45)!30 : hsl(60,100,84)

\newspecialbox{theorem}{Theorem}{draw = green!30!black!50,top color = white!95!green, bottom color = green!60!black!20, text justified, very thick}{draw, text justified, very thick}{120}
% green!30!black!50 : hsl(120,100,15)!50 : hsl(120,100,68)
% white!95!green : hsl(120,100,97)
% green!60!black!20 : hsl(120,100,30)!20 : hsl(120,100,86)

\newspecialbox{keyidea}{Key Idea}{draw = red!30!black!50,top color = white!95!red, bottom color = red!60!black!20, text justified, very thick}{draw, text justified, very thick}{0}
% red!30!black!50 : hsl(0,100,15)!50 : hsl(0,100,68)
% white!95!red : hsl(0,100,97)
% red!60!black!20 : hsl(0,100,30)!20 : hsl(0,100,86)
