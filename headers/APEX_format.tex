...
\ifthenelse{\boolean{printoddanswersonly}\AND\(\value{section}=0\)}{%
 ...
 \write\answrite{\noexpand\begin{enumerate}[leftmargin=0pt]\noexpand\input{#1}\noexpand\end{enumerate}}%
...
\newcommand{\exerciseset}[3]{\ifthenelse{\boolean{printquestions}}{%
 ...
 \stepcounter{exerciseset}%
 \noindent#1 \arabic{saveexerciseenum}--\ref{enumiatendof\theexerciseset}#2%
 \addtocounter{saveexerciseenum}{-1}%
 #3
 \label{enumiatendof\theexerciseset}%
}{
 #3
}}
