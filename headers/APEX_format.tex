...
\newcommand{\exercisesubsectiontitle}[1]{\huge\textbf{\texorpdfstring{\hyperref[sol#1]{Exercises #1}}{Exercises}}\hrule}
...
\newcommand{\exercisesetinstructions}[2][In Exercises]{%
 ...
 \noindent#1 \arabic{enumi}--\ref*{enumiatendof\theexercisesetcounter}\bgroup
 \renewcommand{\theenumi}{(\alph{enumi})}%
 #2\egroup%
 % can't \addtocounter{enumi}{-1} because #2 may have an enumerate
