...
\newcommand{\printproblems}{\bigbreak\noindent\textit{\Large Problems}\bigskip}
\newcommand{\printreview}{\bigbreak\noindent\textit{\Large Review}\bigskip}
\newcommand{\printconceptsB}{\closeenumerate\noindent\textit{\Large Terms and Concepts}\bigskip}
\newcommand{\printproblemsB}{\closeenumerate\bigbreak\noindent\textit{\Large Problems}\bigskip}
\newcommand{\printreviewB}{\closeenumerate\bigbreak\noindent\textit{\Large Review}\bigskip}

\renewcommand{\printconcepts}{\printconceptsB}
\renewcommand{\printproblems}{\printproblemsB}
\renewcommand{\printreview}{\printreviewB}
...
\newcommand{\inanswersection}{%
	...
	\renewcommand{\printconceptsB}{}%
	\renewcommand{\printproblemsB}{}%
	\renewcommand{\printreviewB}{}%
}%
...
\newcounter{exercisesetcounter}[chapter]
\newboolean{enumopen}
\setboolean{enumopen}{false}
\newcommand{\sectiontag}{undefined}

\newcommand{\inputexercises}[1]{%
\renewcommand{\sectiontag}{\arabic{chapter}.\arabic{section}}%
\writeToAnsFileB{#1}{Exercises \sectiontag}{\sectiontag}%
\exercisegeometry%
\exerciseheader%
\small%
\noindent\underline{\parbox{\textwidth}{\textbf{\huge Exercises \sectiontag}
\hyperref[\expandafter sol\sectiontag]{(solutions)}%
\refstepcounter{subsection}\label{\expandafter exer\sectiontag}}}% 
\sffamily%
\bigskip%
\begin{multicols}{2}%
\input{#1}%
...
\ifthenelse{\boolean{printoddanswersonly}\AND\(\value{section}=0\)}{%
 \immediate\write\answrite{\noexpand\setboolean{printoddanswersonly}{false}}%
 \immediate\write\answrite{\noexpand\begin{enumerate}[leftmargin=1.5em]\noexpand\input{#1}\noexpand\end{enumerate}}%
 \immediate\write\answrite{\noexpand\setboolean{printoddanswersonly}{true}}%
}{%
 \immediate\write\answrite{\noexpand\begin{enumerate}[leftmargin=1.5em]\noexpand\input{#1}\noexpand\end{enumerate}}%
}%
\immediate\write\answrite{\noexpand\bigbreak}%
...
\newcommand{\exerciseset}[3]{\ifthenelse{\boolean{printquestions}}{%
 ...
 \noindent#1 \arabic{saveexerciseenum}--\ref{enumiatendof\thechapter_\theexercisesetcounter}#2%
 \addtocounter{saveexerciseenum}{-1}%
 #3
 \label{enumiatendof\thechapter_\theexercisesetcounter}%
}{
 #3
}}
