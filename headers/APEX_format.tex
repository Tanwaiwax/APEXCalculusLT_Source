...
%  \end{enumext}
  % we need to reset the counter after all.  this seems to be a bad way to do it
  % see https://tex.stackexchange.com/q/746415/107497
  \sbox0{\parbox{0pt}{\begin{enumext}[start=0]\item ignore\end{enumext}}}%
  \input{#1}%
  \closeenumerate%
 \end{multicols}%
 \restoregeometry%
