...
%\makeatother
\providecommand{\sectionifdifferent}[1]{} % in case it's still in there
...
%\newcommand{\printconcepts}{\closeenumerate\subsubsection*{Terms and Concepts}}
...
%\newcommand{\printproblems}{\closeenumerate\subsubsection*{Problems}}
\newcommand{\printproblems}{\closeenumerate\exercisesubsubsection{Problems}}
%{\bigbreak\noindent\textit{\Large Problems}\bigskip}
%\newcommand{\printreview}{\closeenumerate\subsubsection*{Review}}
...
\newcommand*{\answersForSection}[3]{%
 \ifthenelse{\equal{#1}{\lastanswerchapter}}{}{%
  \renewcommand{\lastanswerchapter}{#1}
  \section*{Chapter #1}
  \ifthenelse{\boolean{latexml}}{}{\belowpdfbookmark{Chapter #1}{solsol#1}}
