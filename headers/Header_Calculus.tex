...
% \mfigure[options]{offset}{caption}{label}{file}
\newcommand{\mfigure}[5][]%
		{\mnote[#2]{\centering\myincludegraphics[#1]{#5}
...
\newcommand{\mnote}[2][0ex]{\marginpar{\vspace{#1}
		\begin{minipage}[c][0pt]{.99\marginparwidth}
		#2
		\end{minipage}}}
...
\newcommand{\mfigurethree}[6]%
		...
		\includemedia[#1]{\includegraphics{#6_3D\colornamesuffix}}{#6_3D.prc}}{% not
