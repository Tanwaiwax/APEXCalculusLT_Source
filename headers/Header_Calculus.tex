...
\usepackage{pst-fun} % for psBill in 14_Stokes
...
% mecmath commands to remove

\newcommand{\Real}[1]{\mathbb{R}^{#1}}
\newcommand{\ival}[2]{[#1,#2]}
\newcommand{\Crossprod}[2]{#1\times#2}
\newcommand{\ssub}[2]{#1_#2}
\newcommand{\Dotprod}[2]{#1\cdot#2}
\newcommand{\lineintvec}[3]{\int_#1 #2\cdot d #3}
\newcommand{\olineintvec}[3]{\oint_#1 #2\cdot d#3}
