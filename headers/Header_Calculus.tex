...
\makeatletter
% the best that I could get with sectsty. also couldn't get the rule to work
%\chapterfont{\raggedright\reset@font\Huge\scshape\textsc}%\sectionrule{0pt}{0pt}{-10pt}{1pt}}
