...
label("$abcdefghi$",(xbounds.y+0.05*(xbounds.y-xbounds.x),0,0));
label("$jklmnopqr$",(0,ybounds.y+0.05*(ybounds.y-ybounds.x),0));
label("$stuvwxyz$",(0,0,zbounds.y+0.05*(zbounds.y-zbounds.x)));
