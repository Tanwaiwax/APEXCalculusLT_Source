...
label("$aaaaaaaaa$",(xbounds.y+0.05*(xbounds.y-xbounds.x),0,0));
label("$aaaaaaaaa$",(0,ybounds.y+0.05*(ybounds.y-ybounds.x),0));
label("$aaaaaaaa$",(0,0,zbounds.y+0.05*(zbounds.y-zbounds.x)));
