...
\tcolorboxenvironment{example}{
    ...
    overlay unbroken={
     ...
     \node[xshift=10pt](stop\arabic{example})at(frame.south west){};
...
%\newcommand{\northsouth}[2][]{\ifthenelse{\equal{#2}{top}}{#1north}{#1south}}
...
% I'd like to convert this to an environment, but then
% (1) @currenvir==exerciseset and
% (2) the \closeenumerate comes after the \begin{exerciseset}, so that the nesting gets disordered
