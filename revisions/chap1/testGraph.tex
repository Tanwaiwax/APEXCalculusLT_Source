...
\addplot [{\colorone}, dashed, smooth, domain=-1:5,thick] {(6*(x^3-4*x)/((x+2)^3) +.65*x-1}; % Curve a
\node[label={30:{\scriptsize $a$}}] at (axis cs:-1,2.1) {};
\addplot [{\colortwo}, smooth, domain=-1:5,thick] {(13*x^3+78*x^2+876*x-376)/(20*x^3+120*x^2+240*x+160)}; %Curve b
\node[label={30:{\scriptsize $c$}}] at (axis cs:.55,2.1) {};
\addplot [{\colorone}, smooth, domain=-1:5, thick] {(-72*x+144)/(x^4+8*x^3+24*x^2+32*x+16)}; %Curve c
...
bad:
\begin{tikzpicture}
\begin{axis}[xtick=\empty, ytick=\empty, axis y line=middle,axis x line=middle, ymin=-3,ymax=3.5, xmin=-2,xmax=2, name=myplot, xscale=1.1/1,]

%Curve d
\addplot [{\colorone}, dashed, smooth, domain=-3:3,thick] {.5*x^5-2*x}; 
\node[label={30:{\scriptsize $d$}}] at (axis cs:1.6,2.1) {};
%Curve c
\addplot [{\colortwo}, smooth, domain=-2:2,thick] {2.5*x^4-2};
\node[label={30:{\scriptsize $c$}}] at (axis cs:1.1,2.1) {};
%Curve b
\addplot [{\colorone}, smooth, domain=-2:2, thick] {10*x^3};
\node[label={30:{\scriptsize $b$}}] at (axis cs:.55,2.1) {};
%Curve a
\addplot [{\colortwo}, dashed, smooth, domain=-2:2, thick] {30*x^2};
