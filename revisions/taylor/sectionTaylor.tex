...
%%and the closest the homework comes to using it is Assignment 7, \# 6, which is
%%entirely self-contained.
%consequently, you are free to stop reading this once
%you get tired of trying to figure it out.  But if you're curious, feel free
%to read on.
...
% p_2(x,y)&=f(0,0)+f_x(0,0)x+f_y(0,0)y+\frac12f_{xx}(0,0)x^2+
% f_{xy}(0,0)xy+\frac12(0,0)y^2 \\
% p_3(x,y)&=f(0,0)+f_x(0,0)x+f_y(0,0)y+\frac12f_{xx}(0,0)x^2+
% f_{xy}(0,0)xy+\frac12(0,0)y^2 \\
% &\phantom{=f(0,0)}+\frac1{3!}f_{xxx}(0,0)x^3+\frac12f_{xxy}(0,0)x^2y
% +\frac12f_{xyy}(0,0)xy^2+\frac1{3!}f_{yyy}(0,0)y^3 \\
