...
singularity exec $singularitydir/latexml.sif $latexmlscripts/latexmlpost --destination=lab/moverMunder/moverMunder.xhtml --stylesheet=apexepub.xsl lab/moverMunder/moverMunder.xml
