...
\begin{gather*}
\mbox{now~you~see~me}\\
\mbox{}\makebox[0pt]{now~you~still~see~me}
\end{gather*}
...
\begin{tabular}{ c c }
item 1 & \multirow{3}{*}{item 2 should be at the bottom} \\
...
\begin{minipage}{.5\linewidth}%
\begin{tabular}{ c c }
item 7 & \multirow{2}{*}{item 8 should be at the bottom} \\
% see https://tex.stackexchange.com/a/364935/107497
item 9
\end{tabular}
\end{minipage}%
...
\begin{minipage}{.5\linewidth}%
\begin{tabular}{ c c }
item 4 & \multirow{3}{*}{item 5 should be at the bottom} \\
% see https://tex.stackexchange.com/a/364935/107497
item 6
\end{tabular}
\end{minipage}
