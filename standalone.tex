...
%For my use, I needed to modify `\includemedia` and `\mix_embedasset:n`.  Since they're ~350 and ~100 lines long, I created a separate style file that modifies those functions and incorporates your change.
