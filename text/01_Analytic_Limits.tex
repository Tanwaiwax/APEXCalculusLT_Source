...
\mtable[-1.5in]{The situation of the squeeze theorem}{fig:squeeze_thm}{\begin{tikzpicture}[alt={A blue h(x) above a dashed g(x) above a red f(x).  All three come together when x=c.}]
