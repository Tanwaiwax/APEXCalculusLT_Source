...
\end{tikzpicture}}{A blue curve with red dashed horizontal lines marking the 𝜖 boundaries.}
		\\
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{The same picture as before, but now red dashed vertical lines mark the 𝛿 boundaries.}
		\\
		\noindent
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A blue curve, with red dashed horizontal lines marking the 𝜖 boundaries and red dashed vertical lines marking the 𝛿 boundaries.}}
