...
\end{tikzpicture}}{A blue segment of a curve in the first quadrant.}
\\(a)\\
\pdftooltip{\begin{tikzpicture}
 \begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize },
 ...
 \node [right] at (myplot.right of origin) {\scriptsize $x$};
 \node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{An upside down U shape with a hole at the point (0,1).}
\\(b)}
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A blue segment of a curve in the first quadrant with a hole near the point (3,0.3).}
\\ (a) \smallskip\\
\begin{tabular}{lc}
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A blue segment from (-1,0) to a hole at (0,1), and then a curve to (1,0).}
\\ (a) \\
\begin{tabular}{ll}
 $x$ & $f(x)$ \\ \midrule
 $-0.1$ & $0.9$ \\
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A blue curve from (0,3) to a filled dot at (1,2).  Then it jumps to a line segment from a hollow dot at (1,1) to (2,2).}
\\ (a) \\
\begin{tabular}{ll}
 $x$ & $f(x)$ \\ \midrule
 0.9 & 2.01 \\
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A blue curve along the x axis that spikes upward at x=1.}
\\ (a) \smallskip\\
\begin{tabular}{lr}
 $x$ & $f(x)$ \\ \midrule
 0.9 & 100 \\
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A blue curve that wiggles wildly near the origin.}
&
\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
minor x tick num=1,axis y line=middle,axis x line=middle,
ymin=-1.1,ymax=1.1,xmin=-.11,xmax=.11,name=myplot]
\addplot[draw={\colorone},smooth,thick,domain=-.1:-.01]{sin(deg(1/x))};
\addplot[draw={\colorone},smooth,thick,domain=.01:.1]{sin(deg(1/x))};
\addplot[draw={\colorone},smooth,thick,domain=-.01:.01]{sin(deg(1/x))};
\end{axis}
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{Zooming in, the blue curve is even more wild.}
&
\begin{tabular}[b]{lr}
 $x$ & $\sin(1/x)$ \\ \midrule
 0.1 &    $-0.544021$ \\
...
\mtable[-\baselineskip]{We can interpret a difference quotient as the slope of a secant line.}{fig:diffquot1}{%
\pdftooltip{\begin{tikzpicture}
...
\end{tikzpicture}}{A blue upside down arc, with a red line cutting through it.}}% ideally, this would go on the next page.
...
\mtable[-\baselineskip]{Secant lines of $f(x)$ at $x=1$ and $x=1+h$, for shrinking values of $h$ (i.e., $h\rightarrow 0$).}{fig:diff_quot_small_h}{%
\pdftooltip{\begin{tikzpicture}
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $f$};
\end{tikzpicture}}{A blue upside down arc with a red line cutting off a small portion.}
	\\ (a) \\
\pdftooltip{\begin{tikzpicture}
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $f$};
\end{tikzpicture}}{A blue upside down arc with a red line cutting off a tiny portion.}
	\\ (b) \\
\pdftooltip{\begin{tikzpicture}
\begin{axis}[clip=false,width=1.16\marginparwidth,
tick label style={font=\scriptsize},minor x tick num=1,axis y line=middle,
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $f$};
\end{tikzpicture}}{A blue upside down arc with a red line cutting off a miniscule portion.}
	\\(c)}
...
%
\mtable{The difference quotient for $f(x)=-1.5x^2+11.5x$ evaluated at $x=1$ and values of $h$ near 0.}{table:diff_quot_smallh}{\begin{tabular}{lc}
