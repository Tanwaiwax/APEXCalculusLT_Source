...
\mtable[-4\baselineskip]{$\sin(x)/x$ near $x=1$ (top) and $x=0$ (bottom).}{fig:sinx_over_x}%
{\begin{tikzpicture}
...
\mtable{Graphically and numerically approximating a limit in \autoref{ex_limit1}.}{fig:limit1}{\begin{tikzpicture}
...
\mtable[-.75in]{Interpreting a difference quo\-tient as the slope of a secant line.}{fig:diffquot1}{\begin{tikzpicture}
