...
\mtable{Graphically and numerically approximating a limit in \autoref{ex_limit1}.}{fig:limit1}{\myincludegraphics{figures/figlimit1}
\\ (a) \smallskip\\
\begin{tabular}{lc}
...
\mtable{Graphically and numerically approximating a limit in \autoref{ex_limit2}.}{fig:limit2}{\myincludegraphics{figures/figlimit2} \\ (a) \\
\begin{tabular}{ll}
 $x$ & $f(x)$ \\ \midrule
 $-0.1$ & $0.9$ \\
 $-0.01$ & $0.99$ \\
...
\mtable{Graphically and numerically observing no limit as $x\to 1$ in \autoref{ex_no_limit2}.}{fig:nolimit2}{\myincludegraphics{figures/fignolimit2}
\\ (a) \smallskip\\
\begin{tabular}{lr}
 $x$ & $f(x)$ \\ \midrule
 0.9 & 100 \\
...
\mtable[-1.4in]{Secant lines of $f(x)$ at $x=1$ and $x=1+h$, for shrinking values of $h$ (i.e., $h\rightarrow 0$).}{fig:diff_quot_small_h}{%
	\myincludegraphics{figures/figDiffQuotSmallha}
	\\ (a) \\
	\myincludegraphics{figures/figDiffQuotSmallhb} 
	\\ (b) \\
	\myincludegraphics{figures/figDiffQuotSmallhc}
	\\(c)}
