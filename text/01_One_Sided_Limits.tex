...
%
\mtable{A graph of $f$ in \autoref{ex_onesidea}.}{fig:onesided1}{\pdftooltip{\begin{tikzpicture}
...
\end{tikzpicture}}{A segment connecting (0,0) to (1,2) with solid dots at both ends.  Another segment connects (1,4) to (2,2) with hollow dots at both ends.}}% ends the mtable
%
\begin{multicols}{2}
...
\end{multicols}
%
\mtable[1in]{A graph of $f$ from \autoref{ex_onesideb}}{fig:onesidedb}{\pdftooltip{\begin{tikzpicture}
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A line segment connecting (0,2) to a hollow dot at (1,1) and then curving to (2,0).}}
%
\solution
...
%
\mtable[-1in]{Graphing $f$ in \autoref{ex_onesidec}}{fig:onesidedc}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
minor x tick num=1,axis y line=middle,axis x line=middle,
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A U shaped graph from (0,1) to a hollow dot at (1,0) to (2,1).  There is also a dot at (1,1).}}
%
\begin{multicols}{2}
	\begin{enumerate}\lxAddClass{columns2}
		\item	$\ds \lim_{x\to 1^-} f(x)$
