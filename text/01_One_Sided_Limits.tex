...
\end{multicols}
%
\mtable[1in]{A graph of $f$ from \autoref{ex_onesideb}}{fig:onesidedb}{\begin{tikzpicture}[alt={A line segment connecting (0,2) to a hollow dot at (1,1) and then curving to (2,0).}]
...
%
\mtable[-1in]{Graphing $f$ in \autoref{ex_onesidec}}{fig:onesidedc}{\begin{tikzpicture}[alt={A U shaped graph from (0,1) to a hollow dot at (1,0) to (2,1).  There is also a dot at (1,1).}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
minor x tick num=1,axis y line=middle,axis x line=middle,
