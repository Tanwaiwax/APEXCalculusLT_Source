...
\begin{minipage}[t]{1.27\linewidth}\noindent%
...
\end{tikzpicture}}{A U shape, touching the origin.}
&
\pdftooltip{\begin{tikzpicture}[scale = \picturescale]
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{Flat at the origin, going up to the right and down to the left.}
&
\pdftooltip{\begin{tikzpicture}[scale = \picturescale]
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{Starting along the x axis, and then swooping upward.}
&
\pdftooltip{\begin{tikzpicture}[scale = \picturescale]
\begin{axis}[axis y line=middle, axis x line=middle, xmin=-.5, xmax=6.5, ymin=-1.2, ymax=1.2,name=myplot, ytick={-1,0,1}, xtick={-6.28318, -4.7123889, -3.14159, -1.5708, 1.5708, 3.14159, 4.7123889, 6.28318}, xticklabels={-$2\pi$, $-\frac{3\pi}{2}$,$-\pi$, $-\frac{\pi}{2}$, $\frac{\pi}{2}$,$\pi$, $\frac{3\pi}{2}$, $2\pi$},axis equal]
\addplot[draw={\colorone}, domain=-.5:6.4, thick, smooth]{sin deg(x)};
\end{axis}
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A wave passing through the origin.}
&
\pdftooltip{\begin{tikzpicture}[scale = \picturescale]
\begin{axis}[axis y line=middle, axis x line=middle, xmin=-2.2, xmax=2.2, ymin=-.5, ymax=2.2,name=myplot, ytick={0,1,2},axis equal]
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A V touching the origin.}
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{Starting at the origin, moving upward and then leveling off.}
&
\pdftooltip{\begin{tikzpicture}[scale = \picturescale]
\begin{axis}[axis y line=middle, axis x line=middle, xmin=-2.2, xmax=2.2, ymin=-2.2, ymax=2.2,name=myplot,axis equal]
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{Vertical at the origin, moving up to the right and down to the left, but leveling off as it gets away from the origin.}
&
\pdftooltip{\begin{tikzpicture}[scale = \picturescale]
