...
%
\mtable{$f(x) = \cos x^2$ sketched along with its tangent line at $x=1$.}{fig:chain7}{\pdftooltip{\begin{tikzpicture}
...
\end{tikzpicture}}{The curve begins near (-3,-1), rises quickly to (-2.5,1), falls quickly to (-1.8,-1), rises to flatten out near (0,1), and then repeats the process reflected across the y axis.  The line tangent near (1,0.5) is steep.}}
%
\[y = -1.68(x-1)+0.54.\]
...
\mtable[-.5in]{A series of gears to demonstrate the Chain Rule. Note how $\frac{\dd y}{\dd x} = \frac{\dd y}{\dd u}\cdot\frac{\dd u}{\dd x}$}{fig:chainrulegears}{\pdftooltip{\begin{tikzpicture}[>=latex,scale=.8]
...
\end{scope}
\end{scope}
\end{tikzpicture}}{A large gear labeled x is twice as big as a medium sized gear labeled u, which is in turn three times as big as a small gear labeled y.}}
%
