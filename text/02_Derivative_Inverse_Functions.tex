...
\]}{\begin{enumerate}
\item We use \autoref{thm:deriv_inverse_trig} and the Chain Rule to find: % todo
\[\fp(x)=-\frac{1}{\sqrt{1-x^2}}(2x)=- \frac{2x}{\sqrt{1-x^2}}\]
\item We use \autoref{thm:deriv_inverse_trig} and the Quotient Rule to compute: 
\begin{align*}
 g\primeskip'(x)
 &=\frac{\left(\frac 1{\sqrt{1-x^2}}\right)\sqrt{1-x^2} - (\sin^{-1} x)\left( \frac 1{2\sqrt{1-x^2}} (-2x)\right)}{\sqrt{1-x^2}^2}\\
...
\[\int\frac{\sin^{-1}x}{\sqrt{1-x^2}}=\int u\ du=\frac12 u^2+C=\frac 12\sin^{-1}x+C\]
