...
\example{ex_deriv_arcsin}{Finding the derivative of an inverse trigonometric function}{Let $y = \arcsin x = \sin^{-1} x$. Find $y\primeskip'$ using \autoref{thm:deriv_inverse_functions}.}
...
\mfigure{0in}{Graphs of $\sin x$ and $\sin^{-1}x$ along with corresponding tangent lines.}{fig:inverse4}{figures/figinverse4}

%\mfigure{0in}{Graphs of $\sin x$ and $\sin^{-1}x$}{fig:inverse4b}{figures/figinverse4}
...
Using similar techniques, we can find the derivatives of all the inverse trigonometric functions. In \autoref{fig:domain_trig} we show the restrictions of the domains of the standard trigonometric functions that allow them to be invertible.\\
...
Note how the last three derivatives are merely the opposites of the first three, respectively. Because of this, the first three are used almost exclusively throughout this text.\bigskip
