...
Consider $f(x) = x^2$ as shown in \autoref{fig:xsquared} with tangent lines at $x=1$ and $x=3$. It is clear that at $x=3$ the function is growing faster than at $x=1$, as it is steeper at $x=3$. How much faster is it growing?
\solution
