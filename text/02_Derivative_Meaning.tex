...
%subsection*{The Meaning of the Derivative}
...
\khanVideo{CpDfay5NeCg}{interpreting-slope-of-a-curve-exercise}{\textbf{Interpreting slope of a curve exercise}}

\example{ex_der_meaning3}{Understanding the derivative: the rate of change}{
\mfigure{-1in}{A graph of $f(x)=x^2$.}{fig:xsquared}{figures/figxsquared}
...
\mfigure{.4in}{A graph of $f(x)=x^2$ and tangent lines.}{fig:xsquaredwithgrid}{figures/figxsquaredwithgrid}
...
Consider the graph of $f(x)$ and its derivative, $\fp(x)$, in Figure \ref{fig:fwithderiv}(a). %f[x_] := InterpolatingPolynomial[{-1, 0, 2}, x]*4,MAKE BIGGER, PLOT THIS WITH F' NO INTEGRATE,IDIOT
 ...
 %\mfigure{0in}{Graphs of $f$ and $\fp$ in Example \ref{ex_der_meaning4}.}{fig:fwithderiv}{figures/figfwithderiv}
\mtable[1.7in]{Graphs of $f$ and $\fp$ in Example \ref{ex_der_meaning4}, along with tangent lines in (b).}{fig:fwithderiv}{
\begin{tabular}{c}
...
%\mfigure{0in}{Graphs of $f$ and $\fp$ in Example \ref{ex_der_meaning4}, along with tangent lines.}{fig:fwithderivdots}{figures/figfwithderivdots}
...
\mfigure{2in}{Zooming in on $f$ at $x=3$ for the function given in Examples \ref{ex_der_meaning4} and \ref{ex_der_meaning5}.}{fig:fwithderivzoom3}{figures/figfwithderivzoom3}
