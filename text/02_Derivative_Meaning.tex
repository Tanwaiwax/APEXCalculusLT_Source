...
Consider
%
\mtable{A graph of $f(x)=x^2$ and tangent lines.}{fig:xsquared}{\begin{tikzpicture}[alt={A curve from the origin to (4,16), with two lines tangent at separate locations.}]
...
%
\mtable{Zooming in on $f$ and its tangent line at $x=3$ for the function given in Examples \ref{ex_der_meaning4} and \ref{ex_der_meaning5}.}{fig:fwithderivzoom3}{\begin{tikzpicture}[alt={The previous image, zoomed in where the function is near (3,4).}]
