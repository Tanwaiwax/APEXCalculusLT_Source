...
\mfigure{0in}{A graph of $f(x)=x^2$ and tangent lines.}{fig:xsquared}{figures/figxsquaredwithgrid}

%\mtable{A graph of $f(x)=x^2$ and tangent lines.}{fig:xsquared}{\begin{tabular}{c}
%\myincludegraphics{figures/figxsquared} \\
%(a) \\\addlinespace
%\myincludegraphics{figures/figxsquaredwithgrid} \\
%(b)
%\end{tabular}}%
...
\mfigure{0in}{Graphs of $f$ and $\fp$ in \autoref{ex_der_meaning4}, along with tangent lines.}{fig:fwithderiv}{figures/figfwithderivdots}
%\mtable{Graphs of $f$ and $\fp$ in \autoref{ex_der_meaning4}, along with tangent lines in (b).}{fig:fwithderiv}{
%\begin{tabular}{c}
...
%\mfigure{0in}{Graphs of $f$ and $\fp$ in \autoref{ex_der_meaning4}, along with tangent lines.}{fig:fwithderivdots}{figures/figfwithderivdots}
...
%
\mfigure{0in}{Zooming in on $f$ at $x=3$ for the function given in Examples \ref{ex_der_meaning4} and \ref{ex_der_meaning5}.}{fig:fwithderivzoom3}{figures/figfwithderivzoom3}
%
