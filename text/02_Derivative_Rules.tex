...
\settowidth{\cellwidth}{\textbf{Constant Rule:} $\dfrac \dd{\dd x}\bigl( c\bigr) = 0$,\qquad}%
...
\item\makebox[\cellwidth][l]{\textbf{Constant Rule:} $\dfrac \dd{\dd x}\bigl( c\bigr) = 0$,}
\item\makebox[\cellwidth][l]{\textbf{Power Rule:} $\dfrac \dd{\dd x}\left(x^n\right) = nx^{n-1}$,}\\
\phantom{3.}\makebox[\cellwidth][l]{\qquad where $c$ is a constant.}
\phantom{3.}\makebox[\cellwidth][l]{\qquad where $n$ is any real number.}\\
\item\makebox[\cellwidth][l]{$\dfrac \dd{\dd x}(\sin x) = \cos x$}
\item\makebox[\cellwidth][l]{$\dfrac \dd{\dd x}(\cos x) = -\sin x$} \\[2ex]
\item\makebox[\cellwidth][l]{$\dfrac \dd{\dd x}\left(e^x\right) = e^x$}
\item\makebox[\cellwidth][l]{$\dfrac \dd{\dd x}(\ln x) = \dfrac1x$}
