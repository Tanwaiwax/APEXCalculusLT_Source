...
\theorem{thm:deriv_common}{Derivatives of Common Functions}{\mbox{}\smallskip\\[-\baselineskip]\index{derivative!basic rules}\index{derivative!Constant Rule}\index{derivative!Power Rule}\index{Power Rule!differentiation}
\iflatexml\begin{enumerate}\else\begin{enumerate*}\fi\noindent
\lxAddClass{twoColumnListByRows}
\item \parbox[t]{13em}{\sword{Constant Rule:}
	$\ds \frac{d}{dx}\big( c\big) = 0$,\\
	\phantom{.}~where $c$ is a constant.}
\item \parbox[t]{13em}{\sword{Power Rule:}
