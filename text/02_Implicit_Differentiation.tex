...
\begin{align*}
	...
	&= \cos(x^2y^2) \cdot (x^2 \cdot 2yy\primeskip'+2y^2)\\
	&= 2(x^2yy\primeskip'+y^2)\cos(x^2y^2). \\
\end{align*}
...
\mtable{A graph of the equation $\sin(x^2y^2)+y^3=x+y$ and certain tangent lines.}{fig:implicit5}{%
\begin{tabular}{c}
\myincludegraphics{figures/figimplicit5} \\
(a) \\
\begin{tikzpicture}
...
% todo move Logarithmic differentiation to Calc 2
...
%\mfigure{0in}{A graph of $y=x^x$ and its tangent line at $x=1.5$.}{fig:implicit10}{figures/figimplicit10}}\bigskip

% todo this is a weak section summary
