...
\mtable{A graph of the equation $\sin (y)+y^3=6-x^3$.}{fig:implicit1}{\pdftooltip{\begin{tikzpicture}
...
\end{tikzpicture}}{A curve starting near (-2.7,2.9), crossing the y axis near y=1.7, having a bump near (1.3,1.3), crossing the x axis near x=1.8, and finishing near (2.9,-2.6).}}
...
\mtable{The equation $\sin y+y^3 = 6-x^3$ and its tangent line at the point $(\sqrt[3]{6},0)$.}{fig:implicit2}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
minor x tick num=1,minor y tick num=1,axis y line=middle,axis x line=middle,
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{The same curve as the previous image, with a steep, negatively sloped tangent line that is tangent near the point (1.8,0).}}
...
\mtable{A graph of the equation $y^3+x^2y^4=1+2x$ along with its tangent line at the point $(0,1)$.}{fig:implicit4}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
minor x tick num=1,minor y tick num=1,axis y line=middle,axis x line=middle,
...
\mtable{A graph of the equation $\sin(x^2y^2)+y^3=x+y$ and certain tangent lines.}{fig:implicit5}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
minor x tick num=1,minor y tick num=1,axis y line=middle,axis x line=middle,
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{This is a very wiggly curve.  It starts in the third quadrant, wanders to the fourth quadrant, passes through the origin to the second quadrant, and then wanders to the first quadrant.}
\\ (a) \\
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{The same curve as before.  Tangent lines at (0,±1) have slope 1/2, while a tangent line at the origin has slope -1.}
\\ (b)}
...
\mtable[-1in]{The unit circle with its tangent line at $(1/2,\sqrt{3}/2)$.}{fig:implicit7}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
minor x tick num=1,minor y tick num=1,axis y line=middle,axis x line=middle,
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{The tangent line has slope -1/√3.}}
\end{example}
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A diamond shape, with the four sides pushed inward so that the corners are more pointed.}
  &
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A squarish shape, with the corners rounded off.}
   &
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A peanut shape, oriented along the x-axis.}
  &
