...
\paragraph{Practical Note:}When working by hand, it may be beneficial to use the symbol $\frac{\dd y}{\dd x}$ instead of $y\primeskip'$, as the latter can be easily confused for $y$ or $y^1$.
...
%% the following derives \dd/\dd x x^r, but implicit derivation assumes that the derivative already exists
