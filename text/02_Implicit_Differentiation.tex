...
\mfigure{0in}{A graph of the equation $\sin (y)+y^3=6-x^3$.}{fig:implicit1}{figures/figimplicit1}
...
\mfigure{0in}{The equation $\sin y+y^3 = 6-x^3$ and its tangent line at the point $(\sqrt[3]{6},0)$.}{fig:implicit2}{figures/figimplicit2}
...
\mfigure{0in}{A graph of the equation $y^3+x^2y^4=1+2x$ along with its tangent line at the point $(0,1)$.}{fig:implicit4}{figures/figimplicit4}
...
\mtable{A graph of the equation $\sin(x^2y^2)+y^3=x+y$ and certain tangent lines.}{fig:implicit5}{\myincludegraphics{figures/figimplicit5} \\ (a) \\
\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},minor x tick num=1,minor y tick num=1,axis y line=middle,axis x line=middle,ymin=-1.95,ymax=1.95,xmin=-1.95,xmax=1.95,name=myplot]

\addplot [{\colorone},smooth,thick] coordinates
...
\mfigure{-1in}{The unit circle with its tangent line at $(1/2,\sqrt{3}/2)$.}{fig:implicit7}{figures/figimplicit7}}
...
%
%%\mfigure{0in}{An astroid, traced out by a point on the smaller circle as it rolls inside the larger circle.}{fig:implicit9}{figures/figimplicit9}
%
%\mtable{An astroid, traced out by a point on the smaller circle as it rolls inside the larger circle, along with a tangent line.}{fig:implicit8}{\begin{tabular}{c}
%\myincludegraphics{figures/figimplicit9} \\
%(a) \\\addlinespace
%\myincludegraphics{figures/figimplicit8} \\
%(b)
%\end{tabular}}
...
% todo find curves that would go in a gallery of famous implicit equations

% todo write a better section summary
...
\begin{minipage}{.5\specialboxlength}
	\begin{enumerate}
	\item		$\frac{d}{dx}\big(cu\big) = cu'$\stepcounter{enumi}
	\item		$\frac{d}{dx}\big(u\cdot v\big) = uv'+u'v$\stepcounter{enumi}
	\item		$\frac{d}{dx}\big(u(v)\big) = u'(v)v'$\stepcounter{enumi}
	\item		$\frac{d}{dx}\big(c\big) = 0$\stepcounter{enumi}
	\item		$\frac{d}{dx}\big(\ln x\big) = \frac{1}{x}$\stepcounter{enumi}
	\item		$\frac{d}{dx}\big(\sin x\big) = \cos x$\stepcounter{enumi}
	\item		$\frac{d}{dx}\big(\tan x\big) = \sec^2x$\stepcounter{enumi}
	\item		$\frac{d}{dx}\big(\sec x\big) = \sec x\tan x$\stepcounter{enumi}
%	\item		$\frac{d}{dx}\big(\sin^{-1}x\big) = \frac{1}{\sqrt{1-x^2}}$\stepcounter{enumi}
%	\item		$\frac{d}{dx}\big(\csc^{-1}x\big) = -\frac{1}{\abs{x}\sqrt{x^2-1}}$\stepcounter{enumi}
%	\item		$\frac{d}{dx}\big(\tan^{-1}x\big) = \frac{1}{1+x^2}$\stepcounter{enumi}
	\end{enumerate}
\end{minipage}%
\begin{minipage}{.5\specialboxlength}
	\begin{enumerate}\stepcounter{enumi}
	\item		$\frac{d}{dx}\big(u\pm v\big) = u'\pm v'$\stepcounter{enumi}
	\item		$\frac{d}{dx}\big(\frac uv\big) = \frac{u'v-uv'}{v^2}$\stepcounter{enumi}
	\item		$\frac{d}{dx}\big(x^n\big) = nx^{n-1}$\stepcounter{enumi}
	\item		$\frac{d}{dx}\big(x\big) = 1$\stepcounter{enumi}
	\item		$\frac{d}{dx}\big(e^x\big) = e^x$\stepcounter{enumi}
%	\item		$\frac{d}{dx}\big(a^x\big) = \ln a\cdot a^x$\stepcounter{enumi}
%	\item		$\frac{d}{dx}\big(\log_a x\big) = \frac{1}{\ln a}\cdot\frac{1}{x}$\stepcounter{enumi}
	\item		$\frac{d}{dx}\big(\cos x\big) = -\sin x$\stepcounter{enumi}
	\item		$\frac{d}{dx}\big(\cot x\big) = -\csc^2x$\stepcounter{enumi}
	\item		$\frac{d}{dx}\big(\csc x\big) = -\csc x\cot x$\stepcounter{enumi}
%	\item		$\frac{d}{dx}\big(\cos^{-1}x\big) = -\frac{1}{\sqrt{1-x^2}}$\stepcounter{enumi}
%	\item		$\frac{d}{dx}\big(\sec^{-1}x\big) = \frac{1}{\abs{x}\sqrt{x^2-1}}$\stepcounter{enumi}
