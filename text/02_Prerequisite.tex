\section{Chapter Prerequisites}\label{sec:deriv_prereqs}
...
\begin{example}[Product Law of Exponents]\label{prereq_exp_prod}%
...
\begin{example}[Quotient Law of Exponents]\label{prereq_exp_quot}%
\setlength{\abovedisplayskip}{-1.5ex}
\begin{align*}
...
\begin{example}[Power Law of Exponents]\label{prereq_exp_pow}%
\setlength{\abovedisplayskip}{-1.5ex}
\begin{align*}
...
\begin{example}[Product and Quotient Raised to a Power]\label{prereq_exp_dist}%
\setlength{\abovedisplayskip}{-1.5ex}
\begin{align*}
 (xyz)^7 &= x^7y^7z^7 \\
...
\begin{example}[Factoring out the common factor]\label{ex_prereq_gcf}%
...
\begin{example}[Simplifying complex fractions]\label{ex_prereq_fraction}%
...
\begin{example}[Composition of two functions]\label{ex_prereq_comp_of_two}%
...
\begin{example}[Composition of three functions]\label{ex_prereq_comp_of_three}%
...
\begin{example}[Decomposing a function]\label{ex_prereq_decomp}%
...
\printexercises{exercises/02-00-exercises}
