...
\begin{align*}
 ...
 x^{-3}\cdot x^{4} &= x^{-3\cdot4}=x^{-12}=\dfrac1{x^{12}} \\
 x^{-1/2}\cdot x^{2/3} &= x^{-1/2\cdot2/3}=x^{-1/3}=\frac1{\sqrt[3]{x}}.\eoehere
\end{align*}}
...
\[
 1.\quad x^{7/3}-5x^{2/3} \qquad
 2.\quad \frac12 x(x-3)^{-2/5}+(x-3)^{3/5}
\]}{\begin{enumerate}
\item\qquad
...
\begin{align*}
 ...
 &= \frac12 (x-3)^{-2/5}\bigl(1 + 2(x -3)\bigr)\\
 &= \frac12 (x-3)^{-2/5}(1 + 2x -6)\\
 &= \frac12 (x-3)^{-2/5}(2x -5) \\
 &= \frac{2x-5}{2(x-3)^{2/5}} \qquad\text{or} \\
 &= \frac{2x-5}{2\sqrt[5]{(x-3)^2}}\eoehere
\end{align*}
\end{enumerate}}
