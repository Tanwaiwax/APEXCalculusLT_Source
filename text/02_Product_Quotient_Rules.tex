...
\mtable[1in]{A graph of $y = 5x^2\sin x$ and its tangent line at $x=\pi/2$.}{fig:5xsquaredsinx}{\begin{tikzpicture}[alt={A curve beginning flat at the origin before increasing to (2.3,20) and then turning back to finish at (π,0).  The tangent line at x=π/2 is steep.}]
