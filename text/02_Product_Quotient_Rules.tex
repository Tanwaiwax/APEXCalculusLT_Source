...
\mtable[1in]{A graph of $y = 5x^2\sin x$ and its tangent line at $x=\pi/2$.}{fig:5xsquaredsinx}{\pdftooltip{\begin{tikzpicture}
...
\end{tikzpicture}}{A curve beginning flat at the origin before increasing to (2.3,20) and then turning back to finish at (π,0).  The tangent line at x=π/2 is steep.}}
...
\begin{align*}
	...
	&= \sec ^2 x.
\end{align*}
\mtable{A graph of $y=\tan x$ along with its tangent line at $x=\pi/4$.}{fig:tanx}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
minor x tick num=1,minor y tick num=1,axis y line=middle,axis x line=middle,
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A curve beginning near (-π/2,-20), increasing quickly and then flattening out as it passes through the origin before turning to increase quickly again and finish near (π/2,20).  The tangent line at x=π/4 appears to have a shallow slope because of the scaling of the axes.}}
