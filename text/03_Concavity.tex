...
\mtable[-1in]{A function $f$ with a graph that is (a) concave up and (b) concave down. Notice how the slopes of the tangent lines, when looking from left to right, are (a) increasing and (b) decreasing.}{fig:concavity1}{%
\myincludegraphics{figures/figconcavity1} \\ (a) \\
\myincludegraphics{figures/figconcavity2} \\ (b)}
...
\mtable{A number line determining the concavity of $f$ and a graph of $f$ used in \autoref{ex_conc1}.}{fig:concline1}{\begin{tikzpicture}
