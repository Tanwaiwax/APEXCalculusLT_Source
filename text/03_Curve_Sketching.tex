...
\mtable{Demonstrating the 4 ways that concavity interacts with increasing / decreasing, along with the relationships with the first and second derivatives.}{fig:concavity3}{\pdftooltip{\begin{tikzpicture}%[scale=.9]
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{ALT-TEXT-TO-BE-DETERMINED}\\ (b)}
...
\includegraphics[alt={ALT-TEXT-TO-BE-DETERMINED}]{figures/raw/figmathematica_sinx}
