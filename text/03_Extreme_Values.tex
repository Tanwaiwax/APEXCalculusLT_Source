...
{Let $f$ be a continuous function defined on a closed interval $I$. Then $f$ has both a maximum and minimum value on $I$.\hfill\hyperref[pf:extreme_val]{(See the proof.)}
