...
\mtable[-2.5in]{Graphs of functions with and without extreme values.}{fig:extreme}{\begin{tabular}{c}
 \myincludegraphics{figures/figextreme1} \\ (a) \\\addlinespace
 \myincludegraphics{figures/figextreme2} \\ (b) \\\addlinespace
 \myincludegraphics{figures/figextreme3} \\ (c)
\end{tabular}}
...
\example{ex_extval1}{Approximating extreme values}{Consider $f(x) = 2x^3-9x^2$ on $I=[-1,5]$, as graphed in \autoref{fig:extval1}. Approximate the extreme values of $f$.
\mfigure{0in}{A graph of $f(x) = 2x^3-9x^2$ as in \autoref{ex_extval1}.}{fig:extval1}{figures/figextval1}}
...
\example{ex_extval2}{Approximating relative extrema}{Consider $f(x) = (3x^4-4x^3-12x^2+5)/5$, as shown in \autoref{fig:extval2}. Approximate the relative extrema of $f$. At each of these points, evaluate $\fp$.
\mfigure{0in}{A graph of $f(x) = (3x^4-4x^3-12x^2+5)/5$ as in \autoref{ex_extval2}.}%
...
\example{ex_extval3}{Approximating relative extrema}{Approximate the relative extrema of $f(x) = (x-1)^{2/3}+2$, shown in \autoref{fig:extval3}. At each of these points, evaluate $\fp$.
\mfigure{0in}{A graph of $f(x) = (x-1)^{2/3}+2$ as in \autoref{ex_extval3}.}{fig:extval3}{figures/figextval3}}
...
\theorem{thm:criticalpts}{Fermat's Theorem}
...
\example{ex_extval4}{Finding extreme values}{Find the extreme values of $f(x) = 2x^3+3x^2-12x$ on $[0,3]$, graphed in \autoref{fig:extval4}(a).}
...
\mtable[-.5in]{A graph and table of extreme values of $f(x) = 2x^3+3x^2-12x$ on $[0,3]$ as in \autoref{ex_extval4}.}{fig:extval4}{\begin{tabular}{c}
\myincludegraphics{figures/figextval4} \\ (a) \\\addlinespace
\begin{tabular}{cr}
 $x$ & $f(x)$ \\ \midrule
 0 & 0 \\
 1 & $-7$\\
...
\example{ex_extval5}{Finding extreme values}{Find the maximum and minimum values of $f$ on $[-4,2]$, where $$f(x) = \begin{cases} (x-1)^2 & x\leq 0 \\ x+1 & x>0 \end{cases} .$$
}
{%
\mtable{A table of extreme values and graph of $f(x)$ on $[-4,2]$ as in \autoref{ex_extval5}.}{fig:extval5}{\begin{tabular}{c}
\begin{tabular}{rr}
 $x$ & $f(x)$ \\ \midrule
 $-4$ & 25 \\
 0 & 1 \\
...
\example{ex_extval6}{Finding extreme values}{Find the extrema of  $f(x) = \cos (x^2)$ on $[-2,2]$.}
{%
\mtable[-1in]{A table of extreme values and graph of $f(x)= \cos (x^2)$ on $[-2,2]$ in \autoref{ex_extval6}.}{table:ext6}{\begin{tabular}{c}
\begin{tabular}{cl}
 $x$ & $f(x)$ \\ \midrule
 $-2$ & $-0.65$ \\
 $-\sqrt{\pi}$ & $-1$ \\
...
\end{tabular}
\\ (a) \\
\myincludegraphics{figures/figextval6}
\\ (b)
\end{tabular}}
%
...
\example{ex_extval7}{Finding extreme values}{Find the extreme values of $f(x) = \sqrt{1-x^2}$.} 
...
\mtable{A graph and table of extrema of $f(x)=\sqrt{1-x^2}$ on $[-1,1]$ as in \autoref{ex_extval7}.}{fig:extval7}{\begin{tabular}{c}
