...
\mtable[-3in]{Graphs of functions with and without extreme values.}{fig:extreme}{\pdftooltip{\begin{tikzpicture}
...
\end{tikzpicture}}{An upside down U shape, starting with a hollow dot at (-2,1), peaking at (0,5), and then back to a hollow dot at (2,1).  The domain of the curve is indicated below, and is -2<x<2.}
\\(a)\\
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{An upside down U shape, starting with a solid dot at (-2,1), peaking at a hollow dot at (0,5), and then back to a solid dot at (2,1).  There is also a solid dot at (0,3).  The domain of the curve is indicated below, and is -2≤x≤2.}
\\(b)\\
\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
minor x tick num=1, axis y line=middle,axis x line=middle,
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{An upside down U shape, starting with a solid dot at (-2,1), peaking at (0,5), and then back to a solid dot at (2,1).  The domain of the curve is indicated below, and is -2≤x≤2.}
\\(c)}
...
%
\mtable{A graph of $f(x) = 2x^3-9x^2$ as in \autoref{ex_extval1}.}{fig:extval1}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A curve starting at (-1,-11), going upward to touch the origin and turn back downward, bottoming out at (3,-27), turning back upward to cross the x-axis at x=4.5, and finishing at (5,25).}}
\solution
...
{fig:extval2}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A curve starting at (-2,7.4), moving downward to touch the x-axis at x=-1 and turn around, crossing the y-axis at y=1, crossing the x-axis near x=0.6, bottoming out at (2,-5.4), crossing the x-axis near x=2.7, and finishing at (3,6.4).}}
...
\mtable{A graph of $f(x) = (x-1)^{2/3}+2$ as in \autoref{ex_extval3}.}{fig:extval3}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A curve starting near (-0.5,3.3), crossing the y-axis at y=3, continuing downward to a cusp at (1,2), and then moving in a mirror image across the cups back upward to finish near (2.5,3.3).}}
...
\mtable{A graph of $f(x)=x^3$ which has a critical point of $x=0$, but no relative extrema.}{fig:extreme4}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A curve starting near (-1,-1), moving upward and flattening out to cross through the origin horizontally, then turning upward to finish at (1,1).}}
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A curve starting at the origin and moving downward, bottoming out at (1,-7), crossing the x-axis near x=1.8, and finishing at (3,45).}
\\(a)\smallskip\\
\begin{tabular}{cr}
 $x$ & $f(x)$ \\ \midrule
 0 & 0 \\
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A curve starting at (-4,25) continuing downward but curving to the right to meet the y-axis at y=1, and then suddenly changing to a line to the point (2,3).}
\\(b)}
%
\solution
...
\pdftooltip{\begin{tabular}{cl}
 ...
 $\sqrt{\pi}$ & $-1$ \\
 2 & $-0.65$
\end{tabular}}{A curve starting near (-2,-0.6), moving downward to a bottom at (-1.7,-1), turning back to a flat section where it crosses the y-axis at y=1, and then repeating the process in a mirror image across the y-axis to finish near (2,-0.6).}
\\(a)\\
\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{A semicircle of radius 1 centered at the origin and above the x-axis.}
\\(a)\smallskip\\
\begin{tabular}{rc}
 $x$ & $f(x)$ \\ \midrule
 $-1$ & 0 \\
