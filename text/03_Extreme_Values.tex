...
\mtable[3in]{Graphs of functions with and without extreme values.}{fig:extreme}{\begin{tikzpicture}[alt={An upside down U shape, starting with a hollow dot at (-2,1), peaking at (0,5), and then back to a hollow dot at (2,1).  The domain of the curve is indicated below, and is -2<x<2.}]
