...
\mtable{A graph of a function $f$ used to illustrate the concepts of \emph{increasing} and \emph{decreasing}.}{fig:incr0}{\pdftooltip{\begin{tikzpicture}
...
\mtable{Examining the secant line of an increasing function.}{fig:incr00}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{A graph of $f(x)$ in \autoref{ex_incr1}, showing where $f$ is increasing and decreasing.}{fig:incr1}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable[-3\baselineskip]{A graph of $f(x)$ in \autoref{ex_incr2}, showing where $f$ is increasing and decreasing.}{fig:incr2}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
...
\mtable{A graph of $f(x)$ in \autoref{ex_incr3}, showing where $f$ is increasing and decreasing.}{fig:incr3}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
