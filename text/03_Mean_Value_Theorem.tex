...
{\begin{tikzpicture}
 \begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
  ...
  \addplot[{\colorone},smooth,thick,domain=-1.95:-.507] {1/(x*x)};
  \addplot[{\colorone},smooth,thick,domain=.507:1.95] {1/(x*x)};
...
\mfigure{-1in}{A graph of $f(x) = x^3-5x^2+3x+5$, where $f(a) = f(b)$. Note the existence of $c$, where $a<c<b$, where $\fp(c)=0$.}{fig:mvt3}{figures/figmvt3}
...
\mfigure{0in}{Demonstrating the Mean Value Theorem in \autoref{ex_mvt2}.}{fig:mvt4}{figures/figmvt4}
