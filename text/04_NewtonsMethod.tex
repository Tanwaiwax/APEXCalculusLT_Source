...
{\mtable{Demonstrating the geometric concept behind Newton's Method.}{fig:newt1}{\myincludegraphics{figures/fignewt1a}\\(a)\\
\myincludegraphics{figures/fignewt1b} \\ (b) \\
\myincludegraphics{figures/fignewt1c} \\ (c)}}
...
\mfigure{-1.5in}{A graph of $f(x) = x^3-x^2-1$, showing why an initial approximation of $x_0=0$ with Newton's Method fails.}{fig:newt2a}{figures/fignewt2a}
...
% todo find and write application problems
% todo Tim include the Fast Inverse Square Root question?
