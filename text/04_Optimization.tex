...
\foreach \x in {0,...,7} {
 \shadedraw[xscale=.3,shift={(\x*14 pt,0)},
 \iflatexml fill=brown!70!white\else left color=brown!40!white,right color=brown!99!white\fi
 ](0,0)-- ++(0,20pt)-- ++(4pt,4pt)-- ++(6pt,0pt)
 		-- ++(4pt,-4pt)-- ++(0pt,-20pt)--cycle;
}
\end{scope}
\begin{scope}[shift={(33.6pt,35.28pt)}]
\foreach \x in {0,...,10} {
 \shadedraw[xscale=.4,shift={(\x*14 pt,0)},
 \iflatexml fill=brown!70!white\else left color=brown!40!white,right color=brown!99!white\fi
 ](0,0)-- ++(0,20pt)-- ++(4pt,4pt)-- ++(6pt,0pt)
 		-- ++(4pt,-4pt)-- ++(0pt,-20pt)--cycle;
}
