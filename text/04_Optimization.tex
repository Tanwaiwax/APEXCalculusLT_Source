...
\ifbool{latexml}{\shadedraw[fill=green!75!black]}{\shadedraw[top color=green,bottom color=green!50!black]}
 (0,0)--(33.6pt,35.28pt)--(95.2pt,35.28pt)--(61.6pt,0)--cycle;
\begin{scope}[cm={1,1.05,0,1,(0,0)}]
\foreach \x in {0,...,7} { % left side
 \ifbool{latexml}{\shadedraw[xscale=.3,shift={(\x*14 pt,0)},fill=brown!70!white]}{\shadedraw[xscale=.3,shift={(\x*14 pt,0)},left color=brown!40!white,right color=brown!99!white]}
 (0,0)-- ++(0,20pt)-- ++(4pt,4pt)-- ++(6pt,0pt)-- ++(4pt,-4pt)-- ++(0pt,-20pt)--cycle;
}
\end{scope}
\begin{scope}[shift={(33.6pt,35.28pt)}]
\foreach \x in {0,...,10} { % back side
 \ifbool{latexml}{\shadedraw[xscale=.4,shift={(\x*14 pt,0)},fill=brown!70!white]}{\shadedraw[xscale=.4,shift={(\x*14 pt,0)},left color=brown!40!white,right color=brown!99!white]}
 (0,0)-- ++(0,20pt)-- ++(4pt,4pt)-- ++(6pt,0pt)-- ++(4pt,-4pt)-- ++(0pt,-20pt)--cycle;
}
\end{scope}
...
\begin{tikzpicture}[scale=.67]
 \ifbool{latexml}{\draw [draw={\colorone},thick,fill=\colorone!40]}{\draw [draw={\colorone},thick,left color=\colorone!60,right color=\colorone!20]}
...
%   \ifbool{latexml}{\draw [draw={\colorone},fill=\colorone!40]}{\draw [draw={\colorone},left color=\colorone!60,right color=\colorone!20]}
%   (-1,-.2) -- (-1,-3.3)
