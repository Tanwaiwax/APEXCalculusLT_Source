...
%
\mtable{A sketch of the enclosure in \autoref{ex_opt1}.}{fig:opt1}{\pdftooltip{\begin{tikzpicture}[scale=1.3]
...
\mtable{A sketch of the enclosure in \autoref{ex_opt2}.}{fig:opt2}{\pdftooltip{\begin{tikzpicture}[scale=1.3]
\shadedraw[top color=green,bottom color=green!50!black]
 (0,0)--(33.6pt,35.28pt)--(95.2pt,35.28pt)--(61.6pt,0)--cycle;
\begin{scope}[cm={1,1.05,0,1,(0,0)}]
\foreach \x in {0,...,7} {
...
\mtable{Running a power line from the power station to an offshore facility with minimal cost in \autoref{ex_opt3}.}{fig:opt3b}{\pdftooltip{\begin{tikzpicture}[>=latex]
\ifbool{latexml}{
...
\mtable{Labeling unknown distances in \autoref{ex_opt3}.}{fig:opt3c}{\pdftooltip{\begin{tikzpicture}[>=latex]
\ifbool{latexml}{
 \draw[inner color={\colorone},draw=white](0,0)rectangle(120pt,50pt);
}{%
 \begin{scope}
