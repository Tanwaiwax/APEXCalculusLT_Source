...
\mtable{Labeling unknown distances in \autoref{ex_opt3}.}{fig:opt3c}{\begin{tikzpicture}[alt={Beach power station; cable: 5000−x ft on shore then sqrt{x^2+1000^2} ft underwater to facility.},>=latex]
\ifbool{latexml}{
 \draw[inner color={\colorone},draw=white](0,0)rectangle(120pt,50pt);
}{%
 \begin{scope}
