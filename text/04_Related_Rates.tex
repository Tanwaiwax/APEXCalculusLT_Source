...
\mtable[1in]{Tracking a speeding car (at left) with a rotating camera.}{fig:rr4}{\begin{tikzpicture}[alt={Red car on road, arrow east 100 mph; camera 10 ft below road. Horizontal gap x, diagonal to camera makes angle θ.}
,>=latex]
