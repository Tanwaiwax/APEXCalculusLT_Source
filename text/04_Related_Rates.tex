...
\mtable{A sketch of an officer attempting to measure the speed of a car in \autoref{ex_rr3}.}{fig:rr3}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=latex]
...
\mtable[1in]{Tracking a speeding car (at left) with a rotating camera.}{fig:rr4}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=latex]
