...
\mtable{The area under a constant velocity function corresponds to distance traveled.}{fig:defint1}{\pdftooltip{\begin{tikzpicture}
...
\mtable{The total displacement is the area above the $t$-axis minus the area below the $t$-axis.}{fig:defint2}{\pdftooltip{\begin{tikzpicture}
...
\mtable{A graph of $v(t)=-32t+48$; the shaded areas help determine displacement.}{fig:defint3}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
%
\mtable[.5in]{A graph of $f(x)$ in \autoref{ex_defint4}.}{fig:defint4}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,
...
\mtable{A graph of $5f$ in \autoref{ex_defint4}. (Yes, it looks just like the graph of $f$ in \autoref{fig:defint4}, just with a different $y$-scale.)}{fig:defint4a}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
%
\mtable{A graph of a function in \autoref{ex_defint5}.}{fig:defint5}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
%
\mtable{A graph of a velocity in \autoref{ex_defint6}.}{fig:defint6}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,xtick=\empty,
...
\pdftooltip{\begin{tikzpicture}[x=.7em,y=2.5em]
 \draw[<->](-12.9,1)--(28.9,1);
...
\mtable{What is the area below $y=x^2$ on $[0,3]$? The region is not a usual geometric shape.}{fig:defint7}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
