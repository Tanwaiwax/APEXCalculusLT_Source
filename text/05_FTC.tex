...
\mtable{A graph of $y=\sin x$ on $[0,\pi]$ and the rectangle guaranteed by the Mean Value Theorem.}{fig:ftc8}{\begin{tikzpicture}[alt={Blue curve y = sin x from 0 to pi; red rectangle on same base, height sin 0.69; point c; axes x and y.}]
