...
Therefore $\Fp(x)=f(x)$ as desired.  Because the limit exists, \exautoref{diffimpliescont} in \autoref{sec:derivative} implies that $F$ is continuous as well, so that it is differentiable.
\end{proof}
