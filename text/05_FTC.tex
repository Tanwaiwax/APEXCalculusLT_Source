...
\mtable{The area of the shaded region is $F(x) = \int_a^x f(t)\dd t$.}{fig:ftc1}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
...
\mtable{A graph of $y=\sin x$ on $[0,\pi]$ and the rectangle guaranteed by the Mean Value Theorem.}{fig:ftc8}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
