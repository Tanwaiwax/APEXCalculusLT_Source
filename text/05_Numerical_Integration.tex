...
\mtable{Approximating $\int_0^1 e^{-x^2}\dd x$ using 5 trapezoids of equal widths.}{fig:num3a}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
%
\mtable[-2in]{Speed data collected at 30 second intervals for \autoref{ex_num8}.}{fig:num8}{\begin{tabular}{rr}\lxBeginTableHead
Time & Speed\\(min)&(mph)
