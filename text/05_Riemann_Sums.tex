...
\mtable[-3\baselineskip]{Approximating $\int_0^4(4x-x^2)\dd x$ with the Right Hand Rule and 16 evenly spaced subintervals.}{fig:rie7}{\begin{tikzpicture}[alt={Blue parabola y=4x-x² on 0<x<4; sixteen narrow red rectangles use right endpoints, shading under curve; axes x and y.}]
...
\mtable[-1in]{Approximating $\ds\int_{-1}^5 x^3\dd x$ using the Left Hand Rule and 10 evenly spaced subintervals.}{fig:rie9}{\begin{tikzpicture}[alt={Blue curve y = x^3 from x = -1 to 5; ten left-end red rectangles approximate area; axes x and y.}]
\begin{axis}[width=1.16\marginparwidth,%
