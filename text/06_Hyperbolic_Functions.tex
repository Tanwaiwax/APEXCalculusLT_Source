...
\item		$\frac{d}{dx}\bigl(\cosh x\bigr)$
\item		$\frac{d}{dx}\bigl(\sinh x\bigr)$
\item		$\frac{d}{dx}\bigl(\tanh x\bigr)$
\end{enumerate}
\end{multicols}
%\clearpage
\solution
...
\begin{align*}
	...
	&= \sinh x.
\end{align*}
So $\frac{d}{dx}\bigl(\cosh x\bigr) = \sinh x.$
...
\begin{align*}
	...
	&= \cosh x.
\end{align*}
So $\frac{d}{dx}\bigl(\sinh x\bigr) = \cosh x.$
...
\begin{align*}
	...
	&= \sech^2 x.
\end{align*}
So $\frac{d}{dx}\bigl(\tanh x\bigr) = \sech^2 x.$
\end{enumerate}
\end{example}
...
\textbf{Derivatives}
\begin{enumerate}
\item $\frac{d}{dx}\bigl(\cosh x\bigr) = \sinh x$
\item $\frac{d}{dx}\bigl(\sinh x\bigr) = \cosh x$
\item $\frac{d}{dx}\bigl(\tanh x\bigr) = \sech^2 x$
\item $\frac{d}{dx}\bigl(\sech x\bigr) = -\sech x\tanh x$
\item $\frac{d}{dx}\bigl(\csch x\bigr) = -\csch x\coth x$
\item $\frac{d}{dx}\bigl(\coth x\bigr) = -\csch^2x$
\end{enumerate}
\end{minipage}%
\begin{minipage}[t]{.33\linewidth}
\textbf{Integrals}
...
\begin{enumerate}
\item		$\ds\frac{d}{dx}\bigl(\cosh 2x\bigr)$
...
\solution
\begin{enumerate}
\item		Using the Chain Rule directly, we have $\frac{d}{dx} \bigl(\cosh 2x\bigr) = 2\sinh 2x$.
...
\begin{align*}\frac{d}{dx}\bigl(\cosh 2x\bigr) = \frac{d}{dx}\bigl(\cosh^2x+\sinh^2x\bigr) &= 2\cosh x\sinh x+ 2\sinh x\cosh x\\ &= 4\cosh x\sinh x.
\end{align*}
