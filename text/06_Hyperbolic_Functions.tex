...
\begin{tabular}{lll}
\item $\ds\int\frac1{\sqrt{x^2-a^2}}\ dx$ & $\ds{}=\cosh^{-1}\left(\frac xa\right)+C$; $0<a<x$ & $\ds{}=\ln\abs{x+\sqrt{x^2-a^2}}+C$ \\
\item $\ds\int\frac1{\sqrt{x^2+a^2}}\ dx$ & $\ds{}=\sinh^{-1}\left(\frac xa\right)+C$; $a>0$ & $\ds{}=\ln\abs{x+\sqrt{x^2+a^2}}+C$ \\
