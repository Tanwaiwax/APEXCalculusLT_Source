...
%
\mtable{A graph of $f(x)=x^x$ supporting the fact that as $x\to 0^+$, $f(x)\to 1$.}{fig:LHR4}{\pdftooltip{\begin{tikzpicture}
...
\end{tikzpicture}}{A graph starting near (0,1), moving downward as it goes right, and then moving up to finish near (2,4).}}%
%
\begin{align*}
