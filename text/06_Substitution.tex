...
\mnote{\textbf{Note:} Recall from Section \ref{sec:differentials} that the differential of $x$, denoted $dx$, is any nonzero real number.  If $u$ is a function of $x$, then the differential of $u$, denoted $du$, is defined by $du=u'(x)\ dx$.}
...
{% if longpage
\mtable{Graphing the areas defined by the definite integrals of Example \ref{ex_sub12}.}{fig:subst12}{\begin{tabular}{ccc}
...
{% not longpage
\mtable{Graphing the areas defined by the definite integrals of Example \ref{ex_sub12}.}{fig:subst12}{\begin{tabular}{c}
...
\ifthenelse{\boolean{longpage}}
{% if longpage
\mtable{Graphing the areas defined by the definite integrals of Example \ref{ex_subst13}.}{fig:subst13}{\begin{tabular}{ccc}
...
{% not longpage
\mtable{Graphing the areas defined by the definite integrals of Example \ref{ex_subst13}.}{fig:subst13}{\begin{tabular}{c}
...
\example{ex_subst_def_3}{Definite integrals and substitution: changing the bounds}{Evaluate $\ds\int_0^2 xe^{x^2+1}\ dx$ using Theorem \ref{thm:subst_def_int}.}{We note the composition of functions and let $u=x^2+1$, hence $du=2x\,dx$. We divide the differential by 2 to get $\frac{du}2=x\,dx$.
