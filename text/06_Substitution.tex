...
{% if longpage
\mtable[-1in]{Graphing the areas defined by the definite integrals of \autoref{ex_sub12}.}{fig:subst12}{\begin{tabular}{ccc}
...
{% not longpage
\mtable{Graphing the areas defined by the definite integrals of \autoref{ex_sub12}.}{fig:subst12}{\begin{tabular}{c}
...
\ifthenelse{\boolean{longpage}}
{% if longpage
\mtable{Graphing the areas defined by the definite integrals of \autoref{ex_subst13}.}{fig:subst13}{\begin{tabular}{ccc}
...
{% not longpage
\mtable{Graphing the areas defined by the definite integrals of \autoref{ex_subst13}.}{fig:subst13}{\begin{tabular}{c}
