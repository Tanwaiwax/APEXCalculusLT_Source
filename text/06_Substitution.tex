...
%
\mtable{Graphing the areas defined by the definite integrals of \autoref{ex_subst13}.}{fig:subst13}{\begin{tikzpicture}[alt={Graph (a) blue curve y = sin x cos x on 0 to pi/2; area under curve shaded; axes x and y.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
