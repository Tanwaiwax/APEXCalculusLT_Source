...
\mtable{A reference triangle for \autoref{ex_trigsub3}}{fig:tan_tri}{\pdftooltip{\begin{tikzpicture}
...
\mtable[-\baselineskip]{A reference triangle for \autoref{ex_trigsub2}}{fig:sec_tri}{\pdftooltip{\begin{tikzpicture}
...
\end{align*}
%
\mtable{A reference triangle for \autoref{ex_trigsub4}}{fig:sin_tri}{\pdftooltip{\begin{tikzpicture}
