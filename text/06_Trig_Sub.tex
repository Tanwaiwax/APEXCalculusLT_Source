...
\mtable{A reference triangle for \autoref{ex_trigsub3}}{fig:tan_tri}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
...
\mtable[-\baselineskip]{A reference triangle for \autoref{ex_trigsub2}}{fig:sec_tri}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
...
\end{align*}
%
\mtable{A reference triangle for \autoref{ex_trigsub4}}{fig:sin_tri}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
