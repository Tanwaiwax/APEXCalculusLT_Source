...
\end{tikzpicture}}{g(x) starts flat near the origin, then moves up to near (1,0.0045), is flat until near (2,0,0045), then moves down to finish flat near (π,0).  f(x) is similar, but slightly below g(x).}}
\[
