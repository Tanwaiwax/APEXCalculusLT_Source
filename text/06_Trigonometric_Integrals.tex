...
\end{align*}
% todo MEI had different wording
...
\end{aligned}
\]
\captionof{figure}{Setting up Integration by Parts.}\label{fig:trigint1}
\end{lxfigure}
...
\int \sec^3x\ dx &= \frac12\Big(\sec x\tan x + \ln|\sec x+\tan x|\Big)+C.\eoehere
\end{align*}	}
