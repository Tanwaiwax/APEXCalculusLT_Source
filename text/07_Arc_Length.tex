...
%
\mtable{Zooming in on the $i^{\text{th}}$ subinterval $[x_{i-1},x_i]$ of a partition of $[a,b]$.}{fig:arcintro2}{\pdftooltip{\begin{tikzpicture}
...
%
\mtable{A graph of $f(x) = x^{3/2}$ from \autoref{ex_arc1}.}{fig:arc1}{\pdftooltip{\begin{tikzpicture}
...
\mtable{A graph of $f(x) =\frac18x^2-\ln x$ from \autoref{ex_arc2}.}{fig:arc2}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,
