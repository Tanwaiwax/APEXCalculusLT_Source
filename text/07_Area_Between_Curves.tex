...
\solution
\mtable{Graphing an enclosed region in \autoref{ex_abc1}.}{fig:abc1}{\pdftooltip{\begin{tikzpicture}
...
\mtable{Sketching the region enclosed by $y=x^2+x-5$ and $y=3x-2$ in \autoref{ex_ftc6}.}{fig:ftc6}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Graphing a region enclosed by two functions in \autoref{ex_abc2}.}{fig:abc2}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Graphing a region for \autoref{ex_abc3}.}{fig:abc3}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{The region used in \autoref{ex_abc3} with boundaries relabeled as functions of $y$.}{fig:abc3b}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,xtick={1,2},
ymin=-.1,ymax=3.5,xmin=-.1,xmax=2.5]
\addplot[draw={\coloronefill},fill={\coloronefill},area style,domain=0:1]{sqrt(x)+2}\closedcycle;
...
\mtable{Graphing a triangular region in \autoref{ex_abc4}.}{fig:abc4}{\pdftooltip{\begin{tikzpicture}
...
%
%\mtable{(a) A sketch of a lake, and (b) the lake with length measurements.}{fig:abc5}{\pdftooltip{\begin{tikzpicture}[scale=.4]%[width=1.16\marginparwidth]
%\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
