...
Each slice has an area approximately equal to $\big(f(c_i)-g(c_i)\big)\Delta x$; hence, the total area is approximately the Riemann Sum
\[Q \approx \sum_{i=1}^n \big(f(c_i)-g(c_i)\big)\Delta x.\]
