...
\mtable[-10\baselineskip]{Sketching a solid in \autoref{ex_disk1}.}{fig:disk1}{%
  \begin{tikzpicture}
...
\mtable[-8\baselineskip]{Sketching a solid in \autoref{ex_disk2}.}{fig:disk2}{%
  \begin{tikzpicture}
