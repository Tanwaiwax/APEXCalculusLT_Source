...
3Droo=149.99999509331877}{width=.5\marginparwidth}{figures/figcross1_3D}}
...
% todo Tim check that 6.2 side figs don't overlap top figs
\mtable[-3in]{Sketching the region, a sample slice, and solid in \autoref{ex_wash1}.}{fig:wash1}{%
 \begin{tikzpicture}
  \begin{axis}[width=\marginparwidth,
     tick label style={font=\scriptsize},axis y line=middle,
     axis x line=middle,name=myplot,axis on top,
