...
3Droo=150}{.5\marginparwidth}{alt={Irregular right cylinder: matching top and bottom outlines, vertical side walls, base area A, height h.}}{figures/figcross1_3D}}
...
3Droo=150.00000157638937}{\marginparwidth}{alt={Pyramid on x axis, apex at origin, square base at x=5 of side length 10; cross section square side length 2x; axes x and y.}{figures/figcross_area1_3D}
\\(a)\\
\myincludeasythree{
3Droll=130.3044775136707,
3Dortho=0.004594136495143175,
3Dc2c=0.4693154990673065 0.5382519960403442 0.7000198364257812,
3Dcoo=60.78499984741211 0.48087620735168457 -14.641631126403809,
3Droo=150.00000157638937}{\marginparwidth}{alt={Slice of pyramid at x showing square cross section of side length 2x and thickness Delta x, with dashed outline of full pyramid; axes x and y.}{figures/figcross_area1a_3D}
\\(b)}
...
3Droo=150.00000160608386}{\marginparwidth}alt={Red disk at sample x with radius equal to the curve height 1/x; curve drawn; axes x and y.}{figures/figdisk1_3D}\\
	(b) \\
	\myincludeasythree{
3Droll=126.0060482236849,
3Dortho=0.004875946324318647,
3Dc2c=0.44462037086486816 0.39410829544067383 0.8043577671051025,
3Dcoo=67.21983337402344 3.5258262157440186 -29.566415786743164,
3Droo=150.00000160608386}{\marginparwidth}{alt={3D view of solid formed by rotating shaded region under 1/x from 1 to 2 around x axis; sample disk shown; axes x and y.}{figures/figdisk1b_3D}\\
	(c)}
...
3Droo=150.00000339216956}{\marginparwidth}alt={Red disk at sample y around the y-axis, radius R(y)=1/y labeled; blue curve x=1/y drawn; axes x, y.}{figures/figdisk1a_3D}
\\(b)\\
	\myincludeasythree{
3Droll=112.9954735907269,
3Dortho=0.003950905054807663,
3Dc2c=0.5512889623641968 0.2862306833267212 0.7836788296699524,
3Dcoo=-9.51923942565918 49.542564392089844 -9.694497108459473,
3Droo=150.00000339216956}{\marginparwidth}{alt={3D solid from rotating region between y-axis and curve x = 1/y around y-axis; blue translucent outer, red inner circle; axes x, y.}{figures/figdisk2a_3D}
\\(c)}
...
3Droo=149.99999789136484}{\marginparwidth}{alt={Blue curves R(x) and r(x) from a to b; red washer ellipse at sample x shows outer R(x) and inner r(x); axes x,y.}{figures/figwasher_idea_c_3D}
%\\(b)\\
&
\myincludeasythree{
3Droll=96.94265756936434,
...
3Dc2c=0.547386884689331 0.07732175290584564 0.833299994468689,
3Dcoo=64.78053283691406 10.129053115844727 -47.566162109375,
3Droo=149.99999789136484}{\marginparwidth}{alt={3D hollow solid from rotating region between curves around x axis; blue outer, red inner shells; axes x and y.}{figures/figwasher_idea_b_3D}
\\
(a) & (b) &
(c)%}
\end{tabular}}
...
3Droo=149.99999769784193}{\marginparwidth}{alt={Washer slice at x=2: red disk with hole, blue outer radius to upper curve and red inner radius to lower curve; axes x, y.} }{figures/figwash1c_3D}
%\\(b)\\
&
\myincludeasythree{
3Droll=97.32968340849395,
...
3Dc2c=0.43117064237594604 0.05905330181121826 0.9003357887268066,
3Dcoo=64.78053283691406 10.12905216217041 -47.566158294677734,
3Droo=149.99999769784193}{\marginparwidth}{alt={3D hollow solid from rotating the region between curves around x axis; blue and red translucent surfaces; axes x, y.}}{figures/figwash1b_3D}
%\\(c)}
\\(a)&(b)&(c)
\end{tabular}}
...
\tagpdfsetup{table/header-rows={2}}
\begin{tabular}{ c c c }
 \begin{tikzpicture}[alt={Blue curves y = x^2 (lower) and y = 2x (upper) from x=0 to 2; shaded region between curves; red horizontal sample lines at r(x) and R(x); axes x,y.}]
...
3Droo=150}{\marginparwidth}{alt={Red horizontal washer slice showing outer radius to y = 2x and inner radius to y = x^2; blue rotated surface; axes x,y.}}{figures/figsq_rt_3D}
% \\ (b) \\
&
\myincludeasythree{
3Droll=126.0060482236849,
...
3Dc2c=0.44462037086486816 0.39410829544067383 0.8043577671051025,
3Dcoo=3.631758213043213 62.91783142089844 -23.517351150512695,
3Droo=150}{\marginparwidth}{alt={3D hollow solid formed by rotating region between y = x^2 and y = 2x about the y-axis; blue outer and red inner shells; axes x,y.}}{figures/figsq_rt_b_3D}
\\(a)&(b)&(c)
\end{tabular}}
% \\ (c)}
...
3Droo=149.99999819286032}{\marginparwidth}{alt={Blue shaded region between the two curves; red washer slice at sample x shows outer and inner radii; axes x, y.}}{figures/figwash2b_3D}
%\\(b) \\
&
\myincludeasythree{
3Droll=123.42078064170005,
...
3Dc2c=0.41855040192604065 0.31316813826560974 0.8524911999702454,
3Dcoo=-7.115118026733398 66.85215759277344 -16.372848510742188,
3Droo=149.99999819286032}{\marginparwidth}{alt={3D hollow solid: blue outer shell and red inner shell from rotating region between two curves; axes x, y.}
...
3Droo=150}{\marginparwidth}{alt={Blue region between two curves; dashed slanted line marks axis of rotation; red washer slice at sample x shows inner and outer radii; axes x, y.}}{figures/figwash4_3D}
\\ (b) \\
\myincludeasythree{
3Droll=110.40940687660915,
3Dortho=0.004087134264409542,
3Dc2c=0.5237183570861816 0.21099673211574554 0.8253480792045593,
3Dcoo=57.86643981933594 53.05048751831055 -36.72541809082031,
3Droo=150}{\marginparwidth}{alt={3D solid from rotating region between curves about dashed slanted axis; blue outer shell and red inner core; axes x, y.}}{figures/figwash4b_3D}
\\ (c)}
