...
\mtable[-2in]{Sketching a solid in \autoref{ex_disk1}.}{fig:disk1}{%
  \begin{tikzpicture}
...
\mtable[-2.5in]{Sketching a solid in \autoref{ex_disk2}.}{fig:disk2}{%
  \begin{tikzpicture}
...
\begin{align*}
V &= \pi\int_1^3 \Bigl((2x-1)^2-(x^2-2x+2)^2\Bigr)\ dx \\
		&= \pi\int_1^3 \bigl(-x^4+4x^3-4x^2+4x-3\bigr)\ dx \\
...
\begin{align*}
V 	&=	\pi\int_1^3\Bigl(2^2 - \bigl(\frac12(y+1)\bigr)^2\Bigr)\ dy \\
		&=	\pi\int_1^3\Bigl(-\frac14y^2-\frac12y+\frac{15}4\Bigr)\ dy \\
