...
%
%example: Compute $\int \ln x\,dx$.
%
%\solution While this does not look like a product of functions, we find integration by parts useful. In particular we use $u=\ln x$, $du=dx/x$, $dv=dx$, and $v=x$:
%\begin{align*}
...
\frac{d}{dx}\Bigl(\ln (y)\Bigr) &= \frac{d}{dx}\Bigl(x\ln x\Bigr) \\
