...
\draw [
\iflatexml fill=\coloronefill!60\else left color={\coloronefill},right color={\coloronefill!20}\fi
,thick](-2,10)
 -- (-2,0) arc (180:360:2) -- (2,10);
\draw[
\iflatexml fill=\coloronefill!65\else left color={\coloronefill!30},right color={\coloronefill}\fi
,thick]
 (0,10)circle(2);
...
\mtable{A rectangular tank in \autoref{ex_fluid1}.}{fig:fluid1b}{\begin{tikzpicture}[x=.25cm,y=.25cm,>=stealth]
 \begin{scope}[xscale=2]
  ...
  \iflatexml fill=\coloronefill!60\else left color={\coloronefill},right color={\coloronefill!20}\fi
  ,thick](AAA.center)
   -- (A.center)-- node [pos=.5,rotate=-15,below] {\scriptsize 5 ft} (B.center)
   --node [pos=.5,rotate=45,below] {\scriptsize 5 ft}(C.center)--(CCC.center);
  \draw [
  \iflatexml fill=\coloronefill!60\else right color={\coloronefill},left color={\coloronefill!20}\fi
  ,thick]
