...
\draw [left color={\coloronefill},right color={\coloronefill!20},thick](-2,10)
 -- (-2,0) arc (180:360:2) -- (2,10);
\draw[right color={\coloronefill},left color={\coloronefill!30},thick]
 (0,10)circle(2);
...
\mtable{A rectangular tank in \autoref{ex_fluid1}.}{fig:fluid1b}{\begin{tikzpicture}[x=.25cm,y=.25cm,>=stealth]
 \begin{scope}[xscale=2]
  ...
  \begin{scope}[shift={(0,12)}]
   ...
   \end{scope}
  \end{scope}
  \draw [left color={\coloronefill},right color={\coloronefill!20},thick](AAA.center)
  ...
  \draw [right color={\coloronefill},left color={\coloronefill!20},thick]
