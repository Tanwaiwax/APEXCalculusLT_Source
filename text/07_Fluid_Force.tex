...
\mtable[-.5in]{A cylindrical tank in \autoref{ex_fluid1}.}{fig:fluid1a}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},x=.3cm,y=.3cm,>=stealth]
...
%
\mtable{A rectangular tank in \autoref{ex_fluid1}.}{fig:fluid1b}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},x=.25cm,y=.25cm,>=stealth]
 \begin{scope}[xscale=2]
...
\mtable{A thin, vertically oriented plate submerged in a fluid with weight-density $w$.}{fig:fluid_intro1}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},x=1cm,y=1cm,>=stealth]
 \begin{scope}
...
%
\mtable{A thin plate in the shape of an isosceles triangle in \autoref{ex_fluid2}.}{fig:fluid2a}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},x=.4cm,y=.4cm,>=stealth]
\draw[thick] (0,0) -- (2,4)
...
We approach this problem in two different ways to illustrate the different ways \autoref{idea:fluid_force} can be implemented. First we will let $y=0$ represent the surface of the water, then we will consider an alternate convention.
	...
	\mtable{Sketching the triangular plate in \autoref{ex_fluid2} with the convention that the water level is at $y=0$.}{fig:fluid2b}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
...
\mtable[-.2in]{Sketching the triangular plate in \autoref{ex_fluid2} with the convention that the base of the triangle is at $(0,0)$.}{fig:fluid2c}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=\marginparwidth, axis y line=middle,axis x line=middle,
...
%
\mtable{Sketching a submerged car door in \autoref{ex_fluid3}.}{fig:fluid3}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},x=.5cm,y=.5cm,>=stealth]
...
\mtable{Measuring the fluid force on an underwater porthole in \autoref{ex_fluid4}.}{fig:fluid4}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},x=.6cm,y=.6cm,>=stealth]
