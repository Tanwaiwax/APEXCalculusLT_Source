...
\begin{scope}[xscale=2]
 \ifthenelse{\boolean{latexml}}{\draw[thick,fill=\coloronefill!60]}{\draw[thick,left color={\coloronefill},right color={\coloronefill!20}]}
 (-2,10) -- (-2,0) arc (180:360:2) -- (2,10);
 \ifthenelse{\boolean{latexml}}{\draw[thick,fill=\coloronefill!65]}{\draw[thick,left color={\coloronefill!30},right color={\coloronefill}]}
 (0,10)circle(2);
...
\mtable{A rectangular tank in \autoref{ex_fluid1}.}{fig:fluid1b}{\begin{tikzpicture}[x=.25cm,y=.25cm,>=stealth]
 \begin{scope}[xscale=2]
  ...
  \ifthenelse{\boolean{latexml}}{\draw[thick,fill=\coloronefill!60]}{\draw[thick,right color={\coloronefill},left color={\coloronefill!20}]}
...
\mtable{A thin, vertically oriented plate submerged in a fluid with weight-density $w$.}{fig:fluid_intro1}{\begin{tikzpicture}[x=1.25cm,y=1.25cm,>=stealth]
 \begin{scope}
...
\mtable{Sketching the triangular plate in \autoref{ex_fluid2} with the convention that the base of the triangle is at $(0,0)$.}{fig:fluid2c}{\begin{tikzpicture}
\begin{axis}[width=\marginparwidth, axis y line=middle,axis x line=middle,
