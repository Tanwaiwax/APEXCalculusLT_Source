...
\begin{tikzpicture}
 \begin{axis}[width=.6\textwidth,height=.3\textwidth,
   ...
   xticklabels={$-\pi$,$-\frac{\pi}{2}$,$\frac{\pi}{2}$,$\pi$},name=myplot]
...
\begin{tikzpicture}
 \begin{axis}[width=.6\textwidth,height=.45\textwidth,
   ...
   xticklabels={$-\frac{\pi}{2}$,$\frac{\pi}{2}$},name=myplot]
...
\begin{tikzpicture}
 \begin{axis}[width=.45\textwidth,height=.6\textwidth,
   ...
   yticklabels={$-\frac{\pi}{2}$,$\frac{\pi}{2}$},name=myplot]
...
\begin{center}
\begin{tikzpicture}
 \begin{axis}[width=\textwidth,height=.5\textwidth,
   tick label style={font=\scriptsize},axis y line=middle,axis x line=middle,
