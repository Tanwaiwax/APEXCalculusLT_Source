...
\end{tikzpicture}
&
\begin{tikzpicture}[alt={Blue one-to-one arc of sin x (−pi⁄2 < x < pi⁄2) and red inverse sine mirrored across dashed y = x line.},baseline={(current bounding box.center)}]
 \begin{axis}[x=.7cm,y=.7cm,
   tick label style={font=\scriptsize},axis y line=middle,axis x line=middle,
