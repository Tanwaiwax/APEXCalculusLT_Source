...
\begin{tikzpicture}[scale=.67]
 \draw [draw={\colorone},
 \iflatexml fill=\colorone!40\else left color=\colorone!60,right color=\colorone!20\fi
 ,thick] (0,0) ellipse [x radius=1.5cm, y radius=1cm];
\begin{scope}[xscale=1.5]
 \draw [draw={\colorone},
 \iflatexml fill=\colorone!40\else left color=\colorone!60,right color=\colorone!20\fi
 ,thick] (-1,0) -- (-1,-3.5) arc (180:360:1) -- (1,0) arc (360:180:1);
...
\end{scope}
\draw [draw={\colorone},
\iflatexml fill=\colorone!40\else left color=\colorone!20,right color=\colorone!60\fi
,thick] (0,0) ellipse [x radius=1.2cm,y radius=.8cm];
...
\draw [draw={\colorone},
\iflatexml fill=\colorone!40\else left color=\colorone!60,right color=\colorone!20\fi
,thick] (3.5,-.3) -- (3.7,-.1) --node [pos=.5,above,color=black] {\scriptsize $2\pi r$} (8.7,-.1) -- (8.5,-.3);
\draw [draw={\colorone},
\iflatexml fill=\colorone!40\else left color=\colorone!60,right color=\colorone!20\fi
,thick] (8.5,-.3) -- (8.7,-.1) --node [pos=.5,right,color=black] {\scriptsize $h$} (8.7,-3.6) -- (8.5,-3.8);
\draw [draw={\colorone},
\iflatexml fill=\colorone!40\else left color=\colorone!60,right color=\colorone!20\fi
,thick] (3.5,-.3) --  (8.5,-.3) --  (8.5,-3.8)--(3.5,-3.8) -- cycle;
