...
\draw [thick,draw={\colortwo}] (axis cs: .4,1.8) -- node [black,pos=.5,below] {$\underbrace{\rule{42pt}{0pt}}_{h(y)}$} (axis cs:1,1.8);
...
3Droo=150.00000160608386}{width=\marginparwidth}{figures/figshellparab_3D}
\\(b)\smallskip\\
\myincludeasythree{width=\marginparwidth,
3Droll=126.0060482236849,
3Dortho=0.004875946324318647,
3Dc2c=0.44462037086486816 0.39410829544067383 0.8043577671051025,
3Dcoo=67.21983337402344 3.5258262157440186 -29.566415786743164,
3Droo=150.00000160608386}{width=\marginparwidth}{figures/figshellparab_b_3D}
\\(c)}
