...
$$V \approx \sum_{i=1}^n 2\pi r_ih_i\dx,$$ where $r_i$, $h_i$ and $\dx$ are the radius, height and thickness of the $i\,^\text{th}$ shell, respectively. 
...
%
\mfigure{-.2in}{Graphing a region in \autoref{ex_shell1}.}{fig:shell1}{figures/figshell1}
%
...
%\draw [thick,draw={\colortwo}] (axis cs: 1,0,1) -- (axis cs:1,0,2);
%\end{axis}
