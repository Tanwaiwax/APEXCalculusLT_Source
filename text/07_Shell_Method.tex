...
% \draw [{\colorone},fill={\coloronefill},thick] (0,0) circle (1cm);
 \draw [left color=black!60,right color=black!20,thick] (0,0) circle (1cm);

% \draw [{\colorone},fill={\coloronefill},thick] (-1,0) -- (-1,-3.5) arc (180:360:1) -- (1,0) arc (360:180:1);
 \draw [left color=black!60,right color=black!20,thick] (-1,0) -- (-1,-3.5) arc (180:360:1) -- (1,0) arc (360:180:1);
 \draw [{\colorone},fill=white](-1,-.2) -- node [pos=.5,left] {\scriptsize $h$} (-1,-3.3) arc (180:360:1) -- (1,-.2) arc (360:180:1);
 \draw [{\colorone},dashed] (.71,-.91) -- node [pos=.5, above,rotate=90] {\scriptsize cut here} (.71,-4.01);
 \draw[{\colorone}] (0,0) -- node [pos=.5,above] {\scriptsize $r$} (1,0);
\end{scope}
...
\end{scope}
\end{tikzpicture}
& \myincludegraphics[scale=.9]{figures/figshell_unwrapshell}\\
(a) & (b)
\end{tabular}
...
\mfigure{0in}{Graphing a region in Example \ref{ex_shell1}.}{fig:shell1}{figures/figshell1}
...
\mtable{Graphing a region in Example \ref{ex_shell2}.}{fig:shell2}{%
\begin{tabular}{c}
...
\mtable{Graphing a region in Example \ref{ex_shell3}.}{fig:shell3}{%
\begin{tabular}{c}
...
\mtable{Graphing a region in Example \ref{ex_shell4}.}{fig:shell4}{%
\begin{tabular}{c}
