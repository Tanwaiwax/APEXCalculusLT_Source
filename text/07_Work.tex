...
\begin{tikzpicture}
 \begin{scope}[xscale=.2,yscale=.5,shift={(.5,0)}]
  ...
  \end{scope}
 \end{scope}
 \ifbool{latexml}{\draw [shift={(.9,0)},thick,{\colorone},fill=\colorone!40]}{\draw [shift={(.9,0)},thick,{\colorone},left color={\colorone!70},right color={\coloronefill}]}
 (2,0) rectangle (2.5,.5);
 ...
 \begin{scope}[shift={(0,-1.75)}]
  ...
  \end{scope}
  \ifbool{latexml}{\draw [shift={(2.9,0)},thick,{\colorone},fill=\colorone!40]}{\draw [shift={(2.9,0)},thick,{\colorone},left color={\colorone!70},right color={\coloronefill}]}
  (2,0) rectangle (2.5,.5);
 \end{scope}             
\end{tikzpicture}
...
\ifbool{latexml}{\draw [thick,fill=\colorone!60]}{\draw [thick,left color={\colorone},right color={\coloronefill}]}
 (0,16) circle (3);
\ifbool{latexml}{\draw [thick,fill=\colorone!60]}{\draw [thick,left color={\colorone},right color={\coloronefill}]}
...
\mtable{A simplified illustration for computing work.}{fig:pump1b}{\begin{tikzpicture}[x=.1cm,y=.125cm,>=stealth,scale=.9]
\draw [->] (0,-2) -- (0,37) node [above] {\scriptsize $y$};
\draw (-1,0) node [left] {\scriptsize 0} -- (1,0)
      (-1,30) node [left] {\scriptsize 30} -- (1,30)
      (-1,35) node [left] {\scriptsize 35} -- (1,35)
...
\draw [thick] (0,30) circle (3);
\draw [thick,dashed] (3,0) arc (0:180:3);
\ifbool{latexml}{\draw [thick,draw={\colorone},fill=\colorone!60]}{\draw [thick,draw={\colorone},left color={\colorone},right color={\coloronefill}]}
 (0,14) circle (3);
