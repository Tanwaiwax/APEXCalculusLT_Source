...
\mnote{\textbf{Note:} \textit{Mass} and \textit{weight} are closely related, yet different, concepts. The mass $m$ of an object is a quantitative measure of that object's resistance to acceleration. The weight $w$  of an object is a measurement of the force applied to the object by the acceleration of gravity $g$.\bigskip\\
...
\begin{tikzpicture}
 \begin{scope}[xscale=.2,yscale=.5,shift={(.5,0)}]
  ...
  \end{scope}
 \end{scope}
 \ifthenelse{\boolean{latexml}}{\draw [shift={(.9,0)},thick,{\colorone},fill=\colorone!40]}{\draw [shift={(.9,0)},thick,{\colorone},left color={\colorone!70},right color={\coloronefill}]}
 (2,0) rectangle (2.5,.5);
 ...
 \begin{scope}[shift={(0,-1.75)}]
  ...
  \end{scope}
  \ifthenelse{\boolean{latexml}}{\draw [shift={(2.9,0)},thick,{\colorone},fill=\colorone!40]}{\draw [shift={(2.9,0)},thick,{\colorone},left color={\colorone!70},right color={\coloronefill}]}
  (2,0) rectangle (2.5,.5);
 \end{scope}             
\end{tikzpicture}
...
\ifthenelse{\boolean{latexml}}{\draw [thick,fill=\colorone!60]}{\draw [thick,left color={\colorone},right color={\coloronefill}]}
 (0,16) circle (3);
\ifthenelse{\boolean{latexml}}{\draw [thick,fill=\colorone!60]}{\draw [thick,left color={\colorone},right color={\coloronefill}]}
...
\draw [thick] (0,30) circle (3);
\draw [thick,dashed] (3,0) arc (0:180:3);
\ifthenelse{\boolean{latexml}}{\draw [thick,draw={\colorone},fill=\colorone!60]}{\draw [thick,draw={\colorone},left color={\colorone},right color={\coloronefill}]}
 (0,14) circle (3);
