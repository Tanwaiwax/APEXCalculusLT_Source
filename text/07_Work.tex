...
\mnote{\textbf{Note:} In Example \ref{ex_work1_5}, we find that half of the work performed in pulling up a 60 m rope is done in the last 42.43 m. Why is it not coincidental that $60/\sqrt{2}=42.43$?}
}\\
...
\mfigure{0in}{Illustrating a water tank in order to compute the work required to empty it in Example \ref{ex_pump1}.}{fig:pump1a}{figures/figwork_pump1}
...
\mfigure{0in}{A simplified illustration for computing work.}{fig:pump1b}{figures/figwork_pump2}
...
\begin{align*}
	W
	&= \int_{-10}^0 62.4\pi(1/5y+2)^2(3-y)\ dy\\
...
\mfigure{0in}{The cross--section of a swimming pool filled with water in Example \ref{ex_pump3}.}{fig:pump3}{figures/figpump4}
\mfigure{2in}{Orienting the pool and showing differential elements for Example \ref{ex_pump3}.}{fig:pump3b}{figures/figpump4b}
% todo combine into one mtable
