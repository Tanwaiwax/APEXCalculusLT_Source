...
\begin{tikzpicture}
 \begin{scope}[xscale=.2,yscale=.5,shift={(.5,0)}]
  ...
  \end{scope}
 \end{scope}
 \draw [shift={(.9,0)},thick,
 \iflatexml fill=\colorone!40\else left color={\colorone!70},right color={\coloronefill}\fi
 ,{\colorone}] (2,0) rectangle (2.5,.5);
...
\draw [
\iflatexml fill=\colorone!60\else left color={\colorone},right color={\coloronefill}\fi
,thick] (0,16) circle (3);
\draw [
\iflatexml fill=\colorone!60\else left color={\colorone},right color={\coloronefill}\fi
,thick]
...
\draw [
\iflatexml fill=\colorone!60\else left color={\colorone},right color={\coloronefill}\fi
,thick,draw={\colorone}] (0,14) circle (3);
...
\draw [
\iflatexml fill=\colorone!60\else left color={\colorone},right color={\coloronefill}\fi
,thick,draw={\colorone}] (0,14) circle (1.4);
