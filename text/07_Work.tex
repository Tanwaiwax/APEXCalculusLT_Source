...
\mtable{Illustrating a water tank in order to compute the work required to empty it in \autoref{ex_pump1}.}{fig:pump1a}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},x=.1cm,y=.125cm,>=stealth]
...
\mtable{A simplified illustration for computing work.}{fig:pump1b}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},x=.1cm,y=.125cm,>=stealth,scale=.9]
\draw [->] (0,-2) -- (0,37) node [above] {\scriptsize $y$};
\draw (-1,0) node [left] {\scriptsize 0} -- (1,0)
      (-1,30) node [left] {\scriptsize 30} -- (1,30)
      (-1,35) node [left] {\scriptsize 35} -- (1,35)
...
\mtable[-.5in]{A graph of the conical water tank in \autoref{ex_pump2}.}{fig:pump2}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},x=.1cm,y=.125cm,>=stealth]
\draw [->] (0,-2) -- (0,37) node [above] {\scriptsize $y$};
...
\mtable{The cross-section of a swimming pool filled with water in \autoref{ex_pump3} and two sample slices.}{fig:pump3}{%
 \begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},x=.14cm,y=.2cm,>=stealth]
