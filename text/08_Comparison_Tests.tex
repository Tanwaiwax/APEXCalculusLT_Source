...
\mnote{\textbf{Note:} A sequence $\{a_n\}$ is a \textbf{positive sequence} if $a_n>0$ for all $n$.\bigskip\\
...
\begin{example}[Applying the Direct Comparison Test]\label{ex_dct1}%
...
\begin{example}[Applying the Direct Comparison Test]\label{ex_dct2}%
...
\begin{example}[Applying the Limit Comparison Test]\label{ex_lct1}%
...
\begin{example}[Applying the Limit Comparison Test]\label{ex_lct2}%
Determine the convergence of $\ds\sum_{n=1}^\infty \frac1{3^n-n^2}$
\solution
...
Instead, we use the Limit Comparison Test %and compare
...
\begin{example}[Applying the Limit Comparison Test]\label{ex_lct3}%
...
\printexercises{exercises/08-09-exercises}
