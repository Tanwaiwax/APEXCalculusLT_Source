...
\begin{equation}\sum_{n=1}^\infty a_n < a_1 +\int_1^\infty a(x)\dd x.\label{eq:integral_testb}
\end{equation} 
...
\solution
\autoref{fig:itest1}
\mtable{Plotting the sequence and series in \autoref{ex_itest1}.}{fig:itest1}{\pdftooltip{\begin{tikzpicture}
