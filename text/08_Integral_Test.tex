...
\solution
\autoref{fig:itest1}
\mtable{Plotting the sequence and series in \autoref{ex_itest1}.}{fig:itest1}{\begin{tikzpicture}[alt={Blue dots a_n fall toward 0 while red dots S_n climb and level near 0.75 across 0 < n < 20.}]
