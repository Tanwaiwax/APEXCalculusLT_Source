...
\example{ex_ratio1}{Applying the Ratio Test}{Use the Ratio Test to determine the convergence of the following series:
\[
...
\example{ex_ratio2}{Applying the Ratio Test}{Determine the convergence of $\ds\sum_{n=1}^\infty \frac{n!n!}{(2n)!}$.}
...
\example{ex_root1}{Applying the Root Test}{Determine the convergence of the following series using the Root Test:

\[
 \text{1. }\sum_{n=1}^\infty \left(\frac{3n+1}{5n-2}\right)^n\qquad\qquad
 \text{2. }\sum_{n=1}^\infty\frac{n^4}{(\ln n)^n}\qquad\qquad
 \text{3. }\sum_{n=1}^\infty \frac{2^n}{n^2}.
\]}
{\begin{enumerate}
