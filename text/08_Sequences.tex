...
% todo add a geometric series example
...
\item
	...
	&> 0 \quad \text{ for all $n$.}
\end{aligned}$\hfill \null
\mfigure{-.2in}{A plot of $\{a_n\}=\{\frac{n^2+1}{n+1}\}$ in \autoref{ex_seq7}(b).}{fig:seq7b}{figures/figseq7b}
...
\item
\mfigure{-.7in}{A plot of $\{a_n\}=\{n^2/n!\}$ in \autoref{ex_seq7}(d).}{fig:seq7d}{figures/figseq7d}
