...
\example{ex_harm_series}{Divergence of the Harmonic Series}{Show that the harmonic series $\ds \sum_{n=1}^\infty\frac1n$ diverges.}{We will use a proof by contradiction here. Suppose the harmonic series converges to $S$. That is $$S=1+\frac12+ \frac13 +\frac14+\frac15+\frac16+\frac17+\frac18+\cdots$$
We then have
\begin{align*}
