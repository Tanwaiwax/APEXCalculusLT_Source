...
\mtable{Scatter plots relating to the series of \autoref{ex_series1} part 2.}{fig:series1b}{\begin{tikzpicture}[alt={Blue b_n dots alternate 1; red S_n stay near 0; scatter for 1 < n < 10, y-axis –1 < y < 1.}]
...
\end{tikzpicture}
\smallskip\\(a)\bigskip\\
\begin{tikzpicture}[alt={Blue a_n +ve towards  0; red S_n flatten at  almost 0.6; scatter 2 < n < 10, y-axis –0.5 < y < 1.}]
\begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,xtick={2,4,6,8,10},
ymin=-1.1,ymax=1.1,xmin=-1,xmax=11]
...
\mtable{Scatter plots relating to the series of \autoref{ex_series4} part 2.}{fig:series4b}{\begin{tikzpicture}[alt={Scatter-blue a_n stays at 0, red S_n increases slowly to about 4.5 over 10 < n < 100.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,
...
%\mtable{Scatter plots relating to the series of \autoref{ex_series5} part 1.}{fig:series5a}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
%\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
%axis y line=middle,axis x line=middle,name=myplot,axis on top,
