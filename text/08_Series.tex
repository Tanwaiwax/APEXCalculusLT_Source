...
\]\clearpage}
{\mtable[-1in]{Scatter plots relating to the series in \autoref{ex_series2}.}{fig:series2}{%
\begin{tabular}{c}
...
\item	Since $|r| = 1/2 < 1$, this series converges, and by \autoref{thm:geom_series},
...
\noindent\hfill 1. $\ds \sum_{n=1}^\infty \frac{2}{n^2+2n}$ \qquad 2. $\ds \sum_{n=1}^\infty \ln\left(\frac{n+1}{n}\right)$\hfill}
{\begin{enumerate}
...
%
%\noindent 1. $\ds\sum_{n=1}^\infty \frac{(-1)^{n+1}\big(n^2-n\big)}{n^3}$\qquad 2. $\ds\sum_{n=1}^\infty \frac{1000}{n!}$\qquad 3. $\ds \frac1{16}+\frac1{25}+\frac1{36}+\frac1{49}+\dotsb$
%}
%{\begin{enumerate}
...
&+&\ds\sum_{n=10,000,001}^\infty\frac1n\\[4ex]
\ds\sum_{n=1}^\infty\frac1n
&-&\ds\sum_{n=1}^{10,000,000}\frac1n
&=&\ds\sum_{n=10,000,001}^\infty\frac1n&&\\[4ex]
\parbox{50pt}{\centering	very large number}&-&16.7&=&\parbox{50pt}{\centering	very large number}
\end{array}
\]
