...
%\mfigure{0in}{Scatter plots relating to the series of Example \ref{ex_series1} part 1.}{fig:series1a}{figures/figseries1a}
...
%\mfigure{0in}{Scatter plots relating to the series of Example \ref{ex_series1} part 2.}{fig:series1b}{figures/figseries1b}
\mtable{Scatter plots relating to Example \ref{ex_series1}.}{fig:series1}{%
\begin{tabular}{c}
...
\mfigure{0in}{Scatter plots relating to the series in Example \ref{ex_series2}.}{fig:series2a}{figures/figseries2a}

%\mfigure{0in}{Scatter plots relating to the series of Example \ref{ex_series2} part 1.}{fig:series2a}{figures/figseries2a}
...
%\mfigure{0in}{Scatter plots relating to the series of Example \ref{ex_series2} part 2.}{fig:series2b}{figures/figseries2b}
...
%\mfigure{0in}{Scatter plots relating to the series of Example \ref{ex_series2} part 3.}{fig:series2c}{figures/figseries2c}
\mtable{Scatter plots relating to the series in Example \ref{ex_series2}.}{fig:series2}{%
\begin{tabular}{c}
...
\mfigure{0in}{Scatter plots relating to the series of Example \ref{ex_series3}.}{fig:series3}{figures/figseries3}}
...
%\mfigure{0in}{Scatter plots relating to the series of Example \ref{ex_series4} part 1.}{fig:series4a}{figures/figseries4a}
\mtable{Scatter plots relating to the series in Example \ref{ex_series4}.}{fig:series4}{%
\begin{tabular}{c}
...
%\mfigure{0in}{Scatter plots relating to the series of Example \ref{ex_series4} part 2.}{fig:series4b}{figures/figseries4b}
\end{enumerate}}
...
%\mfigure{0in}{Scatter plots relating to the series of Example \ref{ex_series5} part 1.}{fig:series5a}{figures/figseries5a}
...
%\mfigure{0in}{Scatter plots relating to the series of Example \ref{ex_series5} part 2.}{fig:series5b}{figures/figseries5b}
\mtable{Scatter plots relating to the series in Example \ref{ex_series5}.}{fig:series5}{%
\begin{tabular}{c}
...
\[
\begin{array}{ccccccc}
&&\ds\sum_{n=1}^\infty \frac1n
&=&\ds\sum_{n=1}^{10,000,000}\frac1n
&+&\ds\sum_{n=10,000,001}^\infty\frac1n\\[3ex]
\ds\sum_{n=1}^\infty\frac1n
&-&\ds\sum_{n=1}^{10,000,000}\frac1n
&=&\ds\sum_{n=10,000,001}^\infty\frac1n&&\\[3ex]
\infty&-&16.7&=&\infty.
