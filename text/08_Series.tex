...
%
\mtable{Scatter plots relating to the series of \autoref{ex_series1} part 1.}{fig:series1a}{\begin{tikzpicture}[alt={Blue a_n rise gently to almost 100 while red S_n surge to almost 340; scatter for 1 < n < 10, y-axis 0 < y < 350.}]
...
\mtable{Scatter plots relating to the series of \autoref{ex_series1} part 2.}{fig:series1b}{\begin{tikzpicture}[alt={Blue b_n dots alternate +ve and -ve 1; red S_n stay near 0; scatter for 1 < n < 10, y-axis –1 < y < 1.}]
...
\begin{tikzpicture}[alt={Blue a_n decline toward 0; red S_n creep up to 2; scatter 2 < n < 10, y-axis –1 < y < 2.5.}]
\begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
...
\end{tikzpicture}
\smallskip\\(a)\bigskip\\
\begin{tikzpicture}[alt={Scatter: blue a_n decays to 0, red S_n levels near 0.6; 2<n<10, –0.5<y<1}]
\begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,xtick={2,4,6,8,10},
ymin=-1.1,ymax=1.1,xmin=-1,xmax=11]
...
\end{tikzpicture}
\smallskip\\(b)\bigskip\\
\begin{tikzpicture}[alt={Blue a_n explode past 800; red S_n climb past 1 000; scatter 1 < n < 6, y-axis 0 < y < 1 100.}]
\begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,
...
\mtable{Scatter plots relating to the series of \autoref{ex_series4} part 2.}{fig:series4b}{\begin{tikzpicture}[alt={Scatter—blue a_n drops toward 0 while red S_n rises and levels near 1.3; data for 1 < n < 10.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,
...
%\mtable{Scatter plots relating to the series of \autoref{ex_series5} part 1.}{fig:series5a}{\begin{tikzpicture}[alt={Scatter—blue a_n stays at 0, red S_n increases slowly to about 4.5 over 10 < n < 100.}]
%\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
%axis y line=middle,axis x line=middle,name=myplot,axis on top,
...
%\mtable{Scatter plots relating to the series of \autoref{ex_series5} part 2.}{fig:series5b}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
%\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
%axis y line=middle,axis x line=middle,name=myplot,axis on top,
