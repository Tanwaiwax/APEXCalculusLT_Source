...
$\ds \rule{0pt}{15pt}\frac{(-1)^{n+1}(n-1)!}{x^n}$ \hspace{-2em} & & $(-1)^{n+1}(n-1)!$
\end{tabular}}
\[
p_6(x)
...
\mtable[-5\baselineskip]{A table of the derivatives of $f(x)=\cos x$ evaluated at $x=0$.}{fig:taypoly4a}{\begin{tabular}{lll}
