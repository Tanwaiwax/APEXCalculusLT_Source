...
\mtable{Plotting $y=f(x)$ and a table of derivatives of $f$ evaluated at 0.}{fig:taypolyintroa}{\myincludegraphics{figures/figtaypolyintroa}\smallskip\\
\begin{tabular}{lll}
$f(0) = 2$ & &$\fp''(0) = -1$\\
$\fp(0) = 1$ &&	$f\,^{(4)}(0)=-12$ \\
$\fpp(0) = 2$ && $f\,^{(5)}(0)=-19$
...
This is an error of about $0.0016$, or $0.06\%$.
...
\mtable{A table of the derivatives of $f(x)=\cos x$ evaluated at $x=0$.}{fig:taypoly4a}{\begin{tabular}{lll}
