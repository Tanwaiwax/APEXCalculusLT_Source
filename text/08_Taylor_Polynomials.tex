...
\mtable{Plotting $y=f(x)$ and a table of derivatives of $f$ evaluated at 0.}{fig:taypolyintroa}{%
\begin{tabular}{c}
...
\mfigure{0in}{Plotting $f$, $p_2$ and $p_4$.}{fig:taypolyintrob}{figures/figtaypolyintrob}
\mfigure{0in}{Plotting $f$ and $p_{13}$.}{fig:taypolyintroc}{figures/figtaypolyintroc}
...
\flushinnerequ{\scriptsize $$\frac{16901x^{13}}{6227020800}+\frac{13x^{12}}{1209600}-\frac{1321x^{11}}{39916800}-\frac{779x^{10}}{1814400}-\frac{359x^9}{362880}+\frac{x^8}{240}+\frac{139x^7}{5040}+\frac{11 x^6}{360}-\frac{19x^5}{120}-\frac{x^4}{2}-\frac{x^3}{6}+x^2+x+2.$$}
...
This is an error of $0.0016$, or about $0.06\%$.

A plot of $f(x)=e^x$ and $p_5(x)$ is given in \autoref{fig:taypoly1b}.\eoehere
\mfigure{0in}{A plot of $f(x)=e^x$ and its 5$^\text{th}$ degree Maclaurin polynomial $p_5(x)$.}{fig:taypoly1b}{figures/figtaypoly1b}
\end{enumerate}}
...
\mfigure{0in}{A plot of $y=\ln x$ and its 6$^\text{th}$ degree Taylor polynomial at $x=1$.}{fig:taypoly2b}{figures/figtaypoly2b}
\item	
...
\mfigure{0in}{A plot of $y=\ln x$ and its 20$^\text{th}$ degree Taylor polynomial at $x=1$.}{fig:taypoly2c}{figures/figtaypoly2c}
...
\index{Taylor Polynomial!Taylor's Theorem}\index{Taylor's Theorem}
	\item	$\abs{R_n(x)}\leq\dfrac{\max\abs{\,f\,^{(n+1)}(z)}}{(n+1)!}\abs{x-c}^{n+1}$.
\end{enumerate}}
...
We now set out to compute $p_9(x)$. We again need a table of the derivatives of $f(x)=\cos x$ evaluated at $x=0$. A table of these values is given in \autoref{fig:taypoly4a}.
\mtable[-1in]{A table of the derivatives of $f(x)=\cos x$ evaluated at $x=0$.}{fig:taypoly4a}{%
\begin{tabular}{lll}
...
\mfigure{-1in}{A graph of $f(x)= \cos x$ and its degree 8 Maclaurin polynomial.}{fig:taypoly4b}{figures/figtaypoly4}
...
\end{enumerate}}
{\begin{enumerate}
	\item	We begin by evaluating the derivatives of $f$ at $x=4$. This is done in \autoref{fig:taypoly5a}.
...
\[\abs{R_4(3)} \leq \frac{0.0273}{5!}\abs{3-4}^5 \approx 0.00023.\]
\mfigure{-1in}{A graph of $f(x)=\sqrt{x}$ and its degree 4 Taylor polynomial at $x=4$.}{fig:taypoly5b}{figures/figtaypoly5}%
...
%				&= 1+x+x^2+x^3.
%\end{align*}
%\mfigure{0in}{A graph of $y=-1/(x-1)$ and $y=p_3(x)$ from \autoref{ex_taypoly6}.}{fig:taypoly6}{figures/figtaypoly6}
...
% todo for exercises 21-24, reach back to lin approx / Newton’s method to redo the problems
