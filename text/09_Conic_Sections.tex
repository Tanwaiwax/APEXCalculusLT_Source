...
\mtable{Illustrating the definition of the parabola and establishing an algebraic formula.}{fig:parabola_def}{\pdftooltip{\begin{tikzpicture}[scale=.75]
...
\solution
%
\mtable{The parabola described in \autoref{ex_conic1}.}{fig:conic1}{\pdftooltip{\begin{tikzpicture}
...
\mtable{The parabola described in \autoref{ex_conic2}. The distances from a point on the parabola to the focus and directrix is given.}{fig:conic2}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Illustrating the parabola's reflective property.}{fig:conic_reflect}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable[-2\baselineskip]{Illustrating the construction of an ellipse with pins, pencil and string.}{fig:ellipse_def}{\pdftooltip{\begin{tikzpicture}
...
\mtable[5\baselineskip]{Labeling the significant features of an ellipse.}{fig:ellipse_label}{\pdftooltip{\begin{tikzpicture}
...
%
\mtable{The ellipse used in \autoref{ex_conic3}.}{fig:conic3}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\end{align*}
%
\mtable{Graphing the ellipse in \autoref{ex_conic4}.}{fig:conic4}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Illustrating the reflective property of an ellipse.}{fig:ellipse_reflect}{\pdftooltip{\begin{tikzpicture}[scale=1.2]%[width=1.16\marginparwidth]
...
\mtable{Labeling the significant features of a hyperbola.}{fig:hyperbola_def}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable[-1.2in]{Graphing the hyperbola $\frac{x^2}9-\frac{y^2}1 = 1$ along with its asymptotes, $y=\pm x/3$.}{fig:hyperbola_asy1}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable[.2in]{Using the asymptotes of a hyperbola as a graphing aid.}{fig:hyperbola_asy2}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable[.5in]{Graphing the hyperbola in \autoref{ex_conic5}.}{fig:conic5}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Graphing the hyperbola in \autoref{ex_conic6}.}{fig:conic6}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Illustrating the reflective property of a hyperbola.}{fig:hyperbola_reflect}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=none,axis x line=none,name=myplot,
