...
\mtable[-2\baselineskip]{Illustrating the construction of an ellipse with pins, pencil and string.}{fig:ellipse_def}{\begin{tikzpicture}[alt={Dashed ellipse drawn by string loop on two fixed pins (foci); pencil keeps string taut so d_1+d_2 is constant along curve.}]
...
\mtable[5\baselineskip]{Labeling the significant features of an ellipse.}{fig:ellipse_label}{\begin{tikzpicture}[alt={Ellipse with dashed major/minor axes; red dots mark foci, endpoints mark vertices; distances a, b, c labelled inside.}]
