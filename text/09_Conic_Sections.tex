...
\mtable{Illustrating the definition of the parabola and establishing an algebraic formula.}{fig:parabola_def}{\begin{tikzpicture}[={Red upward parabola, vertex at origin; focus above on axis; blue directrix y = −p; dashed equal d from (x,y) to focus and line.},scale=.75]
...
\solution
%
\mtable{The parabola described in \autoref{ex_conic1}.}{fig:conic1}{\begin{tikzpicture}[={Blue downward parabola peaks at y = 2; symmetric about y-axis, crosses x-axis and; axes shown to x = 5 and y = −6.}]
