...
\section{Chapter Prerequisites --- Conic Sections}\label{sec:conic_sections}
\prereqIntro
...
\end{tabular}}
\captionof{figure}{Conic Sections}\label{fig:nondeg_conic}
\end{lxfigure}
...
\mfigure{0in}{Illustrating the definition of the parabola and establishing an algebraic formula.}{fig:parabola_def}{figures/figparabola_def}
...
\mfigure{0in}{The parabola described in \autoref{ex_conic1}.}{fig:conic1}{figures/figconic1}
...
\mfigure{0in}{The parabola described in \autoref{ex_conic2}. The distances from a point on the parabola to the focus and directrix is given.}{fig:conic2}{figures/figconic2}
...
\mfigure{0in}{Illustrating the parabola's reflective property.}{fig:conic_reflect}{figures/figconic_reflect}
...
\mfigure{0in}{Illustrating the construction of an ellipse with pins, pencil and string.}{fig:ellipse_def}{figures/figellipse_def}
...
$$\frac{x^2}{a^2} + \frac{y^2}{b^2} = 1.$$ This choice of $a$ and $b$ is not without reason; as shown in \autoref{fig:ellipse_label}, the values of $a$ and $b$ have geometric meaning in the graph of the ellipse. 
\mfigure{0in}{Labeling the significant features of an ellipse.}{fig:ellipse_label}{figures/figellipse_label}
...
\mfigure{0in}{The ellipse used in \autoref{ex_conic3}.}{fig:conic3}{figures/figconic3}}
...
\end{align*}
\mfigure{0in}{Graphing the ellipse in \autoref{ex_conic4}.}{fig:conic4}{figures/figconic4}
...
\begin{lxfigure}
 \begin{tabular}{cc}
  ...
  (c) & (d)
 \end{tabular}
 \captionof{figure}{Understanding the eccentricity of an ellipse.}
...
\mfigure{0in}{Illustrating the reflective property of an ellipse.}{fig:ellipse_reflect}{figures/figellipse_reflect}
...
\mfigure{0in}{Labeling the significant features of a hyperbola.}{fig:hyperbola_def}{figures/fighyperbola_def}
...
\mfigure{-1in}{Graphing the hyperbola $\frac{x^2}9-\frac{y^2}1 = 1$ along with its asymptotes, $y=\pm x/3$.}{fig:hyperbola_asy1}{figures/fighyperbola_asy1}
...
\mfigure{0in}{Using the asymptotes of a hyperbola as a graphing aid.}{fig:hyperbola_asy2}{figures/fighyperbola_asy2}
...
\mfigure{0in}{Graphing the hyperbola in \autoref{ex_conic5}.}{fig:conic5}{figures/figconic5}
...
\mfigure{0in}{Graphing the hyperbola in \autoref{ex_conic6}.}{fig:conic6}{figures/figconic6}
...
\begin{lxfigure}
 \begin{tabular}{cc}
  ...
  (c) & (d)
 \end{tabular}
 \captionof{figure}{Understanding the eccentricity of a hyperbola.}
...
A key to this method is knowing distances. What if this information is not available? Consider three microphones at positions $A$, $B$ and $C$ which all record a noise (a person's voice, an explosion, et.c.) created at unknown location $D$. The microphone does not ``know'' when the sound was \textit{created}, only when the sound was \textit{detected}. How can the location be determined in such a situation?

\mfigure{0in}{Illustrating the reflective property of a hyperbola.}{fig:hyperbola_reflect}{figures/fighyperbola_reflect}
...
\myincludegraphics{figures/fighyperbola_locate1} & \myincludegraphics{figures/fighyperbola_locate2} & \myincludegraphics{figures/fighyperbola_locate3}  \\ 
(a) & (b) & (c) 
\end{tabular}}
\captionof{figure}{Using hyperbolas in location detection.}%
