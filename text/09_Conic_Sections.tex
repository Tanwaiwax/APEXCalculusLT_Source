\section*{\thesection\quad Chapter Prerequisites --- Conic Sections}\label{sec:conic_sections}
\prereqIntro
...
%This choice of $a$ and $b$ is not without reason; a
As shown in \autoref{fig:ellipse_label}, the values of $a$ and $b$ have
% geometric
meaning. % in the graph of the ellipse. 
