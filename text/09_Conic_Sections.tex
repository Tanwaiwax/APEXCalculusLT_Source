...
\mtable{Illustrating the definition of the parabola and establishing an algebraic formula.}{fig:parabola_def}{\begin{tikzpicture}[scale=.75]
...
\mtable[-2\baselineskip]{Illustrating the construction of an ellipse with pins, pencil and string.}{fig:ellipse_def}{\begin{tikzpicture}
...
\mtable[5\baselineskip]{Labeling the significant features of an ellipse.}{fig:ellipse_label}{\begin{tikzpicture}
...
\mtable[-1.2in]{Graphing the hyperbola $\frac{x^2}9-\frac{y^2}1 = 1$ along with its asymptotes, $y=\pm x/3$.}{fig:hyperbola_asy1}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable[.2in]{Using the asymptotes of a hyperbola as a graphing aid.}{fig:hyperbola_asy2}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable[.5in]{Graphing the hyperbola in \autoref{ex_conic5}.}{fig:conic5}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
