...
\end{align*}
%
\mtable{Graphing the ellipse in \autoref{ex_conic4}.}{fig:conic4}{\begin{tikzpicture}[alt={Horizontal ellipse; endpoints marked at left and right, two interior foci, and central point on major axis.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable[-1.2in]{Graphing the hyperbola $\frac{x^2}9-\frac{y^2}1 = 1$ along with its asymptotes, $y=\pm x/3$.}{fig:hyperbola_asy1}{\begin{tikzpicture}[alt={Blue hyperbola x^2/9 − y^2 = 1 with red dashed asymptotes y = +/-x/3; axes roughly −5 < x < 5, −2 < y < 2.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable[.2in]{Using the asymptotes of a hyperbola as a graphing aid.}{fig:hyperbola_asy2}{\begin{tikzpicture}[alt={Blue hyperbola framed by dashed rectangle (width 2a, height 2b); red asymptotes pass rectangle corners; center labeled (h, k).}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable[.5in]{Graphing the hyperbola in \autoref{ex_conic5}.}{fig:conic5}{\begin{tikzpicture}[alt={Blue hyperbola; central dashed box and red asymptotes crossing at origin; axes about −5 < x < 5, −1 < y < 7.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Graphing the hyperbola in \autoref{ex_conic6}.}{fig:conic6}{\begin{tikzpicture}[alt={Blue vertical-opening hyperbola with vertices at (+/-1 , 0); red dashed asymptotes form “X” through origin; gray dashed box and black-dot foci at (+/-3 , 0); axes −4 < x < 4, −10 < y < 10.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Illustrating the reflective property of a hyperbola.}{fig:hyperbola_reflect}{\begin{tikzpicture}[alt={Twin hyperbola arms; foci F1, F2; grey ray from F1 strikes curve, reflected arrow aims toward F2.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=none,axis x line=none,name=myplot,
...
\begin{tikzpicture}[alt={Baseline setup: sensor B at −500, sensor A at 500 on x-axis; reference point C sits at (0, 1000) above.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
...
\end{tikzpicture}
 &
\begin{tikzpicture}[alt={Dashed left hyperbola branch through C marks points with equal range-difference to A and B.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
ymin=-1100,ymax=1100,xmin=-1100,xmax=1100]
...
\end{tikzpicture}
 &
\begin{tikzpicture}[alt={Solid hyperbola meets dashed circle at D, pinpointing the source relative to sensors A and B.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
ymin=-1100,ymax=1100,xmin=-1100,xmax=1100]
\addplot [thick, smooth,domain=-85:85,samples=60] ({170*sec(x)},{470*tan(x)});
