...
\myincludegraphics[alt={ALT-TEXT-TO-BE-DETERMINED},scale=.25]{figures/conic_parabola}&
\myincludegraphics[alt={ALT-TEXT-TO-BE-DETERMINED},scale=.25]{figures/conic_ellipse}&
\myincludegraphics[alt={ALT-TEXT-TO-BE-DETERMINED},scale=.25]{figures/conic_circle}&
\myincludegraphics[alt={ALT-TEXT-TO-BE-DETERMINED},scale=.25]{figures/conic_hyperbola} \\
Parabola & Ellipse & Circle &  Hyperbola \\
\myincludegraphics[alt={ALT-TEXT-TO-BE-DETERMINED},scale=.25]{figures/conic_singlept}&
\myincludegraphics[alt={ALT-TEXT-TO-BE-DETERMINED},scale=.25]{figures/conic_oneline}&
\myincludegraphics[alt={ALT-TEXT-TO-BE-DETERMINED},scale=.25]{figures/conic_crossedlines} \\
...
\mtable{Illustrating the definition of the parabola and establishing an algebraic formula.}{fig:parabola_def}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},scale=.75]
...
\solution
%
\mtable{The parabola described in \autoref{ex_conic1}.}{fig:conic1}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
...
\mtable{The parabola described in \autoref{ex_conic2}. The distances from a point on the parabola to the focus and directrix is given.}{fig:conic2}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Illustrating the parabola's reflective property.}{fig:conic_reflect}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable[-2\baselineskip]{Illustrating the construction of an ellipse with pins, pencil and string.}{fig:ellipse_def}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
...
\mtable[5\baselineskip]{Labeling the significant features of an ellipse.}{fig:ellipse_label}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
...
%
\mtable{The ellipse used in \autoref{ex_conic3}.}{fig:conic3}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\end{align*}
%
\mtable{Graphing the ellipse in \autoref{ex_conic4}.}{fig:conic4}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
