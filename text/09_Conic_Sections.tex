...
\myincludegraphics[Parabola - {plane parallel to a generator cuts one nappe, giving a single open curve.},scale=.25]{figures/conic_parabola}&
\myincludegraphics[Ellipse - {shallow-slant plane meets one nappe in a closed oval.},scale=.25]{figures/conic_ellipse}&
\myincludegraphics[Circle - {horizontal plane slices one nappe symmetrically, forming a round loop.},scale=.25]{figures/conic_circle}&
\myincludegraphics[Hyperbola - {steep plane intersects both nappes, yielding two mirrored branches.},scale=.25]{figures/conic_hyperbola} \\
Parabola & Ellipse & Circle &  Hyperbola \\
\myincludegraphics[Point - {plane through the apex parallel to the base touches only at the tip.},scale=.25]{figures/conic_singlept}&
\myincludegraphics[Single line - {plane tangent along one generator meets the cone in one straight segment.},scale=.25]{figures/conic_oneline}&
\myincludegraphics[Crossed lines – {plane through the apex meets both nappes in an X of two lines.},scale=.25]{figures/conic_crossedlines} \\
...
\mtable{Illustrating the definition of the parabola and establishing an algebraic formula.}{fig:parabola_def}{\begin{tikzpicture}[alt={Red upward parabola, vertex at origin; focus above on axis; blue directrix y = −p; dashed equal d from (x,y) to focus and line.},scale=.75]
...
\solution
%
\mtable{The parabola described in \autoref{ex_conic1}.}{fig:conic1}{\begin{tikzpicture}[alt={Blue downward parabola peaks at y = 2; symmetric about y-axis, crosses x-axis and; axes shown to x = 5 and y = −6.}]
...
\mtable{The parabola described in \autoref{ex_conic2}. The distances from a point on the parabola to the focus and directrix is given.}{fig:conic2}{\begin{tikzpicture}[alt={Dashed ellipse drawn by string loop on two fixed pins (foci); pencil keeps string taut so d_1+d_2 is constant along curve.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Illustrating the parabola's reflective property.}{fig:conic_reflect}{\begin{tikzpicture}[alt={Ellipse with dashed major/minor axes; red dots mark foci, endpoints mark vertices; distances a, b, c labelled inside.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable[-2\baselineskip]{Illustrating the construction of an ellipse with pins, pencil and string.}{fig:ellipse_def}{\begin{tikzpicture}[alt={Tall blue ellipse centered near (−3, 1); plotted on axes with ticks −6<x<6 and −4<y<6, black dot marks focus location.}]
...
\mtable[5\baselineskip]{Labeling the significant features of an ellipse.}{fig:ellipse_label}{\begin{tikzpicture}[alt={Blue ellipse centered (1 , 2); vertices (−1 , 2) and (3 , 2); black foci at (0 , 2) and (2 , 2); axes −2 < x < 4, 0 < y < 4.}]
...
%
\mtable{The ellipse used in \autoref{ex_conic3}.}{fig:conic3}{\begin{tikzpicture}[alt={Blue hyperbola opening left-right, center at origin; black vertices, red foci farther out; dashed transverse, conjugate axes and asymptote guides.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\end{align*}
%
\mtable{Graphing the ellipse in \autoref{ex_conic4}.}{fig:conic4}{\begin{tikzpicture}[alt={Blue hyperbola x^2/9 − y^2 = 1 with red dashed asymptotes y = +/-x/3; axes roughly −5 < x < 5, −2 < y < 2.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Illustrating the reflective property of an ellipse.}{fig:ellipse_reflect}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},scale=1.2]%[width=1.16\marginparwidth]
...
\mtable{Labeling the significant features of a hyperbola.}{fig:hyperbola_def}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable[-1.2in]{Graphing the hyperbola $\frac{x^2}9-\frac{y^2}1 = 1$ along with its asymptotes, $y=\pm x/3$.}{fig:hyperbola_asy1}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable[.2in]{Using the asymptotes of a hyperbola as a graphing aid.}{fig:hyperbola_asy2}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable[.5in]{Graphing the hyperbola in \autoref{ex_conic5}.}{fig:conic5}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Graphing the hyperbola in \autoref{ex_conic6}.}{fig:conic6}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Illustrating the reflective property of a hyperbola.}{fig:hyperbola_reflect}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=none,axis x line=none,name=myplot,
