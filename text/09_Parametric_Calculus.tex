...
\mtable{Graphing tangent and normal lines in \autoref{ex_parcalc1}.}{fig:parcalc1}{\pdftooltip{\begin{tikzpicture}
...
%
\mtable{Illustrating how a circle's normal lines pass through its center.}{fig:parcalc2}{\pdftooltip{\begin{tikzpicture}
...
%
\mtable{A graph of an astroid.}{fig:parcalc3}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Graphing the parametric equations in \autoref{ex_parcalc4} to demonstrate concavity.}{fig:parcalc4}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,minor x tick num=1,
minor y tick num=1,ymin=-20,ymax=55,xmin=-5,xmax=90]
\addplot [draw={\colorone},thick, smooth,domain=-3.5:5,samples=30]
...
\mtable{A graph of the parametric equations in \autoref{ex_parcalc7}, where the arc length of the teardrop is calculated.}{fig:parcalc7}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,xtick={1,-1},ytick={-1,1},
