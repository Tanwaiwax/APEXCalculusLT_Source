...
\begin{keyidea}[Finding $\frac{dy}{dx}$ with Parametric Equations.]\label{idea:dydxpar}
...
\begin{keyidea}[Finding $\frac{d^2y}{dx^2}$ with Parametric Equations]\label{idea:second_der_par}
