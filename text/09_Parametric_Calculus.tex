...
\mtable{Graphing tangent and normal lines in \autoref{ex_parcalc1}.}{fig:parcalc1}{\begin{tikzpicture}
...
\end{align*}%
%
\mtable{Illustrating how a circle's normal lines pass through its center.}{fig:parcalc2}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
%
\mtable{A graph of an astroid.}{fig:parcalc3}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Graphing the parametric equations in \autoref{ex_parcalc4} to demonstrate concavity.}{fig:parcalc4}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,minor x tick num=1,
minor y tick num=1,ymin=-20,ymax=55,xmin=-5,xmax=90]
\addplot [draw={\colorone},thick, smooth,domain=-3.5:5,samples=30]
...
\begin{gather*}
\frac{dy}{dx} = \frac{y\primeskip'(t)}{x\primeskip'(t)}
...
We can use this equation and convert it to the parametric equation context. Letting $x=f(t)$ and $y=g(t)$, we know that $\frac{dy}{dx} = g\primeskip'(t)/\fp(t)$. Suupose that $f'(t)>0$, and calculate the differential of $x$:
...
\example{ex_parcalc6}{Arc Length of a Circle}{Find the arc length of the circle parameterized by $x=3\cos t$, $y=3\sin t$ on $[0,3\pi/2]$. 
}
...
%
\mtable{A graph of the parametric equations in \autoref{ex_parcalc7}, where the arc length of the teardrop is calculated.}{fig:parcalc7}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,xtick={1,-1},ytick={-1,1},
