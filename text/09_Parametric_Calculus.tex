...
\mtable{Graphing tangent and normal lines in \autoref{ex_parcalc1}.}{fig:parcalc1}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
...
%
\mtable{Illustrating how a circle's normal lines pass through its center.}{fig:parcalc2}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
...
%
\mtable{A graph of an astroid.}{fig:parcalc3}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Graphing the parametric equations in \autoref{ex_parcalc4} to demonstrate concavity.}{fig:parcalc4}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,minor x tick num=1,
minor y tick num=1,ymin=-20,ymax=55,xmin=-5,xmax=90]
\addplot [draw={\colorone},thick, smooth,domain=-3.5:5,samples=30]
...
\mtable{A graph of the parametric equations in \autoref{ex_parcalc7}, where the arc length of the teardrop is calculated.}{fig:parcalc7}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,xtick={1,-1},ytick={-1,1},
...
3Dcoo=0 0.000 0,
3Droo=120.71813597868993}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figparcalc8_3D}
