...
\mtable{Graphing projectile motion in \autoref{ex_pareq6}.}{fig:pareq6}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
...
\example{ex_pareq7}{Eliminating the parameter}{Find a rectangular equation for the curve described by
...
\mtable{Graphing parametric and rectangular equations for a graph in \autoref{ex_pareq7}.}{fig:pareq7}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
...
\mtable{Graphing the parametric equations $x=4\cos t+3$, $y=2\sin t+1$ in \autoref{ex_pareq8}.}{fig:pareq8}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
%
\mtable{A graph of the parametric equations from \autoref{ex_pareq4}.}{fig:pareq4}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\draw (axis cs: 7,14) node [align=left]
 {\scriptsize $x=t^3-5t^2+3t+11$\\ \scriptsize $y=t^2-2t+3$};
\end{axis}
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}
...
\end{tikzpicture}
  ...
  \begin{tikzpicture}
   \begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
                ...
                ymin=-.2,ymax=6.2,xmin=-.1,xmax=6.3,axis equal]
  ...
  \begin{tikzpicture}
   \begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
                axis y line=middle,axis x line=middle,name=myplot,
                %xtick={-1,1},ytick={-1,1},
                ymin=-.1,ymax=6.1,xmin=-3.1,xmax=3.1,axis equal]
...
\end{tikzpicture}
  &
% todo Tim folium of Descartes should be in Implicit Equation gallery?
  \begin{tikzpicture}
   \begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
                axis y line=middle,axis x line=middle,name=myplot,
...
%
\mtable{Graphing the curve in \autoref{ex_pareq9}; note it is not smooth at $(1,4)$.}{fig:pareq9}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,minor x tick num=4,
...
\begin{lxfigure}
 \centering
  \begin{tikzpicture}
   \begin{axis}[axis lines=none,xmin=-1,xmax=4*pi+1,ymin=0,ymax=2.5,axis equal,
     width=\textwidth]
