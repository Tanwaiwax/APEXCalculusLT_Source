...
% todo Tim should these be labeled as figures?
\[
...
\begin{lxfigure}
 ...
 \begin{tikzpicture}[scale=.8]
   \foreach \x in { 0, 2.09, 4.19, 6.28, 8.38, 10.47, 12.57} {
    \draw [draw={\colorone}] (\x,1) circle (1);
    \draw [draw={\colorone},fill={\colorone}] (\x,1) circle (2pt)
   ...
   \draw [draw={\colortwo},smooth,thick,domain=0:12.56,variable=\t]
