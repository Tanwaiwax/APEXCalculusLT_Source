...
\end{align*}
%
\mtable{The limaçon in \autoref{ex_polcalc1} with its tangent line at $\theta=\pi/4$ and points of vertical and horizontal tangency.}{fig:polcalc1}{\pdftooltip{\begin{tikzpicture}
...
%
\mtable{Graphing the tangent lines at the pole in \autoref{ex_polcalc2}.}{fig:polcalc2}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\[
\pdftooltip{\begin{tikzpicture}[x=30pt,y=30pt,thick]
...
%
\mtable[\baselineskip]{Finding the area of the shaded region of a cardioid in \autoref{ex_polcalc4}.}{fig:polcalc4}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Illustrating area bound between two polar curves.}{fig:polarea3}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
...
\mtable{Finding the area between polar curves in \autoref{ex_polcalc5}.}{fig:polcalc5}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\end{align*}
%
\mtable[-6\baselineskip]{The limaçon in \autoref{ex_polcalc7} whose arc length is measured.}{fig:polcalc7}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,
