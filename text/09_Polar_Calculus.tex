...
\example{ex_cardioid_length}{Arc Length of Polar Curves}{Find the arc length of the cardioid $r=1+\cos \theta$.}{With $r=1+\cos \theta$, we have $r' = -\sin \theta$. The cardioid is traced out once on $[0,2\pi]$, giving us our bounds of integration. Applying \autoref{idea:polar_arclength} we have
\begin{align*}
	L
...
\example{ex_polcalc7}{Arc length of a lima\c con}{Find the arc length of the lima\c con $r=1+2\sin\theta$.}
