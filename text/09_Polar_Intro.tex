...
\fi
\begin{tikzpicture}[alt={Three concentric circles (r = 1, 2, 3); points: A at 30 deg (pi / 6), B at 210 deg (7pi / 6), C at 315 deg (7pi / 4), D at 240 deg (4pi / 3).},remember picture,overlay,scale=.8,gridshift]
...
\end{tikzpicture}		
&
\begin{tikzpicture}[alt={Horizontal figure-eight centred at origin, each lobe length a sqrt of 2.},scale=.9,>=stealth]
	\draw [<->,] (-2.1,0) -- (2.1,0);
	\draw [<->,] (0,-2.1) -- (0,2.1);
