...
\textbf{\large Lines}\\[\baselineskip]
...
\myincludegraphics[scale=.9]{figures/figpolarline1} & \myincludegraphics[scale=.9]{figures/figpolarline2} & \myincludegraphics[scale=.9]{figures/figpolarline4} & \myincludegraphics[scale=.9]{figures/figpolarline3} \\[2\baselineskip]
\textbf{\large Circles} &&& \textbf{\large Sprial} \\[\baselineskip]
