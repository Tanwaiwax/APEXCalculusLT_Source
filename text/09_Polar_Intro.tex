...
\makebox[1pt][l]{Symmetric about $x$-axis: $r=a\pm b\cos\theta$; \qquad
...
\makebox[1pt][l]{Symmetric about $x$-axis: $r=a \cos(n\theta)$; \qquad
Symmetric about $y$-axis:  $r=a\sin(n\theta)$}\\
\makebox[1pt][l]{Curve contains $2n$ petals when $n$ is even and $n$ petals when $n$ is odd.}\\
