...
\iflatexml
here.\mnote{% copy and paste the above
\begin{tikzpicture}[scale=.8]
	\draw [dashed,gray] (-3.1,0) -- (0,0);
	\draw[thick,->,>=stealth] (0,0) node [below] {$O$} -- (3.5,0) ;
	\filldraw (0,0) circle (1.5pt);
...
\mfigure{0in}{Plotting polar points in Example \ref{ex_polar1}.}{fig:polar1}{figures/figpolar1}}
...
\mtable{Plotting rectangular and polar points in Example \ref{ex_polar2}.}{fig:polar2}{%
\begin{tabular}{c}
...
\mfigure{0in}{Plotting standard polar plots.}{fig:polar3}{figures/figpolar3}
\end{enumerate}}
...
\mtable{Graphing a polar function in Example \ref{ex_polar4} by plotting points.}{fig:polar4}{%
\begin{tabular}{c}
		$\begin{array}{cc}
...
\mtable{Polar plots from Example \ref{ex_polar5}.}{fig:polar5}{%
\begin{tabular}{c}
...
{\begin{enumerate}
	...
	\mfigure{0in}{Graphing $xy=1$ from Example \ref{ex_polar6}.}{fig:polar6}{figures/figpolar6}
...
\mtable{Graphs to help determine the points of intersection of the polar functions given in Example \ref{ex_polar7}.}{fig:polar7}{%
\begin{tabular}{c}
