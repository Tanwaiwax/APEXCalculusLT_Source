...
\fi
\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},remember picture,overlay,scale=.8,gridshift]
...
%
\mtable{Plotting polar points in \autoref{ex_polar1}.}{fig:polar1}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},scale=.75,>=latex]
...
\mtable{Converting between rectangular and polar coordinates.}{fig:polar_intro2}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},scale=.75,>=latex]
...
\mtable{Plotting standard polar plots.}{fig:polar3}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=latex]
 \draw [thick,->] (0,0) node [below] {$O$} -- (2.5,0);
 \foreach \x in {1,2}
...
\begin{tabular}{c}
 {$\begin{array}{cc}
	...
	11\pi/6 & 1+\sqrt{3}/2 \\
 \end{array}$} \\ \\
 \begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},scale=.95]
...
%
%\mtable{Using  technology to graph a polar function.}{fig:polar4b}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},scale=1]
%	\draw [dashed,gray] (-2.1,0) -- (0,0);
%	\draw[thick,->,>=stealth] (0,0) node [below] {$O$} -- (2.5,0) ;
%	\filldraw (0,0) circle (1.5pt);
%	\foreach \x in {1,2} {
...
\mtable[-2in]{Polar plots from \autoref{ex_polar5}.}{fig:polar5}{%
 \begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},scale=1]
  \draw [dashed,gray] (-2.1,0) -- (0,0);
