...
\begin{center}\pdftooltip{\begin{tikzpicture}[baseline=-3pt,>=stealth]
...
\end{tikzpicture}}{ALT-TEXT-TO-BE-DETERMINED}\end{center}
...
3Dc2c=.78 .32 .53,
3Dcoo=0 0 34,
3Droo=150}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figcrossp_rhr_3D}}
...
\mtable[-\baselineskip]{Using the cross product to find the area of a parallelogram.}{fig:crossp_parallelogram}{%
\pdftooltip{\begin{tikzpicture}[thick,scale=1.25]
...
\\(a) \\[15pt]
\pdftooltip{\begin{tikzpicture}[thick,scale=1.25,>=stealth]
...
\begin{equation}A = \vnorm u\,\vnorm v\sin\theta = \norm{\vec u\times\vec v},\label{eq:crossp1}\end{equation}
...
3Dcoo=61 60 63,
3Droo=250}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figcrossp4a_3D}\\
	(b)}
%
\solution
...
%
\mtable[1in]{Finding the area of a triangle in \autoref{ex_crossp5}.}{fig:crossp5}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
3Dc2c=.84 .46 .26,
3Dcoo=0 110 86,
3Droo=150}{.5\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figcrosspparallelpiped_3D}}%
%
...
3Dc2c=4 4 2,
3Dcoo=0 50 50,
3Droo=150}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figcrossp6_3D}}
%
...
While a full understanding of torque is beyond the purposes of this book, when a force $\vec F$ is applied to a lever arm $\vec \ell$, the resulting torque is \begin{equation}\vec \tau = \vec \ell\times\vec F.\label{eq:crossp3}\end{equation}
...
\mtable{Showing a force being applied to a lever in \autoref{ex_crossp7}.}{fig:crossp7}{\pdftooltip{\begin{tikzpicture}[>=stealth]
