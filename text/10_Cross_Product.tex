...
\begin{center}\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},baseline=-3pt,>=stealth]
...
\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},thick,scale=1.25]
 \draw(0,0)--node[below,pos=.5]{\scriptsize $b$}(2,0)--(3,1.5)--(1,1.5)--cycle;
 \draw [dashed] (1,1.5) -- (1,0) node [pos=.5,right] {\scriptsize$h$};
 \draw (.8,0) -- (.8,.2) -- (1,.2);
\end{tikzpicture}
\\(a) \\[15pt]
\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},thick,scale=1.25,>=stealth]
...
%
\mtable[1in]{Finding the area of a triangle in \autoref{ex_crossp5}.}{fig:crossp5}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Showing a force being applied to a lever in \autoref{ex_crossp7}.}{fig:crossp7}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth]
