...
%
\mtable[1in]{Finding the area of a triangle in \autoref{ex_crossp5}.}{fig:crossp5}{\begin{tikzpicture}[alt={Triangle ABC drawn; area found from half the magnitude of the cross product of two side vectors.}]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
