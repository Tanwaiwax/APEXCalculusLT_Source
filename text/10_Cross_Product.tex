...
\example{ex_crossp1}{Computing a cross product}{Let $\vec u = \la 2,-1,4\ra$ and $\vec v = \la 3,2,5\ra$. Find $\crossp uv$, and verify that it is orthogonal to both $\vec u$ and $\vec v$.}
...
\begin{center}\begin{tikzpicture}[baseline=-3pt,>=stealth]
...
\example{ex_crossp2}{Computing a cross product}{Let $\vecu=\la 1,3,6\ra$ and $\vec v = \la -1,2,1\ra$. Compute both $\crossp uv$ and $\crossp vu$.}
...
\example{ex_crossp3}{The cross product and angles}{Let $\vec u = \la 1,3,6\ra$ and $\vec v = \la -1,2,1\ra$ as in \autoref{ex_crossp2}. Verify \autoref{thm:cross_product} by finding $\theta$, the angle between $\vecu$ and $\vecv$, and the magnitude of $\crossp uv$.}
...
3Dcoo=0 0 34,
3Droo=150,
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=5mm 5mm 5mm 5mm,clip=true}{0in}{Illustrating the Right Hand Rule of the cross product.}{fig:crossp_rhr}{figures/figcrossp_rhr}
%\mfigure[scale=1.25,trim=5mm 5mm 5mm 5mm,clip=true]{0in}{Illustrating the Right Hand Rule of the cross product.}{fig:crossp_rhr}{figures/figcrossp_rhr}
...
\mfigure{0in}{Finding the area of a triangle in \autoref{ex_crossp5}.}{fig:crossp5}{figures/figcrossp5}
...
\mnote{\textbf{Note:} The word ``parallelepiped'' is pronounced ``parallel--eh--pipe--ed.''}
...
3Dcoo=0 110 86,
3Droo=150,
3Dlights=Headlamp,add3Djscript=asylabels.js}{}{0in}{A parallelepiped is the three dimensional analogue to the parallelogram.}{fig:crossp_parallelepiped}{figures/figcrosspparallelpiped}
%\mfigure{0in}{A parallelepiped is the three dimensional analogue to the parallelogram.}{fig:crossp_parallelepiped}{figures/figcrosspparallelpiped}
...
\example{ex_crossp6}{Finding the volume of parallelepiped}{Find the volume of the parallepiped defined by the vectors $\vecu = \la 1,1,0\ra$, $\vecv = \la -1,1,0\ra$ and $\vecw = \la 0,1,1\ra$.}
{We apply \autoeqref{eq:crossp2}. We first find $\crossp vw =\la 1,1,-1\ra$. Then
...
3Dcoo=0 50 50,
3Droo=150,
3Dlights=Headlamp,add3Djscript=asylabels.js}{}{0in}{A parallelepiped in \autoref{ex_crossp6}.}{fig:crossp6}{figures/figcrossp6}}
...
\mfigure{0in}{Showing a force being applied to a lever in \autoref{ex_crossp7}.}{fig:crossp7}{figures/figcrossp7}
\begin{enumerate}
