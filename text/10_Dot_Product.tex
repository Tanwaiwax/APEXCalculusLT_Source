...
\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth,scale=1.25]
...
3Dc2c=.54 .61 .58,
3Dcoo=0 0 40,
3Droo=170}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figdotpangle3D_3D}
\\(b)}
...
\centering
\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth,thick,scale=1.25]
	\begin{scope}
...
\mtable{Vectors used in \autoref{ex_dotp2}.}{fig:dotp2}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth]
...
3Dc2c=.89 .4 .23,
3Dcoo=10 50 46,
3Droo=200}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figdotp3_3D}}
...
3Dc2c=.9 .12 .42,
3Dcoo=0 50 30,
3Droo=250}{.8\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figdotp4b_3D}
\\(b)
\iftoggle{in_threeD}{}{%
\\[15pt]
\myincludegraphics[alt={ALT-TEXT-TO-BE-DETERMINED},width=.8\marginparwidth]{figures/figdotp4c_3D} % myinc g 3D
\\(c)}% end iftoggle
}% end mtable
...
\[\vec z = \vec u - \proj uv.\]%
%
\mtable[-7\baselineskip]{Illustrating the orthogonal projection.}{fig:dotpprojc}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth]
...
\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth,scale=.2]
...
\mtable{Finding work when the force and direction of travel are given as vectors.}{fig:dotpwork}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth,scale=.8]
...
\mtable{Computing work when sliding a box up a ramp in \autoref{ex_dotp7}.}{fig:dotp7}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth,scale=.3]
