...
\pdftooltip{\begin{tikzpicture}[>=stealth,scale=1.25]
...
\centering
\pdftooltip{\begin{tikzpicture}[>=stealth,thick,scale=1.25]
	\begin{scope}
...
\mtable{Vectors used in \autoref{ex_dotp2}.}{fig:dotp2}{\pdftooltip{\begin{tikzpicture}[>=stealth]
...
\[\vec z = \vec u - \proj uv.\]%
%
\mtable[-7\baselineskip]{Illustrating the orthogonal projection.}{fig:dotpprojc}{\pdftooltip{\begin{tikzpicture}[>=stealth]
...
\pdftooltip{\begin{tikzpicture}[>=stealth,scale=.2]
...
\mtable{Finding work when the force and direction of travel are given as vectors.}{fig:dotpwork}{\pdftooltip{\begin{tikzpicture}[>=stealth,scale=.8]
...
\mtable{Computing work when sliding a box up a ramp in \autoref{ex_dotp7}.}{fig:dotp7}{\pdftooltip{\begin{tikzpicture}[>=stealth,scale=.3]
