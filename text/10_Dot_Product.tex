...
\mfigure{0in}{Vectors used in Example \ref{ex_dotp2}.}{fig:dotp2}{figures/figdotp2}
...
3Dcoo=10 50 46,
3Droo=200,
3Dlights=Headlamp,add3Djscript=asylabels.js}{}{0in}{Vectors used in Example \ref{ex_dotp3}.}{fig:dotp3}{figures/figdotp3}%
%\mfigure{0in}{Vectors used in Example \ref{ex_dotp3}.}{fig:dotp3}{figures/figdotp3}
...
\mtable{Graphing the vectors used in Example \ref{ex_dotp4}.}{fig:dotp4}{%
\begin{tabular}{c}
...
\mtable{Sketching the ramp and box in Example \ref{ex_dotp6}. Note: \textit{The vectors are not drawn to scale.}}{fig:dotp6}{%
\begin{tabular}{c}
...
\mfigure{0in}{Computing work when sliding a box up a ramp in Example \ref{ex_dotp7}.}{fig:dotp7}{figures/figdotp7}
