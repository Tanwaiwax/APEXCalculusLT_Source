...
3Dcoo=0 70 0,
3Droo=150,
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=5mm 5mm 5mm 5mm,clip=true}{0in}{Defining a line in space.}{fig:lines_intro}{figures/figlines_intro}
%\mfigure[scale=1.25,trim=5mm 5mm 5mm 5mm,clip=true]{0in}{Defining a line in space.}{fig:lines_intro}{figures/figlines_intro}
...
\example{ex_lines1}{Finding the equation of a line}{Give all three equations, as given in \autoref{def:lines}, of the line through $P = (2,3,1)$ in the direction of $\vec d = \la -1,1,2\ra$. Does the point $Q=(-1,6,6)$ lie on this line?}
...
3Dcoo=0 70 50,
3Droo=150,
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=2mm 2mm 2mm 2mm,clip=true}{0in}{Graphing a line in \autoref{ex_lines1}.}{fig:lines1}{figures/figlines1}
%\mfigure[scale=1.25,trim=2mm 2mm 2mm 2mm,clip=true]{0in}{Graphing a line in \autoref{ex_lines1}.}{fig:lines1}{figures/figlines1}
...
3Dcoo=58 8.7 4.6,
3Droo=150,
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25}{0in}{A graph of the line in \autoref{ex_lines6}.}{fig:lines6}{figures/figlines6}
%\mfigure[scale=1.25]{0in}{A graph of the line in \autoref{ex_lines6}.}{fig:lines6}{figures/figlines6}
...
3Dcoo=0 30 50,
3Droo=150,
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=5mm 5mm 5mm 5mm,clip=true}{0in}{Sketching the lines from \autoref{ex_lines2}.}{fig:lines2}{figures/figlines2}
%\mfigure[scale=1.25,trim=5mm 5mm 5mm 5mm,clip=true]{0in}{Sketching the lines from \autoref{ex_lines2}.}{fig:lines2}{figures/figlines2}
...
3Dcoo=0 0 0,
3Droo=150,
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=2mm 0mm 0mm 0mm,clip=true}{0in}{Graphing the lines in \autoref{ex_lines3}.}{fig:lines3}{figures/figlines3}
%\mfigure[scale=1.25,trim=2mm 0mm 0mm 0mm,clip=true]{0in}{Graphing the lines in \autoref{ex_lines3}.}{fig:lines3}{figures/figlines3}
...
\mfigure{0in}{Establishing the distance from a point to a line.}{fig:lines_dist1}{figures/figlines_dist1}
...
3Droo=150,
3Dlights=Headlamp,add3Djscript=asylabels.js}{}{0in}{Establishing the distance between lines.}{fig:lines_dist2}{figures/figlines_dist2}
%\mfigure{0in}{Establishing the distance between lines.}{fig:lines_dist2}{figures/figlines_dist2}
...
\example{ex_lines4}{Finding the distance from a point to a line}{Find the distance from the point $Q=(1,1,3)$ to the line $\vec\ell(t) = \la 1,-1,1\ra+t\la 2,3,1\ra.$}
{The equation of the line line gives us the point $P=(1,-1,1)$ that lies on the line, hence $\vv{PQ} = \la 0,2,2\ra$. The equation also gives $\vec d= \la 2,3,1\ra$. Following \autoref{idea:line_distance}, we have the distance as 
\begin{align*}
h &= \frac{\norm{\vv{PQ}\times \vec d}}{\vnorm{d}}\\
...
\example{ex_lines5}{Finding the distance between lines}{Find the distance between the lines $$\ell_1: \begin{array}{ccc} x&=&1+3t \\ y&=&2-t\\z&=&t\end{array}\qquad\qquad \ell_2:\begin{array}{ccc} x&=&-2+4s\\y&=&3+s\\z&=&5+2s.\end{array}$$}
