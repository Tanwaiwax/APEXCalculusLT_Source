...
3Droo=150}{\marginparwidth}{Cardboard-blue plane; nail at P shows normal, uniquely fixing the plane.}{figures/figplanes_intro_3D}}
...
3Droo=150.00000744992093}{\marginparwidth}{Plane through P(0,0,0), Q(−2,−4,0), R(0,4,4); blue PQ, PR and normal PQ * PR; axes +/-4.}{figures/figplanes1_3D}}

\begin{example}[Finding the equation of a plane.]\label{ex_planes1}%
...
\begin{example}[Finding the equation of a plane.]\label{ex_planes2}%
...
3Droo=149.99999773205013}{\marginparwidth}{Skew blue lines l_1, l_2 span light blue plane; black n = d_1 * d_2 drawn; axes marked to 5.}{figures/figplanes2_3D}}
\begin{align*}
5(x+1) +4(y-3) -7z &= 0 \\
5x + 5 + 4y-12 -7z &= 0\\
5x+4y-7z &= 7.
...
\begin{example}[Finding the equation of a plane]\label{ex_planes3}%
...
3Droo=149.99999682944613}{\marginparwidth}{Tilted grid plane with line through P; blue line segment and axes xyz labelled +/- 3.}{figures/figplanes3_3D}}
\[(x+1) +2y+2(z-1)=0.\]
The line and plane are sketched in \autoref{fig:planes3}.
\end{example}

\begin{example}[Finding the intersection of two planes]\label{ex_planes4}%
...
3Droo=149.99999623071383}{\marginparwidth}{Blue and red planes intersect; their common line highlighted; axes xyz ticked to +/- 5.}{figures/figplanes4_3D}}
...
\begin{example}[Finding the intersection of a plane and a line]\label{ex_planes5}%
...
3Droo=149.9999995928182}{\marginparwidth}{Red line l(t) pierces blue plane; intersection shown on rotated grid; axes xyz +/- 2..}{figures/figplanes5_3D}}%
...
3Droo=149.9999995928182}{\marginparwidth}{Height h from Q to plane along dashed normal; n at P illustrates point-to-plane distance.}{figures/figplanes_dist_3D}}
...
\begin{example}[Distance between a point and a plane]\label{ex_planes6}%
...
\printexercises{exercises/10-06-exercises}
