...
\begin{definition}[Equations of a Plane in Standard and General Forms]\label{def:planes}
...
\begin{keyidea}[Distance from a Point to a Plane]\label{idea:planes_dist}
