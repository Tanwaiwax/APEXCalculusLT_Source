...
\mtable{Illustrating defining a plane with a sheet of cardboard and a nail.}{fig:planes_intro}{%
\myincludeasythree{width=\marginparwidth,
3Droll=-41.9,
3Dortho=0.0045,
3Dc2c=.97 .05 .23,
3Dcoo=65.14276885986328 3.0251121520996094 21.06670570373535,
3Droo=150}{width=\marginparwidth}{figures/figplanes_intro_3D}}
...
% todo should we make a picture of a vector ``orthogonal to the plane''?
...
% todo should we make a picture of how the vector equation of a plane works?
...
\mtable{Sketching the plane in \autoref{ex_planes1}.}{fig:planes1}{%
\myincludeasythree{width=\marginparwidth,
...
3Droo=150.00000744992093}{width=\marginparwidth}{figures/figplanes1_3D}}
...
\[
 \ell_1: \begin{array}{ccc} x&=&-5+2s \\ y&=&1+s \\ z&=&-4+2s\end{array}
 \qquad\qquad
...
\mtable{Sketching the plane in \autoref{ex_planes2}.}{fig:planes2}{%
\myincludeasythree{width=\marginparwidth,
...
3Droo=149.99999773205013}{width=\marginparwidth}{figures/figplanes2_3D}}
\begin{align*}
5(x+1) +4(y-3) -7z &= 0 \\
5x + 5 + 4y-12 -7z &= 0\\
5x+4y-7z &= 7.
...
\mtable{The line and plane in \autoref{ex_planes3}.}{fig:planes3}{%
\myincludeasythree{width=\marginparwidth,
...
3Droo=149.99999682944613}{width=\marginparwidth}{figures/figplanes3_3D}}
\[(x+1) +2y+2(z-1)=0.\]
...
\mtable{Graphing the planes and their line of intersection in \autoref{ex_planes4}.}{fig:planes4}{%
\myincludeasythree{width=\marginparwidth,
...
3Droo=149.99999623071383}{width=\marginparwidth}{figures/figplanes4_3D}}
...
\mtable{Illustrating the intersection of a line and a plane in \autoref{ex_planes5}.}{fig:planes5}{%
\myincludeasythree{width=\marginparwidth,
...
3Droo=149.9999995928182}{width=\marginparwidth}{figures/figplanes5_3D}}%
...
\mtable{Illustrating finding the distance from a point to a plane.}{fig:planes_dist}{%
\myincludeasythree{width=\marginparwidth,
3Droll=1.7009341752827345,
3Dortho=0.007484772708266974,
3Dc2c=0.6873484253883362 0.6952667832374573 0.2101338654756546,
3Dcoo=1.2409521341323853 -5.606988430023193 29.735889434814453,
3Droo=149.9999995928182}{width=\marginparwidth}{figures/figplanes_dist_3D}}
