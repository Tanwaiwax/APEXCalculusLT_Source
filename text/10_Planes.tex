...
{The plane passing through the point $P=(x_0,y_0,z_0)$ with normal vector $\vec n=\bracket{a,b,c}$ can be described by an equation with \textbf{standard form} $$a(x-x_0)+b(y-y_0)+c(z-z_0) =0;$$
