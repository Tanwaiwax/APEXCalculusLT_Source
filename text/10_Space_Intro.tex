...
(a) & (b) & (c)
\end{tabular}}
\captionof{figure}{Sketching the cylinder defined by $x=\sin z$.}\label{fig:space4b}
\end{lxfigure}
...
\[
 \text{1. }y=\frac{x^2}{4}+\frac{z^2}{16}\qquad
 \text{2. }x^2+\frac{y^2}{9}+\frac{z^2}{4}=1\qquad
 \text{3. }z=y^2-x^2.
\]}
{\mbox{}\\[-\baselineskip]\begin{enumerate}
