...
$$\norm{\overline{PQ}}= \sqrt{(2-1)^2+(1-4)^2+(1-(-1))^2} = \sqrt{14}\approx 3.74.\eoehere$$}
...
the $x$-$z$ plane
\end{tabular}}
\captionof{figure}{The coordinate planes.}\label{fig:coordplanes}
\end{lxfigure}
...
3Dcoo=0 0 0,
3Droo=150,
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=5mm 2mm 5mm 5mm,clip=true}{0in}{The plane $x=2$.}{fig:space2}{figures/figspace2}
...
3Dcoo=0 0 0,
3Droo=150,
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=5mm 2mm 5mm 2mm,clip=true}{0in}{Sketching the boundaries of a region in \autoref{ex_space3}.}{fig:space3}{figures/figspace3}%
...
(a) & (b) & (c)
\end{tabular}}
\captionof{figure}{Sketching the cylinder defined by $z=y^2$.}\label{fig:space4a}
\end{lxfigure}
...
(a) & (b) & (c)
\end{tabular}}
\captionof{figure}{Sketching the cylinder defined by $x=\sin z$.}\label{fig:space4b}\eoehere
\end{lxfigure}
\end{enumerate}}
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.5,trim=0mm 1mm 0mm 0mm,clip}{figures/figquadric_hyp_two_sheetb}
 ...
 \bigskip\\
 \begin{minipage}{.75\linewidth}
  The one variable with a positive coefficient corresponds to the axis that the hyperboloid ``opens'' along. In the case illustrated, when $\abs d<\abs c$, there is no trace.\index{quadric surface!hyperboloid of two sheets}
 \end{minipage}
\end{minipage}
