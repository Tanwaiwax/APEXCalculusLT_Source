...
\mtable{Illustrating the right hand rule.  Figure courtesy of \href{https://commons.wikimedia.org/wiki/File:Right_hand_rule_simple.png}{user:Schorschi2} / \href{http://commons.wikimedia.org/}{Wikimedia Commons} / Public Domain.}{fig:right_hand_rule}{\rotatebox{41}{\includegraphics[width=.5\marginparwidth]{figures/raw/Right_hand_rule_simple.png}}\vspace{-2\baselineskip}}
...
\example{ex_space4}{Graphing cylinders}{Graph the following cylinders.
...
\mtable[-\baselineskip]{Introducing surfaces of revolution.}{fig:surf_rev_intro}{%
\myincludeasythree{width=\marginparwidth,
3Droll=0,
3Dortho=0.0045,
3Dc2c=.395 .79 .356,
...
\\(b)}
	...
	\mtable[-5\baselineskip]{Sketching a hyperbolic paraboloid.}{fig:space5c}{%
	\myincludeasythree{width=\marginparwidth,
3Droll=0,
3Dortho=0.0045,
3Dc2c=.7 .55 .43,
