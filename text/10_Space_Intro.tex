...
\end{tikzpicture}
\hspace{-2em}
\includegraphics[{Right-hand rule: thumb points along +z; curled fingers show counter-clockwise rotation from +x toward +y.},width=.5\marginparwidth,angle=41,origin=c]{figures/raw/Right_hand_rule_simple.png}
...
3Dc2c=4 2.5 2,
3Dcoo=0 0 0,
3Droo=150}{\marginparwidth}{Two translucent planes x = −2 and x = 2 enclose a vertical slab; axes drawn for reference.

}{figures/figspace3_3D}}
%
...
3Dc2c=.85 .85 .31,
3Dcoo=0 0 0,
3Droo=150}{\marginparwidth}{Left: blue double cone z^2 = x^2/a^2 + y^2/b^2. Table lists traces. Center: red hyperbolas in planes y = 0, z = d and ellipse in z = d. Right: red hyperbolas in plane x = 0 and ellipse in z = d, arrows label those cutting planes.

}{figures/figquadric_ellipsoidb_3D}
 \end{minipage}
...
3Dc2c=.7 .66 .18,
3Dcoo=0 30 0,
3Droo=150}{.8\marginparwidth}{Completed blue surface z = 4 + x^2/4 + y^2/2 with transparent mesh, showing elliptical horizontal sections.

}{figures/figspace5a_3D}
\\(b)}
