...
3Dcoo=0 0 0,
3Droo=200,
3Dlights=Headlamp,add3Djscript=asylabels.js}{}{0in}{Plotting the point $P=(2,1,3)$ in space.}%
{fig:cartcoord1}{figures/figcartcoord1}%
%{\mfigure{0in}{Plotting the point $P=(2,1,3)$ in space.}{fig:cartcoord1}{figures/figcartcoord1}
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.5,trim=5mm 5mm 3mm 5mm,clip=true}{0in}{Plotting the point $P=(2,1,3)$ in space with a perspective used in this text.}%
{fig:cartcoord2}{figures/figcartcoord2}%
%{\mtable{0in}{Plotting the point $P=(2,1,3)$ in space with a perspective used in this text.}{fig:cartcoord2}{\myincludegraphics[scale=1.5,trim=5mm 5mm 3mm 5mm,clip=true]{figures/figcartcoord2}}
% todo Tim add the box edges like in the previous figure
...
\definition{def:space_distance}{Distance In Space}{Let $P=(x_1,y_1,z_1)$ and $Q = (x_2,y_2,z_2)$ be points in space. The distance $D$ between $P$ and $Q$ is \index{distance!between points in space}
...
\example{ex_space1}{Length of a line segment}{Let $P = (1,4,-1)$ and let $Q = (2,1,1)$. Draw the line segment $\overline{PQ}$ and find its length.}
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=1mm 5mm 2mm 2mm,clip=true}{0in}{Plotting points $P$ and $Q$ in \autoref{ex_space1}.}%
...
%3Dcoo=32.306640625 39.99113082885742 5.668694019317627,
%3Droo=113.20770262248418,
%3Dlights=Headlamp,add3Djscript=asylabels.js]{0in}{Plotting points $P$ and $Q$ in \autoref{ex_space1}.}%
%{fig:space1}{figures/figspace1_3D}}%
%{\mfigure[scale=1.25,trim=1mm 5mm 2mm 2mm,clip=true]{0in}{Plotting points $P$ and $Q$ in \autoref{ex_space1}.}{fig:space1}{figures/figspace1}}
\[\norm{\overline{PQ}}= \sqrt{(2-1)^2+(1-4)^2+(1-(-1))^2} = \sqrt{14}%\approx 3.74
.\eoehere\]}

\subsection*{Spheres}

\index{sphere}Just as a circle is the set of all points in the \textit{plane} equidistant from a given point (its center), a sphere is the set of all points in \textit{space} that are equidistant from a given point. \autoref{def:space_distance} allows us to write an equation of the sphere.
...
\keyidea{idea:sphere}{Standard Equation of a Sphere in Space}{The standard equation of the sphere with radius $r$, centered at $C=(a,b,c)$, is
$$(x-a)^2+(y-b)^2+(z-c)^2=r^2.$$}

\youtubeVideo{fE_PWxyohXQ}{Example of Equation of a Sphere}

\example{ex_space2}{Equation of a sphere}{Find the center and radius of the sphere defined by $x^2+2x+y^2-4y+z^2-6z=2.$}
...
%\mtable{The coordinate planes.}{fig:coordplanes}{%
%\begin{tabular}{c}
...
\example*{ex_space_x_is_two}{A plane in three dimensions}{The equation $x=2$ describes all points in space where the $x$-value is 2. This is a plane, parallel to the $y$-$z$ coordinate plane, shown in \autoref{fig:space2}.}
...
3Dcoo=0 0 0,
3Droo=150,
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=5mm 2mm 5mm 5mm,clip=true}{-4\baselineskip}{The plane $x=2$.}{fig:space2}{figures/figspace2}

\example{ex_space3}{Regions defined by planes}{Sketch the region defined by the inequalities $-1\leq y\leq 2$.}
...
3Dcoo=0 0 0,
3Droo=150,
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=5mm 2mm 5mm 2mm,clip=true}{-3\baselineskip}{Sketching the boundaries of a region in \autoref{ex_space3}.}{fig:space3}{figures/figspace3}
...
\definition{def:cylinder}{Cylinder}{Let $C$ be a curve in a plane and let $L$ be a line not parallel to $C$. A \textbf{cylinder} is the set of all lines parallel to $L$ that pass through $C$. The curve $C$ is the \textbf{directrix} of the cylinder, and the lines are the \textbf{rulings}.\index{cylinder}\index{directrix}}
...
\example{ex_space4}{Graphing cylinders}{Graph the cylinder following cylinders.
...
{\mbox{}\\[-2\baselineskip]\begin{enumerate}
	...
	%\mtable{Sketching the cylinder defined by $z=y^2$ in \autoref{ex_space4}.}{fig:space4a}{%
	%\begin{tabular}{c}
...
(a) & (b) & (c)
\end{tabular}}
\caption{Sketching the cylinder defined by $x=\sin z$.}\label{fig:space4b}\eoehere
\end{lxfigure}
\end{enumerate}}
...
\mtable[-4\baselineskip]{Introducing surfaces of revolution.}{fig:surf_rev_intro}{%
\myincludegraphicsthree{width=125pt,3Dmenu,activate=onclick,deactivate=onclick,
3Droll=0,
3Dortho=0.0045,
3Dc2c=.395 .79 .356,
...
\example{ex_surfrev1}{Finding equation of a surface of revolution}{Let $y=\sin z$ on $[0,\pi]$. Find the equation of the surface of revolution formed by revolving $y=\sin z$ about the $z$-axis.}
...
\example{ex_surfrev2}{Finding equation of surface of revolution}{Find the equation of the surface found by revolving $z=\sin x$ about the $z$-axis.}
...
3Dcoo=0 0 75,
3Droo=150,
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.4,trim=2mm 1mm 2mm 0mm,clip}{0in}{The elliptic paraboloid $z=x^2/4+y^2$.}{fig:quadric1}{figures/figquadric_parb}
%\mfigure[scale=1.4,trim=2mm 1mm 2mm 0mm,clip]{0in}{The elliptic paraboloid $z=x^2/4+y^2$.}{fig:quadric1}{figures/figquadric_parb}
...
\noindent\textbf{Ellipsoid, \quad$\dfrac{x^2}{a^2}+\dfrac{y^2}{b^2}+\dfrac{z^2}{c^2}=1$}\bigskip\\
\begin{minipage}{1.1\linewidth}
 \noindent%
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.5,trim=0mm 1mm 0mm 0mm,clip}{figures/figquadric_hyp_two_sheetb}
 ...
 \bigskip\\
 \begin{minipage}{.75\linewidth}
  The one variable with a positive coefficient corresponds to the axis that the hyperboloid ``opens'' along. In the case illustrated, when $\abs d<\abs c$, there is no trace in the plane $z=d$.\index{quadric surface!hyperboloid of two sheets}
 \end{minipage}
\end{minipage}
...
\noindent\textbf{Hyperbolic Paraboloid, \quad$z=\dfrac{x^2}{a^2}-\dfrac{y^2}{b^2}$}\bigskip\\
\noindent
\begin{minipage}{1.1\linewidth}
 \noindent%
 \begin{minipage}[c]{.4\linewidth}
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=1mm 5mm 3mm 2mm,clip}{figures/figquadric_hyp_parc}
 ...
 \bigskip\\
 \begin{minipage}{.75\linewidth}
  The parabolic traces will open along the axis of the one variable that is raised to the first power.\index{quadric surface!gallery|)}\index{quadric surface!hyperbolic paraboloid}
 \end{minipage}
\end{minipage}
...
\example{ex_space5}{Sketching quadric surfaces}{Sketch the quadric surface defined by the given equation.
\[
