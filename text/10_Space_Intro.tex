...
\mtable[-2\baselineskip]{Introducing surfaces of revolution.}{fig:surf_rev_intro}{%
\myincludeasythree{width=\marginparwidth,
3Droll=0,
3Dortho=0.0045,
3Dc2c=.395 .79 .356,
...
\mtable[-3\baselineskip]{Revolving $z=\sin x$ about the $z$-axis in \autoref{ex_surfrev2}.}{fig:surfrev2}{%
\myincludeasythree{width=.8\marginparwidth,
3Droll=0,
3Dortho=0.0046,
3Dc2c=.66 .67 .32,
...
\mtable[2\baselineskip]{The elliptic paraboloid $z=x^2/4+y^2$.}{fig:quadric1}{%
\myincludeasythree{width=.8\marginparwidth,
3Droll=0,
