...
\pdftooltip{\begin{tikzpicture}[baseline=-10ex]
 \draw[->](0,0)--(0,1)node[above]{$z$};
 \draw[->](0,0)--(-.5,-.3)node[below left]{$x$};
 \draw[->](0,0)--(.5,-.3)node[below right]{$y$};
\node at(2,.5){\rotatebox{41}{\includegraphics[alt={ALT-TEXT-TO-BE-DETERMINED},width=.5\marginparwidth]{figures/raw/Right_hand_rule_simple.png}}};
...
\begin{tabular}{ c c c }
\myincludeasythree{width=.28\linewidth,
3Droll=0,
3Dortho=0.004,
3Dc2c=4 4 2,
3Dcoo=0 0 75,
3Droo=150}{width=.28\linewidth}{figures/figspace4a_3D}
 &
\myincludeasythree{width=.28\linewidth,
3Droll=0,
3Dortho=0.004,
3Dc2c=4 4 2,
3Dcoo=0 0 75,
3Droo=150}{width=.28\linewidth}{figures/figspace4b_3D}
 &
\myincludeasythree{width=.28\linewidth,
3Droll=0,
3Dortho=0.004,
3Dc2c=4 4 2,
3Dcoo=0 0 75,
3Droo=150}{width=.28\linewidth}{figures/figspace4c_3D}
\\(a) & (b) & (c)
\end{tabular}
...
3Dc2c=4 4 3,
3Dcoo=0 0 0,
3Droo=150}{width=.28\linewidth}{figures/figspace4d_3D}
 &
\myincludeasythree{width=.28\linewidth,
3Droll=0,
3Dortho=0.0045,
3Dc2c=4 4 3,
3Dcoo=0 0 0,
3Droo=150}{width=.28\linewidth}{figures/figspace4e_3D} 
&
\myincludeasythree{width=.28\linewidth,
3Droll=0,
3Dortho=0.0045,
3Dc2c=4 4 3,
3Dcoo=0 0 0,
3Droo=150}{width=.28\linewidth}{figures/figspace4f_3D}
\\(a) & (b) & (c)
\end{tabular}
...
3Dc2c=.85 .85 .31,
3Dcoo=0 0 0,
3Droo=150}{width=\linewidth}{figures/figquadric_ellipsoid_3D}
 \end{minipage}%
 \begin{minipage}[c]{.2\linewidth}
 \tagpdfsetup{table/header-rows={1}}
  \begin{tabular}{cc}
...
3Dc2c=.85 .85 .31,
3Dcoo=0 0 -15,
3Droo=150}{width=\linewidth}{figures/figquadric_hyp_two_sheet_3D}
 \end{minipage}%
