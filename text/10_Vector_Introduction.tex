...
\mnote{\textbf{Note:} Instead of $\vec{v}$, some texts use $\mathbf{v}$.}
...
{\mbox{}\\[-2\baselineskip]\begin{enumerate}
	...
	\item	To create a vector with magnitude 5 in the direction of $\vec v$, we multiply the unit vector $\vec u$ by 5. Thus $5\vec u = \la 15/\sqrt{10},5/\sqrt{10}\ra$ is the vector we seek. This is sketched in \autoref{fig:vect5}.
