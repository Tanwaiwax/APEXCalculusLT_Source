...
A
%
\mtable{A figure of a weight being pushed by the wind in \autoref{ex_vect8}.}{fig:vect8}{\begin{tikzpicture}[alt={Wind force F_w pushes plate; chain at tilt theta, plate leans phi; 2 ft lever arm indicated between dashed pivots.}]
