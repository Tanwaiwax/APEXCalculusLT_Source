...
\mtable{A diagram of a weight hanging from 2 chains in \autoref{ex_vect6}.}{fig:vect6}{\pdftooltip{\begin{tikzpicture}
...
\mtable{A diagram of the force vectors from \autoref{ex_vect6}.}{fig:vect6b}{\pdftooltip{\begin{tikzpicture}[>=stealth]
...
A
%
\mtable{A figure of a weight being pushed by the wind in \autoref{ex_vect8}.}{fig:vect8}{\pdftooltip{\begin{tikzpicture}
