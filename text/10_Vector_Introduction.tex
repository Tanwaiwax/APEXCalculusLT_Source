...
\mtable{Drawing the same vector with different initial points.}{fig:vectintro1}{\begin{tikzpicture}
...
\mtable{Illustrating how equal vectors have the same displacement.}{fig:vectintro2}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
%
\mtable{Graphing the sum of vectors in \autoref{ex_vect2}.}{fig:vect2}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,minor x tick num=1,
...
\mtable{Illustrating how to add vectors using the Head to Tail Rule and Parallelogram Law.}{fig:vect2b}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,minor x tick num=1,
minor y tick num=1,ymin=-.5,ymax=4.1,xmin=-.5,xmax=4.1]
\draw[very thick,->,>=stealth] (axis cs:0,0) --(axis cs:1,3)
...
%
\mtable{Illustrating how to subtract vectors graphically.}{fig:vect4}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,minor x tick num=1,
...
%
\mtable{Graphing vectors $\vec v$ and $2\vec v$ in \autoref{ex_vect3}.}{fig:vect3}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,minor x tick num=1,
...
\mtable{Graphing vectors in \autoref{ex_vect5}. All vectors shown have their initial point at the origin.}{fig:vect5}{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,minor x tick num=1,
...
\mtable{A diagram of a weight hanging from 2 chains in \autoref{ex_vect6}.}{fig:vect6}{\begin{tikzpicture}
...
\mtable{A diagram of the force vectors from \autoref{ex_vect6}.}{fig:vect6b}{\begin{tikzpicture}[>=stealth]
