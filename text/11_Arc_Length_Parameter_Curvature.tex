...
\mtable[\baselineskip]{Examining the curvature of $y=x^2$.}{fig:curvature3}{\begin{tikzpicture}[alt={Parabola y=x^(2); red circle of radius = 0.5 depicts peak curvature at vertex.},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
