...
\mtable{Graphing $\vec r$ in \autoref{ex_vvfarc1} with parameters $t$ and $s$.}{fig:vvfarc1}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth]
...
%
\mtable{Illustrating the osculating circles for the curve seen in \autoref{fig:curvatureintro}.}{fig:curvature_osculate}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth]
\begin{axis}[width=\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
ymin=-.1,ymax=2.9,xmin=-.1,xmax=3.5]
\addplot [thick,draw={\colorone}, smooth,domain=-1:1.5] ({x^2-x+1},{x^3+1});
...
\mtable[\baselineskip]{Examining the curvature of $y=x^2$.}{fig:curvature3}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
...
3Droo=150}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figcurvature4_3D}
\\(b)}%
