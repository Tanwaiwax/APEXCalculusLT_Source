...
\mfigure{0in}{Graphing $\vec r$ in \autoref{ex_vvfarc1} with parameters $t$ and $s$.}{fig:vvfarc1}{figures/figvvfarc1}
...
Let a point $P$ on a smooth curve $C$  be given, and let $\kappa$ be the curvature of the curve at $P$. A circle that:
	...
	\end{itemize}
\mfigure{0in}{Illustrating the osculating circles for the curve seen in \autoref{fig:curvatureintro}.}{fig:curvature_osculate}{figures/figcurvature_introc}
...
\mfigure{0in}{Examining the curvature of $y=x^2$.}{fig:curvature3}{figures/figcurvature3}
