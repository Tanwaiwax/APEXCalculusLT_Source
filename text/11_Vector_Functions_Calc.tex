...
\iftoggle{in_threeD}{% in threeD
 ...
 \mtable{Graphing a curve in space with its tangent line.}{fig:vvfderiv1}{%
 \myincludegraphics[alt={Plane curve r(t)=⟨t,t^2–1⟩ (blue) with red tangent line l(t) = r(0)+t r′(0) touching at (0, 0).},width=\marginparwidth]{figures/figvvfderiv1_3D}
 \\(a)\\[10pt]
...
\mtable[1.5in]{Graphing $\vec r(t)$ and its tangent line in \autoref{ex_vvfderiv3}.}{fig:vvfderiv3}{\begin{tikzpicture}[alt={Plane curve r (t)=⟨t, t^2–1⟩ (blue) with red tangent line l(t) = r(0)+t r′(0) touching at (0, 0).},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
...
\begin{enumerate}
	...
	%
\mtable{Graphing $\vec r(t)$ and $\vec u(t)$ in \autoref{ex_vvfderiv2}.}{fig:vvfderiv2a}{\begin{tikzpicture}[alt={Blue parabola r (t)=⟨t, t^2⟩ and red circle path u (t)=⟨sin t, 1–cos t⟩ share common start and speed; arrows show orientation.},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
...
\end{align*}
%
\mtable{Graphing some of the derivatives of $\vec u(t)$ in \autoref{ex_vvfderiv2}.}{fig:vvfderiv2b}{\begin{tikzpicture}[alt={Blue circle u (t) with three red derivative vectors u′(t) drawn at t = pi/2, pi, 3pi/2, indicating velocity directions.},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
