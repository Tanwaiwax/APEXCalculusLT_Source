...
\iftoggle{in_threeD}{% in threeD
 ...
 3Droo=149.99999927774635}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figvvfderiv1_3D}}
}{% not in three D
 \mtable{Graphing a curve in space with its tangent line.}{fig:vvfderiv1}{%
...
\mtable[1.5in]{Graphing $\vec r(t)$ and its tangent line in \autoref{ex_vvfderiv3}.}{fig:vvfderiv3}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
...
\begin{enumerate}
	...
	%
\mtable{Graphing $\vec r(t)$ and $\vec u(t)$ in \autoref{ex_vvfderiv2}.}{fig:vvfderiv2a}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
...
\end{align*}
%
\mtable{Graphing some of the derivatives of $\vec u(t)$ in \autoref{ex_vvfderiv2}.}{fig:vvfderiv2b}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
