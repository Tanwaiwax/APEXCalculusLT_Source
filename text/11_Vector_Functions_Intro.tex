...
3Droo=399.99999354879714}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figvvf2_3D}}
...
\index{cycloid}
{\centering
\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth,scale=.5]
...
%\mtable{The cycloid in \autoref{ex_vvf4}.}{fig:vvfa}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth]
%\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
%axis y line=middle,axis x line=middle,name=myplot,
