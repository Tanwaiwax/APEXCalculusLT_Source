...
\index{cycloid}
{\centering
\pdftooltip{\begin{tikzpicture}[>=stealth,scale=.5]
...
%\mtable{The cycloid in \autoref{ex_vvf4}.}{fig:vvfa}{\pdftooltip{\begin{tikzpicture}[>=stealth]
%\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
%axis y line=middle,axis x line=middle,name=myplot,
...
\solution
%
\mtable{Graphing the displacement of a position function in \autoref{ex_vvf5}.}{fig:vvf5}{\pdftooltip{\begin{tikzpicture}[>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
