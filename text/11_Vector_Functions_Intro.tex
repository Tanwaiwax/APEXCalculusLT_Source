...
\mtable{Sketching the vector--valued function of Example \ref{ex_vvf1}.}{fig:vvf1}{%
\begin{tabular}{c}
		\begin{tabular}{ccc}
...
%\mfigure[scale=1.25]{0in}{The graph of $\vec r(t)$ in Example \ref{ex_vvf2}.}{fig:vvf2}{figures/figvvf2}
...
\mtable{Graphing the functions in Example \ref{ex_vvf3}.}{fig:vvf3}{%
\begin{tabular}{c}
...
\mfigure{0in}{The cycloid in Example \ref{ex_vvf4}.}{fig:vvfa}{figures/figvvf4a}
...
\mfigure{0in}{Graphing the displacement of a position function in Example \ref{ex_vvf5}.}{fig:vvf5}{figures/figvvf5}
