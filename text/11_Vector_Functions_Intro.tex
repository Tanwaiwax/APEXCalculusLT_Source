...
\mtable[-7\baselineskip]{Graphing the functions in \autoref{ex_vvf3}.}{fig:vvf3}{%
\begin{tikzpicture}[>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
% todo how does this differ from the previous figure?
