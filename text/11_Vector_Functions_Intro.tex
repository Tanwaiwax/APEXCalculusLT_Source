...
\end{tabular}
\\(a)\\[10pt]
\begin{tikzpicture}[alt={Table lists t, x=t^3–t, y=1⁄(t^2+1) for −2 ≤ t ≤ 2., highlighting r(2)=⟨6, 1/5⟩.},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\begin{tikzpicture}[alt={Curve ⟨t, sin t⟩ for –pi≤t≤pi: small circle at origin then slanted line through (3.5,3.5).},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\end{tikzpicture}
\\(b)\\[10pt]
\begin{tikzpicture}[alt={Curve ⟨t, t^2 sin t⟩: large spiral, axes scaled to +/-20.},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
%\mtable{The cycloid in \autoref{ex_vvf4}.}{fig:vvfa}{\begin{tikzpicture}[alt={Blue semicircle x^2+y^2=1; red displacement vector d from (0,–1) to (0,1) illustrates Δr.},>=stealth]
%\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
%axis y line=middle,axis x line=middle,name=myplot,
...
\solution
%
\mtable{Graphing the displacement of a position function in \autoref{ex_vvf5}.}{fig:vvf5}{\begin{tikzpicture}[alt={Right half of a unit circle centered at the origin.},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
