...
\mtable{Plotting velocity and acceleration vectors for Object 1 in \autoref{ex_motion2}.}{fig:motion2a}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
...
\mtable{Modeling the flight of a ball in \autoref{ex_motion3}.}{fig:motion3}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=latex,scale=.75]
...
3Droo=150.0000062372992}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figmotion6_3D}}
	}%ends in 3D
	{% now in 2D	
	\mtable{The path of the particle, from two perspectives, in \autoref{ex_motion6}.}{fig:motion6}{%
	\myincludegraphics[alt={ALT-TEXT-TO-BE-DETERMINED},width=\marginparwidth]{figures/raw/figmotion6}\\[-20pt]
	(a)\\[20pt]
	% todo Tim make sure these three figures match
	\myincludegraphics[alt={ALT-TEXT-TO-BE-DETERMINED},width=\marginparwidth]{figures/figmotion6_3D}\\
	(b)
	}% ends \mtable
