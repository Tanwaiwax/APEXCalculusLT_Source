...
\mtable{Plotting velocity and acceleration vectors for Object 1 in \autoref{ex_motion2}.}{fig:motion2a}{\pdftooltip{\begin{tikzpicture}[>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
...
\mtable{Modeling the flight of a ball in \autoref{ex_motion3}.}{fig:motion3}{\pdftooltip{\begin{tikzpicture}[>=latex,scale=.75]
