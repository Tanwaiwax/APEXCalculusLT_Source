...
%
\mtable{Plotting unit tangent vectors in \autoref{ex_tannorm2}.}{fig:tannorm2}{\begin{tikzpicture}[alt={Plane curve 𝑟(𝑡)=⟨t^2, t^3, 3t⟩ three red unit-tangent T(t), drwan where t = -1, 0, 2.},>=stealth]
