...
% todo Tim write these in terms of r(t) if possible? but the theorem is about a(t)
...
Contrast this with $t=0$, where $a_\text{T} = 0$ and $a_\text{N} = 4/\sqrt{2}=2\sqrt2%\approx 2.82
