...
3Droo=150.00000240039893}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figtannorm1_3D}}
%
\[
...
%
\mtable{Plotting unit tangent vectors in \autoref{ex_tannorm2}.}{fig:tannorm2}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth]
...
\mtable{Given a direction in the plane, there are always two directions orthogonal to it.}{fig:tannorm_intro1}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
3Droo=150.0000014005964}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figtannorm3_3D}}%
%
Thus
...
\mtable{Plotting unit tangent and normal vectors in \autoref{ex_tannorm4}.}{fig:tannorm4}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
ymin=-1.1,ymax=6.5,xmin=-2.1,xmax=7]
\addplot [thick,draw={\colorone}, smooth,domain=-2:2,samples=30] ({x^2-x},{x^2+x});
...
\mtable{Graphing $\vec r(t)$ in \autoref{ex_tannorm6}.}{fig:tannorm6}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
ymin=-1.1,ymax=6.5,xmin=-2.1,xmax=7]
...
\mtable{Plotting the position of a thrown ball, with 1s increments shown.}{fig:tannorm7b}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED},>=stealth]
