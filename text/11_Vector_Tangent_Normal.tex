...
%
\mtable{Plotting unit tangent vectors in \autoref{ex_tannorm2}.}{fig:tannorm2}{\pdftooltip{\begin{tikzpicture}[>=stealth]
...
\mtable{Given a direction in the plane, there are always two directions orthogonal to it.}{fig:tannorm_intro1}{\pdftooltip{\begin{tikzpicture}[>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
\mtable{Plotting unit tangent and normal vectors in \autoref{ex_tannorm4}.}{fig:tannorm4}{\pdftooltip{\begin{tikzpicture}[>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
ymin=-1.1,ymax=6.5,xmin=-2.1,xmax=7]
\addplot [thick,draw={\colorone}, smooth,domain=-2:2,samples=30] ({x^2-x},{x^2+x});
...
\mtable{Graphing $\vec r(t)$ in \autoref{ex_tannorm6}.}{fig:tannorm6}{\pdftooltip{\begin{tikzpicture}[>=stealth]
\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,
ymin=-1.1,ymax=6.5,xmin=-2.1,xmax=7]
...
\mtable{Plotting the position of a thrown ball, with 1s increments shown.}{fig:tannorm7b}{\pdftooltip{\begin{tikzpicture}[>=stealth]
