...
\youtubeVideo{39LA5WyVgKY}{Tangent Line to a Parametrized Curve}
...
{In \autoref{ex_tannorm1}, we found $\vec T(t) =\bracket{\rule{0pt}{10pt} (-3/5)\sin t,(3/5)\cos t,4/5}$. Therefore 
$$\vec T\,'(t) =\bracket{-\frac35\cos t,-\frac35\sin t,0}\quad \text{and} \quad \norm{\vec T\,'(t)} = \frac35.$$
Thus $$\vec N(t) = \frac{\vec T\,'(t)}{3/5} =\bracket{-\cos t,-\sin t,0}.$$
...
\begin{align*}
T\,'(t) &=\bracket{\frac{\sqrt{8t^2+2}(2)-(2t-1)\left(\frac12(8t^2+2)^{-1/2}(16t)\right)}{8t^2+2},\right.\\
...
$$\vec N(t_0) =\bracket{-t_2,t_1}\quad \text{or}\quad \vec N(t_0) =\bracket{t_2,-t_1},$$ whichever is the vector that points to the concave side of the graph of $\vec r$.
