...
\index{unit tangent vector!and acceleration}\index{unit normal vector!and acceleration}%
%\iflatexml%
\index{an@$a_{\mathrm{N}}$}\index{at@$a_{\mathrm{T}}$}\index{unit normal vector!an@$a_{\mathrm{N}}$}\index{unit tangent vector!at@$a_{\mathrm{T}}$}%
%\else%
%\index{an@$a_\string\mathrm{N}$}\index{at@$a_\string\mathrm{T}$}\index{unit normal vector!an@$a_\string\mathrm{N}$}\index{unit tangent vector!at@$a_\string\mathrm{T}$}%
%\fi%
\end{theorem}
}
...
\example{ex_tannorm5}{Computing $a_\mathrm{T}$ and $a_\mathrm{N}$}
...
\example{ex_tannorm6}{Computing $a_\mathrm{T}$ and $a_\mathrm{N}$}
...
\example{ex_tannorm7}{Analyzing projectile motion}{A ball is thrown from a height of 240ft with an initial speed of 64ft/s and an angle of elevation of $30^\circ$. Find the position function \vrt\ of the ball and analyze $a_\mathrm{T}$ and $a_\mathrm{N}$.\index{projectile motion}}
