...
\begin{definition}[{\parbox[t]{195pt}{Directional Derivatives and Gradient with Three Variables}}]\label{def:direct_deriv3}
...
\begin{theorem}[{\parbox[t]{200pt}{The Gradient and Directional Derivatives with Three Variables}}]\label{thm:gradient3}
