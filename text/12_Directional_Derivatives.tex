...
{Let $z=f(x,y)$ be differentiable on an open set $S$ containing $(x_0,y_0)$, and let $\vec u =\bracket{u_1,u_2}$ be a unit vector. The directional derivative of $f$ at $(x_0,y_0)$ in the direction of $\vec u$ is
\index{derivative!directional}\index{directional derivative}
...
To simplify notation, we often express the gradient as $\nabla f =\bracket{f_x, f_y}$. The gradient allows us to compute directional derivatives in terms of a dot product.
