...
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.1}{0in}{Understanding the directional derivative in \autoref{ex_direct1}.}{fig:direct1}{figures/figdirect1}
%\mfigure[scale=1.1]{0in}{Understanding the directional derivative in \autoref{ex_direct1}.}{fig:direct1}{figures/figdirect1}
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{}{0in}{At the top of a paraboloid, all directional derivatives are 0.}{fig:direct9}{figures/figdirect9}
%\mfigure{0in}{At the top of a paraboloid, all directional derivatives are 0.}{fig:direct9}{figures/figdirect9}
}
