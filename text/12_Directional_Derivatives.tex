...
3Droo=130.00000000067573}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figdirect1_3D}}
...
\begin{equation}\grad f\cdot \vec u = \norm{\grad f}\,\vnorm u \cos \theta = \norm{\grad f}\cos \theta, \label{eq:gradient}\end{equation}
...
3Droo=150}{.8\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figdirect2_3D}
\\(a)\\
\myincludeasythree{
3Droll=0,
...
3Droo=149.9999987284343}{.8\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figdirect2b_3D}
\\(b)}
...
3Droo=200.00000572048617}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figdirect9_3D}}
...
3Droo=150.00001038122664}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figdirect3_3D}
\\(a)\\
