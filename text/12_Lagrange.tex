...
The distance $d$ from any point $(x,y)$ to the point $(1,2)$ is
 ...
 \]
%
 \mtable{The circle in \autoref{ex_lagr_circle}.}{fig_lagr_on_circle}{\pdftooltip{\begin{tikzpicture}[x=.05\marginparwidth,y=.05\marginparwidth]
...
\end{tikzpicture}}{A circle of radius √80 centered at the origin.  A line through the origin and (1,2) intersects the circle at the points ±(4,8).}}
