...
The Chain Rule, as learned in \autoref{sec:chainrule}, states that $\dfrac{d}{dx}\Bigl(f\bigl(g(x)\bigr)\Bigr) = \fp\bigl(g(x)\bigr)g\primeskip'(x)$. If $t=g(x)$, we can express the Chain Rule as 
...
\begin{align}
\frac{d}{dx}\Bigl(x^2y-xy^3\Bigr) &= \frac{d}{dx}\Bigl(3\Bigr) \notag\\
