...
3Droo=130.00000264534413}{width=\marginparwidth}{figures/figmchain_intro_3D}}
...
3Droo=130.0000024373742}{width=\marginparwidth}{figures/figmchain2_3D}}
...
\end{align*}
% todo Tim should ``odd n'' become ``2k+1''?
...
Note how our solution for $\frac{dy}{dx}$ in \autoeqref{eq:mchain2} is just the negative of the partial derivative of $z$ with respect to $x$, divided by the partial derivative of $z$ with respect to $y$.
