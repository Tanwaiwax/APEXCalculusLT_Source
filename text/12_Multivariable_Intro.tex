...
\mfigure{0in}{Illustrating the domain of $f(x,y)$ in \autoref{ex_multi2}.}{fig:multi2}{figures/figmulti2}
\begin{align*}
...
{\myincludegraphicsthree{width=150pt,3Dmenu,activate=onclick,
...
%3Droo=130,
%3Dortho=.005,
%3Dlights=Headlamp,add3Djscript=asylabels.js]{0in}{Visualizing the solid shown from \autoref{ex_doublepol4}.}{fig:doublepol4}{figures/figlevelcurve2_3D} 
