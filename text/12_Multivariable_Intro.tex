...
\mtable[-\baselineskip]{Illustrating the domain of $f(x,y)$ in \autoref{ex_multi2}.}{fig:multi2}{\begin{tikzpicture}[alt={Shaded interior of the ellipse \frac{x^{2}}{9}+\frac{y^{2}}{4}\ = 1; marks the domain of f(x,y).},>=stealth]
