...
% todo we need a transition between Theorems 104 & 105

\theorem{thm:multi_cont_comp}{Continuity of Compositions}{Let $f$ be continuous on $B$, where the range of $f$ on $B$ is $J$, and let $g$ be a single variable function that is continuous on $J$. Then
