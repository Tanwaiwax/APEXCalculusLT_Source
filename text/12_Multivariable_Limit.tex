...
\begin{definition}[{\parbox[t]{225pt}{Open Disk, Boundary and Interior Points, Open and Closed Sets, Bounded Sets}}]\label{def:open}
...
\example{ex_multicont1}{Continuity of a function of two variables}{Let $\ds f(x,y) = \begin{cases} \frac{\cos y\sin x}{x} & x\neq 0 \\
	\cos y & x=0
