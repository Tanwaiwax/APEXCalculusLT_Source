...
\mtable{Sketching the domain of the function in \autoref{ex_multilimit2}.}{fig:multilimit2}{\begin{tikzpicture}[alt={Domain is the filled square x,y with the diagonal y = x; white strip through the shading.},>=stealth]
