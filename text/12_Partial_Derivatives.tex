...
\begin{enumerate}
	...
	\[\frac{\partial}{\partial x}f(x,y)=\frac{\pf}{\px}=\frac{\partial z}{\partial x}=z_x.\]
...
Just as $\frac{d}{dx}\bigl(5x^2\bigr) = 10x$, we compute $\frac{\partial}{\px}\bigl(x^2y\bigr) = 2xy$. Here we are treating $y$ as a coefficient.

Just as $\frac{d}{dx}\bigl(5^3\bigr) = 0$, we compute $\frac{\partial}{\px}\bigl(y^3\bigr) = 0.$ Here we are treating $y$ as a constant. More examples will help make this clear.
...
\begin{enumerate}
	...
	\[\frac{\partial}{\partial x}\left(\frac{\partial f}{\px}\right) = \frac{\partial^2 f}{\px^2} = \bigl(\,f_x\,\bigr)_x = f_{xx}\]

\item The \textbf{second partial derivative of $f$ with respect to $x$ then $y$} is 
\[\frac{\partial}{\partial y}\left(\frac{\partial f}{\px}\right) = \frac{\partial^2f}{\py\px} = \bigl(\,f_x\,\bigr)_y = f_{xy}\]
...
%
%\item The \textbf{second partial derivative of $f$ with respect to $y$ then $x$} is \[\frac{\partial}{\partial x}\left(\frac{\partial f}{\py}\right) = \frac{\partial^2f}{\px\py} = \bigl(\,f_y\,\bigr)_x = f_{yx}\]
...
\begin{enumerate}
	...
	f_y(x,y) &= 2x^3y+6xy^2 \\
	f_{xx}(x,y) &= \frac{\partial}{\px}\bigl(f_x\bigr) = \frac{\partial}{\px}\bigl(3x^2y^2+2y^3-\sin x\bigr) = 6xy^2-\cos x \\
	f_{yy}(x,y) &= \frac{\partial}{\py}\bigl(f_y\bigr) = \frac{\partial}{\py}\bigl(2x^3y+6xy^2\bigr) = 2x^3+12xy \\
	f_{xy}(x,y) &= \frac{\partial}{\py}\bigl(f_x\bigr) = \frac{\partial}{\py}\bigl(3x^2y^2+2y^3-\sin x\bigr) = 6x^2y+6y^2 \\
	f_{yx}(x,y) &= \frac{\partial}{\px}\bigl(f_y\bigr) = \frac{\partial}{\px}\bigl(2x^3y+6xy^2\bigr) = 6x^2y+6y^2
	\end{aligned}$\hfill\null
%
	\item\hfill$\begin{aligned}[t]
	...
	f_{xx}(x,y) &= \frac{\partial}{\px}\bigl(f_x\bigr) = \frac{\partial}{\px}\bigl(\frac{3x^2}{y^2}\bigr) = \frac{6x}{y^2} \\
	f_{yy}(x,y) &= \frac{\partial}{\py}\bigl(f_y\bigr) = \frac{\partial}{\py}\bigl(-\frac{2x^3}{y^3}\bigr) = \frac{6x^3}{y^4} \\
	f_{xy}(x,y) &= \frac{\partial}{\py}\bigl(f_x\bigr) = \frac{\partial}{\py}\bigl(\frac{3x^2}{y^2}\bigr) = -\frac{6x^2}{y^3} \\
	f_{yx}(x,y) &= \frac{\partial}{\px}\bigl(f_y\bigr) = \frac{\partial}{\px}\bigl(-\frac{2x^3}{y^3}\bigr) = -\frac{6x^2}{y^3}.
	\end{aligned}$\hfill\null
%
%\item	$f(x,y) = e^x\sin(x^2y)$
