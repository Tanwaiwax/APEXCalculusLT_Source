...
3Dlights=Headlamp,add3Djscript=asylabels.js}{trim=1mm 5mm 1mm 0mm,clip,scale=1.25}{0in}{Showing various lines tangent to a surface.}{fig:space_tangent_intro}{figures/figspace_tangent_intro}
%\mfigure[trim=1mm 5mm 1mm 0mm,clip,scale=1.25]{0in}{Showing various lines tangent to a surface.}{fig:space_tangent_intro}{figures/figspace_tangent_intro}
...
\begin{enumerate}
	...
	\item	 The line $\ell_{\vec u}$ through $\big(x_0,y_0,f(x_0,y_0)\big)$ parallel to $\bracket{u_1,u_2,D_{\vec u\,}f(x_0,y_0)}$	is the \textbf{tangent line to $f$ in the direction of $\vec u$ at $(x_0,y_0)$}.
	\end{enumerate}}
...
The two lines are shown with the surface in \autoref{fig:partial4}(a).
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.1}{0in}{Graphing $f$ in \autoref{ex_tpl2}.}{fig:tpl2}{figures/figtpl2}
%\mfigure[scale=1.1]{0in}{Graphing $f$ in \autoref{ex_tpl2}.}{fig:tpl2}{figures/figtpl2}
...
\begin{enumerate}
\item	A nonzero vector parallel to $\vec n=\bracket{a,b,-1}$ is \textbf{orthogonal to $f$ at $P=\big(x_0,y_0,f(x_0,y_0)\big)$}.
...
$$\ell_{n}(t) = \begin{cases}x= x_0+at\\ y = y_0 + bt \\ z = f(x_0,y_0) - t\end{cases}.$$
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.5,trim=6mm 0mm 5mm 0mm,clip}{0in}{Graphing a surface with a normal line  from \autoref{ex_tpl3}.}{fig:tpl3}{figures/figtpl3}
%\mfigure[scale=1.5,trim=6mm 0mm 5mm 0mm,clip]{0in}{Graphing a surface with a normal line  from \autoref{ex_tpl3}.}{fig:tpl3}{figures/figtpl3}

The surface $z=-x^2+y^2$, along with the found normal line, is graphed in \autoref{fig:tpl3}.}
...
$$\vec u = \frac{\vec n}{\vnorm n} =\bracket{1/\sqrt{6},-2/\sqrt{6},-1/\sqrt{6}}\approx\bracket{0.408,-0.816,-0.408}.$$
Thus a the normal line to $f$ at $P$ can be written as
$$\ell_n(t) =\bracket{2,1,4}+ t\bracket{0.408,-0.816,-0.408}.$$
...
Q_1 &= \ell_n(4) & Q_2 &= \ell_n(-4) \\
  &\approx\bracket{3.63, -2.27, 2.37}& & \approx\bracket{0.37, 4.27, 5.63}
	\end{align*}
\mfigurethree{width=150pt,3Dmenu,activate=onclick,deactivate=onclick,
3Droll=0,
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.25,trim=5mm 10mm 0mm 0mm,clip}{0in}{Graphing the surface in \autoref{ex_tpl5} along with points 4 units from the surface.}{fig:tpl5}{figures/figtpl5}
%\mfigure[scale=1.25,trim=5mm 0mm 0mm 0mm,clip]{0in}{Graphing the surface in \autoref{ex_tpl5} along with points 4 units from the surface.}{fig:tpl5}{figures/figtpl5}
...
{Note that this is the same surface and point used in \autoref{ex_tpl3}. There we found $\vec n =\bracket{0,-2,-1}$ and $P = (0,1,1)$. Therefore the equation of the tangent plane is 
$$-2(y-1)-(z-1)=0.$$
\mfigurethree{width=150pt,3Dmenu,activate=onclick,deactivate=onclick,
3Droll=0,
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.5,trim=6mm 0mm 5mm 0mm,clip}{0in}{Graphing a surface with  tangent plane from \autoref{ex_tpl6}.}{fig:tpl6}{figures/figtpl6}
%\mfigure[scale=1.5,trim=6mm 0mm 5mm 0mm,clip]{0in}{Graphing a surface with  tangent plane from \autoref{ex_tpl6}.}{fig:tpl6}{figures/figtpl6}

The surface $z=-x^2+y^2$ and tangent plane are graphed in \autoref{fig:tpl6}.}
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.5,trim= 6mm 5mm 2mm 0mm,clip}{0in}{An ellipsoid and its tangent plane at a point.}{fig:tpl8}{figures/figtpl8}
%\mfigure[scale=1.5,trim= 6mm 5mm 2mm 0mm,clip]{0in}{An ellipsoid and its tangent plane at a point.}{fig:tpl8}{figures/figtpl8}
