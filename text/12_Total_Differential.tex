...
% todo Tim check example line in 3d total differential
%\enlargethispage{\baselineskip} % otherwise, the next example ends, but the mark doesn't get drawn until the next page
% maybe if we drew the full example line at the beginning instead of the end?
...
%\begin{theorem}[\parbox[t]{205pt}{Continuity and Differentiability of Multivariable Functions}]\label{thm:diff_cont_multi}
...
%\begin{theorem}[\parbox[t]{215pt}{Continuity and Differentiability of Functions of Three Variables}]\label{thm:differentiable3}
