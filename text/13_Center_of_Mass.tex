...
\mfigure{0in}{A region $R$ representing a lamina in Example \ref{ex_mass1}.}{fig:mass1}{figures/figmass1}
...
%\mfigure[scale=1.25]{0in}{Graphing the density function in Example \ref{ex_mass2}.}{fig:mass2}{figures/figmass2}
...
%\mtable{Graphing the density functions in Example \ref{ex_mass3}. In (a) is the density function $\delta(x,y) = x^2+y^2+1$; in (b) is $\delta(x,y) = 2\sqrt{x^2+y^2}+1$.}{fig:mass3}{%
%\begin{tabular}{c}
...
\end{align*}
\end{minipage}
\mfigure{0in}{Illustrating the center of mass of a discrete planar system in Example \ref{ex_mass5}.}{fig:mass5}{figures/figmass5}
...
\mfigure{0in}{A region $R$ representing a lamina in Example \ref{ex_mass1}.}{fig:mass6}{figures/figmass1}
...
\end{align*}
\mfigure{0in}{Illustrating the region $R$ in Example \ref{ex_mass9}.}{fig:mass9}{figures/figmass9}
