...
3Dlights=Headlamp}{width=\marginparwidth}{figures/figcylindricalintro_3D}}
...
3Dlights=Headlamp}{width=1.16\marginparwidth}{figures/figcylindrical1_3D}}
...
3Droo=300,
3Dlights=Headlamp}{width=\marginparwidth}{figures/figcylindrical2_3D}}
...
3Droo=300}{width=\marginparwidth}{figures/figdoublepol4_3D}}

\example{ex_cylindrical3}{Finding the center of mass using cylindrical coordinates}
{Find the center of mass of the solid with constant density whose base can be described by the polar curve $r=\cos(3\theta)$ and whose top is defined by the plane $z=1-x+0.1y$, where distances are measured in feet, as seen in \autoref{fig:cylindrical3}. (The volume of this solid was found in \autoref{ex_doublepol4}.)}
...
3Droo=150,
3Dlights=Headlamp}{width=\marginparwidth}{figures/figsphericalintro_3D}}
...
\mnote{\textbf{Note:} The symbol $\rho$ is the Greek letter ``rho.'' Traditionally it is used in the spherical coordinate system, while $r$ is used in the polar and cylindrical coordinate systems.% In space, $r$ and $\rho$ play different roles. In spherical coordinates, $\rho$ is the dist
}

The following Key Idea gives conversions to/from our three spatial coordinate systems.

\begin{keyidea}[{\parbox[t]{210pt}{Converting Between Rectangular, Cylindrical and Spherical Coordinates}}]\label{idea:convert_coords}
...
3Droo=300,
3Dlights=Headlamp}{width=\marginparwidth}{figures/figspherical1_3D}}
...
3Dlights=Headlamp}{width=\marginparwidth}{figures/figsphericalwedge_3D}}
...
\mnote{\textbf{Note:} It is generally most intuitive to evaluate the triple integral in \autoref{thm:triple_int_spherical} by integrating with respect to $\rho$ first; it often does not matter whether we next integrate with respect to $\theta$ or $\varphi$. Different texts present different standard orders, some preferring $d\varphi\ d\theta$ instead of $d\theta\ d\varphi$. As the bounds for these variables are usually constants in practice, it generally is a matter of preference.}
...
3Droo=150,
3Dlights=Headlamp}{width=\marginparwidth}{figures/figspherical3_3D}}
