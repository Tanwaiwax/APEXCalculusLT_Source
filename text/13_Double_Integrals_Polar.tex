...
\iint_Rf(x,y)\ dA
	...
	%&=\int_0^{\pi}\int_{2\cos\theta}^{4\cos\theta} \bigl(r^3\cos^2\theta + r^3\sin^2\theta -4r^2\cos \theta+4r\bigr)\ dr\ d\theta\\
...
\[\int_0^\pi\int_0^{\cos(3\theta)}\bigl(1-r\cos\theta+0.1r\sin\theta\bigr)r\ dr\ d\theta = \frac{\pi}{4} %\approx 0.785
\text{ units}^3.\]
