...
\iint_R\bigl(xy+e^y\bigr) \dd A
	...
	&= \int_3^4 \left(\left.\left[\frac12xy^2+e^y\right]\right|_1^2\ \right)\dd x \\
...
\iint_R\bigl(xy+e^y\bigr) \dd A &= \int_1^2\int_3^4\bigl(xy+e^y\bigr)\dd x \dd y \\
		&= \int_1^2\left(\left.\left[\frac12x^2y+xe^y\right]\right|_3^4\right)\dd y\\
...
%\iint_R e^{2x+3y}\dd A &= \int_0^2\int_0^{-\frac x2+1} e^{2x+3y}\dd y\dd x\\
		%&= \int_0^2\left.\left(\frac13e^{2x+3y}\right)\right|_0^{-\frac x2+1}\dd x\\
...
%\begin{align*}
%\iint_R e^{2x+3y}\dd A &= \int_0^1\int_0^{2-2y} e^{2x+3y}\dd y\dd x\\
		%&= \int_0^1\left.\left(\frac12e^{2x+3y}\right)\right|_0^{2-2y}\dd y\\
...
\iint_R (3xy-x^2-y^2+6\bigl)\dd A &= \int_0^2\int_0^{-\frac x2+1} (3xy-x^2-y^2+6\bigr)\dd y\dd x\\
		&= \int_0^2\left.\left(\frac32xy^2-x^2y-\frac13y^3+6y\right)\right|_0^{-\frac x2+1}\dd x\\
...
\iint_R \bigl(3xy-x^2-y^2+6\bigr)\dd A
	...
	&= \int_0^1\left.\left(\frac32x^2y-\frac13x^3-xy^2+6x\right)\right|_0^{2-2y}\dd y\\
...
\iint_R f(x,y)\dd A &= \int_0^1\int_{y-1}^{1-y}\sin x\cos y\dd x\dd y\\
		&= \int_0^1\left.\Bigl( -\cos x\cos y\Bigr)\right|_{y-1}^{1-y}\dd y\\
...
\iint_R &(4-y)\dd A \\
	...
	&= \int_0^4 \bigl(x(4-y)\bigr)\Big|_{y^2/4}^{2\sqrt{y}}\dd y\\
