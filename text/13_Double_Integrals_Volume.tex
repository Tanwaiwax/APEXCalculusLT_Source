...
\end{tikzpicture}}{ALT-TEXT-TO-BE-DETERMINED}}{A region R in the x-y plane, covered with uniform rectangles.}
\\(a)\\
...
3Droo=150.0000012715658}{width=\marginparwidth,alt={The same region R, but now with a surface above. A rectangular prism goes from one rectangle up to the surface.}}{figures/figdouble_intro2_3D}
\\(b)}
...
3Droo=200.99999858350685}{width=\marginparwidth,alt={For a particular x value, the portion under the surface z over the region R with that x value is a two dimensional region with area A(x).}}{figures/figdouble_intro3_3D}}
...
3Droo=149.99999646067835}{width=\marginparwidth,alt={The volume under f on the region R.}}{figures/figdouble1_3D}}
...
3Droo=200.99999432688844}{width=\marginparwidth,alt={The volume under f over the triangular region R.}}{figures/figdouble2_3D}}
...
\mtable[-2in]{$R$ is the union of two nonoverlapping regions, $R_1$ and $R_2$.}{fig:double_region}{\pdftooltip{\begin{tikzpicture}[xscale=.85,yscale=.6]
...
3Droo=200.9999927619444}{width=\marginparwidth,alt={The surface and region of integration.}}{figures/figdouble3_3D}}
\solution
...
3Droo=201.0000081559461}{width=\marginparwidth,alt={The region of integration forms a fish shape.}}{figures/figdouble4_3D}}
%
\solution
...
%\mtable{Sketching the region $R$ described by the iterated integral in \autoref{ex_double5}.}{fig:double5}{\pdftooltip{\begin{tikzpicture}
%\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
...
%\mtable{Drawing the region determined by the bounds of integration in \autoref{ex_double7}.}{fig:double7}{\pdftooltip{\begin{tikzpicture}
%\begin{axis}[width=1.16\marginparwidth,tick label style={font=\scriptsize},
%axis y line=middle,axis x line=middle,name=myplot,axis on top,
...
\mtable{Determining the region $R$ determined by the bounds of integration in \autoref{ex_double6}.}{fig:double6}{\pdftooltip{\begin{tikzpicture}
...
3Droo=201.00002888349545}{width=\marginparwidth,alt={The surface and region of integration.}}{figures/figdouble6b_3D}}%
%
Thus 
\[
...
3Droo=201.00001586839815}{width=\marginparwidth,alt={The volume over the region R under the surface z=1 is the same calculation as the area of R.}}{figures/figdouble_summary_3D}}
