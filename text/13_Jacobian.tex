...
In a similar fashion, it can be shown (see Exercises \ref{pr_cyl_jac}--\ref{pr_sph_jac}) that triple integrals in cylindrical and spherical coordinates take the following forms:
