...
\mnote{\textbf{Note:} as done before, we think of ``$\iint_R\ dS$'' as meaning ``sum up lots of little surface areas over $R$.''\\
...
\example{ex_surfacearea3}{Finding the surface area of a cone}{The general formula for a right cone with height $h$ and base radius $a$ is $$\ds f(x,y) = h-\frac{h}a\sqrt{x^2+y^2},$$ shown in \autoref{fig:surfacearea3}. Find the surface area of this cone.
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.2,trim=1mm 0mm 1mm 0mm, clip}{0in}{Graphing the surface in \autoref{ex_surfacearea4}.}{fig:surfacearea4}{figures/figsurfacearea4}
