...
\mnote{\textbf{Note:} As before, we think of ``$\iint_R\ dS$'' as meaning ``sum up lots of little surface areas over $R$.''\bigskip\\
...
\end{align*}
%
\mnote{\textbf{Note:} The inner integral in \autoeqref{eq:exsurfacearea2} is an improper integral, as the integrand of $\ds \int_0^ar\sqrt{\frac{a^2}{a^2-r^2}}\ dr$ is not defined at $r=a$. To properly evaluate this integral, one must use the techniques of \autoref{sec:improper_integration}.\bigskip\\
