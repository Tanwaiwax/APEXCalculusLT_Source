...
3Droo=150.00000665572844}{width=\marginparwidth}{figures/figsurfacearea_intro1_3D}
\\(a)\\[20pt]
\myincludeasythree{width=\marginparwidth,
...
3Droo=200.00000665572844}{width=\marginparwidth}{figures/figsurfacearea_intro2_3D}
\\(b)}
...
% todo Tim remove the grid lines from figure 14.5.2 fig:surfacearea1 - check that this happened
\example{ex_surfacearea1}{Finding the surface area of a plane over a triangle}{Let $f(x,y) = 4-x-2y$, and let $R$ be the region in the plane bounded by $x=0$, $y=0$ and $y=2-x/2$, as shown in \autoref{fig:surfacearea1}. Find the surface area of $z=f(x,y)$ over $R$.
%
...
3Droo=149.9999964329389}{width=\marginparwidth}{figures/figsurfacearea1_3D}}%
}
...
\example{ex_surfacearea2}{The surface area of a sphere.}{Find the surface area of the sphere with radius $a$ centered at the origin, whose top hemisphere has equation $z=f(x,y)=\sqrt{a^2-x^2-y^2}$. 
}
...
3Droo=149.99999339949443}{width=\marginparwidth}{figures/figsurfacearea3_3D}}
%
...
\example{ex_surfacearea4}{Finding surface area over a region}{Find the area of the surface $z=f(x,y) = x^2-3y+3$ over the region $R$ bounded by $-x\leq y\leq x$, $0\leq x\leq 4$, as pictured in \autoref{fig:surfacearea4}.}
...
3Droo=150.00000342734387}{width=\marginparwidth}{figures/figsurfacearea4_3D}}
%
