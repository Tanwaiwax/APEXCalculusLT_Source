...
\example{ex_trip3}{Finding the volume of a space region with triple integration}{Set up the triple integrals that find the volume of the space region $D$ where $x^2+y^2\le1$ and $0\le z\le-y$, as shown in \autoref{fig:trip3}(a), with the orders of integration $dz\ dy\ dx$, $dy\ dx\ dz$ and $dx\ dz\ dy$.}
{The order $dz\ dy\ dx$:\\
...
%\mbox{}
\end{theorem}
% todo Tim check a spurious mbox at the end of thm:triple_int_prop
...
%\mbox{}
\end{definition}
% todo Tim spurious normalsize mbox at the end of def:triple_integral_2
