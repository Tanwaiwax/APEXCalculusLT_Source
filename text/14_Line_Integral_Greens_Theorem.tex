...
%Note: take this sentnec out and make as exerciseChoosing $\vec F =\bracket{-y,0}$ has special significance. This field leads to the line integral $\oint_C\bracket{0,-f(t)}\cdot\bracket{\fp(t),\gp(t)}\ dt$.
