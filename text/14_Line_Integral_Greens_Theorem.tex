...
\mtable{Illustrating the principles of flow and flux.}{fig:flowfluxintro}{\pdftooltip{\begin{tikzpicture}
...
\mtable{Determining ``counterclockwise'' is not always simple without a good definition.}{fig:fluxcounterclockwise}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,height=1.16\marginparwidth,
tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,axis equal,
xtick={-1,1},ytick={-1,1},
...
\mtable{Illustrating the curves and vector fields in \autoref{ex_flux1}. In (a) the vector field is $\vec F_1$, and in (b) the vector field is $\vec F_2$.}{fig:flux1}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,height=1.16\marginparwidth,
tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,axis equal,
xtick={1},ytick={1},
...
%
\mtable{The vector field and planar region used in \autoref{ex_green1}.}{fig:green1}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,height=1.16\marginparwidth,
tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,axis equal,
xtick={-1,1},ytick={1,2},
...
%
\mtable{The vector field and planar region used in \autoref{ex_green2}.}{fig:green2}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,height=1.16\marginparwidth,
tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,axis equal,
xtick={-2,2},ytick={2,2},
...
\mtable{The region $R$, whose area is found in \autoref{ex_green3}.}{fig:green3}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,height=1.16\marginparwidth,
tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,axis equal,
xtick={-1,1},ytick={1},
...
\mtable{The region $R$ used in \autoref{ex_div1}.}{fig:div1}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,height=1.16\marginparwidth,
tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,axis equal,
xtick={-2,2},ytick={-2,2},
...
\solution
%
\mtable{As used in \autoref{ex_div2}, the vector field has a divergence of 0 and the two paths only intersect at their initial and terminal points.}{fig:div2}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,height=1.16\marginparwidth,
...
%\pdftooltip{\begin{tikzpicture}[x={(.55ex,0)},y={(0,.55ex)}]
