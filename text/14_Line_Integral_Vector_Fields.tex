...
%
\mtable{Paths through a vector field in \autoref{ex_livf1}.}{fig:livf1}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
...
\mtable{Paths through a vector field in \autoref{ex_livf2}.}{fig:livf2}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=1.16\marginparwidth,height=1.16\marginparwidth,
tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,axis equal,
xtick={-1,1},ytick={-1,1},
...
\mtable{The vector field and curve in \autoref{ex_livf3}.}{fig:livf3}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
\begin{axis}[width=1.16\marginparwidth,height=1.16\marginparwidth,
tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,axis equal,
xtick={1},ytick={1},
...
3Dlights=Headlamp}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figlivf4_3D}}
...
\mtable{$R_1$ is simply connected; $R_2$ is connected, but not simply connected; $R_3$ is not connected.}{fig:simply_connected_plane}{\begin{tikzpicture}[alt={ALT-TEXT-TO-BE-DETERMINED}]
...
3Dlights=Headlamp}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figsimply_connected_1_3D}
\\(a)\\[10pt]
\myincludeasythree{
3Droll=0,
3Dortho=0.009668752551078796,
...
3Dcoo=0.47741085290908813 38.61087417602539 -23.2408390045166,
3Droo=149.999998390057,
3Dlights=Headlamp}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figsimply_connected_2_3D}
\\(b)}
