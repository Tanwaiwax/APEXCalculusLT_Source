...
%
\mtable{Paths through a vector field in \autoref{ex_livf1}.}{fig:livf1}{\pdftooltip{\begin{tikzpicture}
...
\mtable{Paths through a vector field in \autoref{ex_livf2}.}{fig:livf2}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,height=1.16\marginparwidth,
tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,axis equal,
xtick={-1,1},ytick={-1,1},
...
\mtable{The vector field and curve in \autoref{ex_livf3}.}{fig:livf3}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,height=1.16\marginparwidth,
tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,name=myplot,axis on top,axis equal,
xtick={1},ytick={1},
...
\mtable{$R_1$ is simply connected; $R_2$ is connected, but not simply connected; $R_3$ is not connected.}{fig:simply_connected_plane}{\pdftooltip{\begin{tikzpicture}
