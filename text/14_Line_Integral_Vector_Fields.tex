...
\[\int \frac{\partial f}{\partial x}\dd x = f(x,y) + C(y).\]
...
\[\int \frac{\partial f}{\partial x}\dd x = \int (3x^2y+2x)\dd x = x^3y+x^2 + C(y).\]

Likewise, integrating $f_y$ with respect to $y$ gives:
\[\int \frac{\partial f}{\partial y}\dd y = \int( x^3+1)\dd y = x^3y+ y + C(x).\]
