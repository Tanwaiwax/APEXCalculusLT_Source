...
\mnote[-4\baselineskip]{The formula for $\curl\vecf$ is unfortunately complicated.  \autoeqref{nablacurl} in \autoref{divgradcurllap} provides a simpler way to remember it.}
