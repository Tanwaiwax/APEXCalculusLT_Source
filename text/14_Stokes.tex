...
\renewcommand{\arraystretch}{1.4}
 \begin{tabular}{p{.25\specialboxlength} l p{.35\specialboxlength}}
  ...
  Stokes' Theorem & $\int_{\partial S}\vec F\cdot d\vec s=\iint_S\nabla\times\vec F\cdot d\vec s$ & $\partial S$ oriented with $S$ to the left \\
  Divergence Theorem & $\iint_{\partial W}\vec F\cdot d \vec s=\iiint_W\nabla\cdot\vec Fd V$ & $\partial W$ oriented outwards
 \end{tabular}}
