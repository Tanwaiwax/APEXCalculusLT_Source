...
\renewcommand{\arraystretch}{1.4}
 \begin{tabular}{p{10em} l l}
  ...
  Fundamental Theorem\par of Calculus & $\ds\left.f\right|_a^b=\int_a^b \fp(x)\dd x$ &\\
  Fundamental Theorem\par of Gradient Fields & $\ds\left.\phi\right|_P^Q=\int_C\nabla\phi\cdot\dd s$ & $C$ goes from $P$ to $Q$ \\
  ...
  $\mathbb{R}^3$ Divergence Theorem & $\ds\iint_{\partial D}\vec F\cdot\dd\vec\sigma=\iiint_D\divv\vec F\dd V$ & $\partial W$ oriented outwards
 \end{tabular}
\end{keyidea}
}
