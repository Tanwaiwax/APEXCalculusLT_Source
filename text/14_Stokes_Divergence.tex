...
\renewcommand{\arraystretch}{1.4}
 \begin{tabular}{p{10em} l l}
  ...
  Green's Theorem & $\ds\oint_{\partial R}\vecF\cdot\dd\vecr=\iint_R\curl F\dd A$ & $\partial D$ oriented counterclockwise \medskip\\
  ...
  $\mathbb{R}^2$ Divergence Theorem & $\ds\iint_{\partial R}\vec F\cdot\vec n\dd s=\iint_R\divv\vec F\dd A$ & $\partial R$ oriented outwards \medskip\\
