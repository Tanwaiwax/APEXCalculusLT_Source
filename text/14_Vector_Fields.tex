...
\mtable[1.5in]{Graphing a vector field in space.}{fig:vectorfieldintroc}{%
\myincludeasythree{
3Droll=0,
...
3Dlights=Headlamp}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figvectorfieldintro_f_3D}}
...
\begin{enumerate}
	\item
%
\mtable{The vector fields in part \arabic{enumi} in \autoref{ex_vectorfield1}.}{fig:vectorfield1a}{%
\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,height=1.16\marginparwidth,
tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,
...
%
	...
	\item
%
\mtable{The vector fields in part \arabic{enumi} in \autoref{ex_vectorfield1}.}{fig:vectorfield1b}{%
\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,height=1.16\marginparwidth,
tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,
...
%
	...
	Since the curl is constant, we conclude the induced spin is the same no matter where one is in this field.
		...
		\item
%
	\mtable{The vector fields in part \arabic{enumi} in \autoref{ex_vectorfield1}.}{fig:vectorfield1c}{%
\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,height=1.16\marginparwidth,
tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,
...
%
	...
	\item
%
	\mtable{The vector fields in part \arabic{enumi} in \autoref{ex_vectorfield1}.}{fig:vectorfield1d}{%
\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,height=1.16\marginparwidth,
tick label style={font=\scriptsize},
axis y line=middle,axis x line=middle,
...
%
\mtable[-3\baselineskip]{A vector field representing a planar gravitational force.}{fig:vectorfield3}{\pdftooltip{\begin{tikzpicture}
\begin{axis}[width=1.16\marginparwidth,height=1.16\marginparwidth,
tick label style={font=\scriptsize},
...
\mtable[-2\baselineskip]{The vector field $\vec F = \grad f$ and a graph of a function $z=f(x,y)$ in \autoref{ex_vectorfield4}.}{fig:vectorfield4}{%
\pdftooltip{\begin{tikzpicture}
...
\node [right] at (myplot.right of origin) {\scriptsize $x$};
\node [above] at (myplot.above origin) {\scriptsize $y$};
\end{tikzpicture}}{ALT-TEXT-TO-BE-DETERMINED}\\(a)\\[10pt]
%}
...
3Dlights=Headlamp}{\marginparwidth}{ALT-TEXT-TO-BE-DETERMINED}{figures/figvectorfield4b_3D}\\(b)}
