...
\index{curl}\mbox{}\\[-2\baselineskip]\begin{itemize}
	\item Let $\vec F =\bracket{M,N}$ be a vector field in the plane. The \sword{curl} of $\vec F$ is $\curl \vec F = N_x - M_y$.
