...
%
\mtable[-3\baselineskip]{A vector field representing a planar gravitational force.}{fig:vectorfield3}{\begin{tikzpicture}[alt={A vector field with arrows pointing toward the origin.  Arrows closer to the origin are longer.}]
\begin{axis}[width=1.16\marginparwidth,height=1.16\marginparwidth,
tick label style={font=\scriptsize},
