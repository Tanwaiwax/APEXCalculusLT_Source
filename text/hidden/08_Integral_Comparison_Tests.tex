...
%\mnote{\textbf{Note:} Recall we often use $\sum a_n$ to write $\ds \sum_{n=1}^\infty a_n$.}
...
\example{ex_itest2}{Using the Integral Test to establish \autoref{thm:pseries}.}
{
...
%It is helpful to remember that when using \autoref{thm:series_limit_compare}, the terms of the series with known convergence go in the denominator of the fraction.
