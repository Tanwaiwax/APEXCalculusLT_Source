...
\begin{keyidea}[Vector Calculus in Cartesian Coordinates]\label{ki_cart_sys}
...
{
\tcbset{grow to right by=60pt}
\begin{keyidea}[Vector Calculus in Cylindrical Coordinates]\label{ki_cyl_sys}
...
{
\tcbset{grow to right by=60pt}
\begin{keyidea}[Vector Calculus in Spherical Coordinates]\label{ki_sph_sys}
