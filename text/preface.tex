...
\end{itemize}
All of these sites are completely free (although some will ask you to donate).  Here's a sample one: \youtubeVideo{ILNfpJTZLxk}{Practical Advice for Those Taking College Calculus}
...
We encourage others to adapt this work to fit their own needs. One might add sections that are ``missing'' or remove sections that your students won't need. The source files can be found at \url{https://github.com/teepeemm/APEXCalculusLT_Source}.

You can learn more at \texttt{\href{http://www.vmi.edu/APEX}{www.vmi.edu/APEX}}.\\

\noindent\textbf{\large Creating \apex~LT}\\
