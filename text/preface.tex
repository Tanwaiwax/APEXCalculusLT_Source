...
% todo Tim : uncomment
%, found in Chapters \ref{chapter:vectors} through \ref{chapter:vect_calc}.
All three are available separately for free.% at \texttt{\href{http://apexcalculus.com}{www.apexcalculus.com}}.
...
to Michael Corral for allowing us to use portions of his Vector Calculus, available at \texttt{\href{http://www.mecmath.net/}{www.mecmath.net/}}% (specifically, Sections \ref{sec:other_systems}, \ref{sec:lagrange}, and \ref{sec:jacobian}, and \autoref{chapter:vect_calc})
and
