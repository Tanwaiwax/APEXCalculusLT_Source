...
% todo Tim for BSC, make the chapter breakdown actually match
...
% at \texttt{\href{http://apexcalculus.com}{www.apexcalculus.com}}.
...
%\newcommand{\threedurl}{file:///Users/tprescott/Documents/programming/github/APEXCalculusLT_Source/prc/prc.html}
%
%\iflatexml\else
%\noindent
...
%\indent
%\fi
%The situation is more interesting for tablets and smartphones.  The 3D graphics files have been arrayed at \url{\threedurl}.  At the bottom of the page are links to apps for Android and iOS that can display the interactive files.
%\iflatexml\else
