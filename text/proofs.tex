...
\theorem{thm:bolzano_weierstrass}{The Bolzano-Weierstrass Theorem}
...
%\end{enumerate}
\begin{proof}[Proof of {\hyperref[thm:riemann_sum]{Definite Integrals and the Limit of Riemann Sums}}]\label{pf:riemann_sum}
